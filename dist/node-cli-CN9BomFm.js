...
import { Bt as resolveGatewayConnectionAuth, Cu as ensureExecApprovals, Eu as mergeExecApprovalsSocketDefaults, G as formatHelpExamples, Gu as evaluateExecAllowlist, Hs as formatExecCommand, Iu as saveExecApprovals, Jp as GATEWAY_CLIENT_NAMES, Ku as evaluateShellAllowlist, Lu as requestJsonlSocket, Mu as recordAllowlistUse, Nu as requiresExecApproval, Ou as normalizeExecApprovals, Pu as resolveExecApprovals, Rg as loadConfig, Su as addAllowlistEntry, Us as resolveSystemRunCommandRequest, Uu as resolveExecSafeBinRuntimePolicy, Vu as isInterpreterLikeSafeBin, Yr as withTimeout, __ as unwrapKnownDispatchWrapperInvocation, b_ as resolveInlineCommandMatch, bc as GatewayClient, d_ as analyzeArgvCommand, f_ as resolvePlannedSegmentArgv, g_ as normalizeExecutableToken, gm as startBrowserControlServiceFromConfig, h_ as POSIX_SHELL_WRAPPERS, hm as createBrowserControlContext, hu as loadOrCreateDeviceIdentity, ju as readExecApprovalsSnapshot, km as resolveBrowserConfig, m_ as resolveExecutableFromPathEnv, mm as createBrowserRouteDispatcher, p_ as resolveCommandResolutionFromArgv, qp as GATEWAY_CLIENT_MODES, qs as normalizeSystemRunApprovalPlan, qu as resolveAllowAlwaysPatterns, rm as writeJsonAtomic, v_ as unwrapKnownShellMultiplexerInvocation, vd as getMachineDisplayName, y_ as POSIX_INLINE_COMMAND_FLAGS } from "./auth-profiles-C0kh5mIB.js";
import { t as formatCliCommand } from "./command-format-BTnLVWI8.js";
import { i as resolveAgentConfig } from "./agent-scope-C4S7fG5T.js";
import "./utils-CtED9zde.js";
import { a as sameFileIdentity } from "./boundary-file-read-B1ga_qm2.js";
import { i as logWarn } from "./logger-BUMgVwAa.js";
...
import { S as sanitizeSystemRunEnvOverrides, x as sanitizeHostExecEnv } from "./env-overrides-6kya__R2.js";
import { t as VERSION } from "./version-DcA9ITyc.js";
import { a as splitShellArgs } from "./search-manager-DSd7jCvQ.js";
import "./plugins-LGMtobye.js";
import { W as detectMime } from "./query-expansion-CU62AsAp.js";
...
import { b as resolveNodeSystemdServiceName, f as formatNodeServiceDescription, x as resolveNodeWindowsTaskName, y as resolveNodeLaunchAgentLabel } from "./prompt-style-CvOiDahx.js";
...
import { l as buildNodeServiceEnvironment, n as resolveDaemonInstallRuntimeInputs, p as resolveNodeProgramArguments, t as emitDaemonInstallRuntimeWarning } from "./daemon-install-plan.shared-B-Il-Vr1.js";
import "./runtime-guard-f5IxSOtq.js";
import { r as isGatewayDaemonRuntime, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-C3k8ZAj5.js";
import "./systemd-DXsGlfGs.js";
import "./service-BZhRiTaM.js";
import { a as createCliStatusTextStyles, f as resolveRuntimeStatusColor, g as installDaemonServiceAndEmit, h as createDaemonActionContext, i as runServiceUninstall, m as buildDaemonServiceSnapshot, r as runServiceStop, t as runServiceRestart } from "./lifecycle-core-DURmtRLL.js";
import { c as buildPlatformRuntimeLogHints, l as buildPlatformServiceStartHints, u as formatRuntimeStatus } from "./systemd-hints-CTokBi8z.js";
import { t as parsePort } from "./parse-port-C-gqpYO7.js";
import { i as NODE_SYSTEM_RUN_COMMANDS, n as NODE_EXEC_APPROVALS_COMMANDS, t as NODE_BROWSER_PROXY_COMMAND } from "./node-commands-DrEMnj9G.js";

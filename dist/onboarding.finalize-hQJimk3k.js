...
import { m as restoreTerminalState } from "./subsystem-JJ8bgFw2.js";
import "./boolean-DTgd5CzD.js";
import { Et as probeGatewayReachable, Mt as waitForGatewayReachable, Ot as resolveControlUiLinks, gt as detectBrowserOpenSupport, vt as formatControlUiSshHint, wt as openUrl } from "./auth-profiles-C0kh5mIB.js";
import { r as resolveCliName, t as formatCliCommand } from "./command-format-BTnLVWI8.js";
import { y as DEFAULT_BOOTSTRAP_FILENAME } from "./agent-scope-C4S7fG5T.js";
import { m as pathExists, v as resolveUserPath } from "./utils-CtED9zde.js";
...
import { t as runTui } from "./tui-B02pgJMl.js";
...
async function finalizeOnboardingWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-LznV-8u0.js").then((n) => n.r);
	...
	if (webSearchProvider) {
		const { SEARCH_PROVIDER_OPTIONS, resolveExistingKey, hasExistingKey, hasKeyInEnv } = await import("./onboard-search-CiwHl3Ua.js");
		...
		const { SEARCH_PROVIDER_OPTIONS, hasExistingKey, hasKeyInEnv } = await import("./onboard-search-CiwHl3Ua.js");

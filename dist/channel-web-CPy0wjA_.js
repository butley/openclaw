...
import { p as defaultRuntime, t as createSubsystemLogger } from "./subsystem-JJ8bgFw2.js";
import { $ as setActiveWebListener, $i as computeBackoff, Ar as hasControlCommand, Ca as toLocationContext, Da as resolveInboundLastRouteSessionKey, Dg as registerUnhandledRejectionHandler, Ea as resolveAgentRoute, Er as finalizeInboundContext, Fr as normalizeMentionText, Fs as formatDurationPrecise, Hd as loadWebMedia, Ht as issuePairingChallenge, In as convertMarkdownTables, Ip as resolveGroupSessionKey, Jd as chunkMarkdownTextWithMode, Kf as updateLastRoute, La as resolveDefaultGroupPolicy, Lv as normalizeStreamLevel, Mp as resolveChannelGroupRequireMention, Pm as saveMediaBuffer, Pr as buildMentionRegexes, Qt as recordPendingHistoryEntryIfEnabled, Ra as resolveOpenProviderRuntimeGroupPolicy, Rg as loadConfig, Sa as formatLocationText, Ta as deriveLastRoutePolicy, Ud as resolveMarkdownTableMode, Uf as loadSessionStore, Ut as resolveMentionGating, Vt as createConnectedChannelStatusPatch, Wf as recordSessionMetaFromInbound, Xd as resolveTextChunkLimit, Xt as createReplyPrefixOptions, Yd as resolveChunkMode, Zs as enqueueSystemEvent, Zt as buildHistoryContextFromEntries, _n as getReplyFromConfig, aa as parseActivationCommand, an as resolvePinnedMainDmOwnerFromAllowlist, cn as shouldAckReactionForWhatsApp, dn as createInboundDebouncer, ea as sleepWithAbort, ef as resolveIdentityNamePrefix, fn as resolveInboundDebounceMs, ia as normalizeGroupActivation, in as resolveDmGroupAccessWithLists, jp as resolveChannelGroupPolicy, jr as shouldComputeCommandAuthorized, kg as getAgentScopedMediaLocalRoots, ln as dispatchReplyWithBufferedBlockDispatcher, pn as formatInboundEnvelope, rn as resolveDmGroupAccessWithCommandGate, ta as createDedupeCache, tf as resolveMessagePrefix, tn as readStoreAllowFromForDmPolicy, ut as resolveInboundSessionEnvelopeContext, wa as buildAgentSessionKey, ya as upsertChannelPairingRequest, za as warnMissingProviderGroupPolicyFallbackOnce } from "./auth-profiles-C0kh5mIB.js";
...
import { S as sleep, _ as resolveJidToE164, d as isSelfChatMode, f as jidToE164, n as clamp, p as normalizeE164 } from "./utils-CtED9zde.js";
import { $ as readWebSelfId, G as resolveWhatsAppMediaMaxBytes, U as resolveWhatsAppAccount, q as getWebAuthAgeMs } from "./plugins-LGMtobye.js";
import { l as resolveStorePath } from "./paths--60oHXZP.js";
import { n as recordChannelActivity } from "./channel-activity-U1P6GjYM.js";
import { a as markdownToWhatsApp, i as sendReactionWhatsApp } from "./outbound-CAqaYt5K.js";
import { i as waitForWaConnection, n as formatError, r as getStatusCode, t as createWaSocket } from "./session-BXPiNu6M.js";
import { i as noteContactName, r as loadContactNameCache, t as createWebSendApi } from "./send-api-A0NAlmGX.js";
...
async function monitorWebInbox(options) {
	...
	const enqueueInboundMessage = async (msg, inbound, enriched) => {
		...
		const reply = async (text) => {
			const { processOutboundMentions } = await import("./send-api-A0NAlmGX.js").then((n) => n.n);

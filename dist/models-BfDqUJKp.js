...
import { Ag as loadModelCatalog, An as formatRemainingShort, B_ as resolveApiKeyForProvider, Dn as maskApiKey, F as resolveModelRefFromString, G_ as shouldEnableShellEnvFallback, H_ as resolveEnvApiKey, Hg as readConfigFileSnapshotForWrite, Ii as loadProviderUsageSummary, Ir as runEmbeddedPiAgent, J as getModelsCommandSecretTargetIds, Lg as createConfigIO, M as resolveConfiguredModelRef, Mg as shouldSuppressBuiltInModel, N as resolveDefaultModelForAgent, Ng as resolveOpenClawAgentDir, O as normalizeProviderId, On as DEFAULT_OAUTH_WARN_MS, Ov as DEFAULT_MODEL, R as resolvePluginProviders, R_ as getCustomProviderApiKey, Rg as loadConfig, Ri as formatUsageWindowSummary, T as modelKey, U_ as resolveUsableCustomProviderApiKey, Uv as resolveAuthProfileDisplayLabel, V_ as resolveAwsSdkEnvVarName, W as withProgressTotals, W_ as getShellEnvAppliedKeys, Wg as setRuntimeConfigSnapshot, Z as resolveCommandSecretRefsViaGateway, b as buildModelAliasIndex, bf as discoverModels, d as setAuthProfileOrder, do as describeFailoverError, f as upsertAuthProfile, gf as resolveModelWithRegistry, k as parseModelRef, kn as buildAuthHealthSummary, kv as DEFAULT_PROVIDER, n as resolveAuthProfileOrder, nh as resolveSecretRefString, p as ensureAuthProfileStore, r as resolveProfileUnusableUntilForDisplay, t as resolveAuthProfileEligibility, u as listProfilesForProvider, v as resolveAuthStorePathForDisplay, vv as isNonSecretApiKeyMarker, wt as openUrl, x as findNormalizedProviderValue, yf as discoverAuthStorage, z_ as hasUsableCustomProviderApiKey, zi as resolveUsageProviderId } from "./auth-profiles-C0kh5mIB.js";
import { t as formatCliCommand } from "./command-format-BTnLVWI8.js";
import { F as toAgentModelListLike, N as resolveAgentModelFallbackValues, P as resolveAgentModelPrimaryValue, a as resolveAgentDir, d as resolveAgentWorkspaceDir, f as resolveDefaultAgentId, j as resolveDefaultAgentWorkspaceDir, l as resolveAgentModelFallbacksOverride, s as resolveAgentExplicitModelPrimary } from "./agent-scope-C4S7fG5T.js";
import { x as shortenHomePath } from "./utils-CtED9zde.js";
...
import { i as parseDurationMs } from "./search-manager-DSd7jCvQ.js";
...
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent } from "./paths--60oHXZP.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { ensureAuthProfileStore } = await import("./auth-profiles.runtime-B9fNxl2E.js");
	const { ensureOpenClawModelsJson } = await import("./auth-profiles-C0kh5mIB.js").then((n) => n.jg);

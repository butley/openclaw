import { R as resolveStorePath, fn as buildGroupHistoryKey, hn as normalizeAgentId, ln as DEFAULT_MAIN_KEY, un as buildAgentMainSessionKey } from "./query-expansion-Q-LrwXu2.js";
import { $ as normalizeMentionText, A as shouldAckReactionForWhatsApp, Ai as pickWebChannel, Br as getAgentScopedMediaLocalRoots, C as buildHistoryContextFromEntries, Ci as resolveWhatsAppAccount, Cn as resolveChunkMode, D as resolveDmGroupAccessWithLists, Di as logWebSelfId, Dn as resolveMessagePrefix, Dt as computeBackoff, E as resolveDmGroupAccessWithCommandGate, Ei as getWebAuthAgeMs, En as resolveIdentityNamePrefix, F as formatInboundEnvelope, Ft as toLocationContext, Gn as recordSessionMetaFromInbound, Hr as loadConfig, I as getReplyFromConfig, Ii as webAuthExists, It as buildAgentSessionKey, J as finalizeInboundContext, Kn as updateLastRoute, Lr as registerUnhandledRejectionHandler, Lt as deriveLastRoutePolicy, Mi as readWebSelfId, Mt as parseActivationCommand, N as createInboundDebouncer, Nt as upsertChannelPairingRequest, O as resolvePinnedMainDmOwnerFromAllowlist, Ot as sleepWithAbort, P as resolveInboundDebounceMs, Pt as formatLocationText, Q as buildMentionRegexes, Qr as normalizeStreamLevel, Rt as resolveAgentRoute, S as createReplyPrefixOptions, Sn as chunkMarkdownTextWithMode, T as readStoreAllowFromForDmPolicy, Ti as WA_WEB_AUTH_DIR, W as convertMarkdownTables, Wn as loadSessionStore, X as hasControlCommand, Xi as formatCliCommand, Z as shouldComputeCommandAuthorized, _n as loadWebMedia, b as resolveMentionGating, ci as resolveChannelGroupRequireMention, di as warnMissingProviderGroupPolicyFallbackOnce, g as resolveInboundSessionEnvelopeContext, j as dispatchReplyWithBufferedBlockDispatcher, jt as normalizeGroupActivation, kt as createDedupeCache, li as resolveDefaultGroupPolicy, nn as formatDurationPrecise, or as resolveGroupSessionKey, p as setActiveWebListener, rn as enqueueSystemEvent, si as resolveChannelGroupPolicy, ui as resolveOpenProviderRuntimeGroupPolicy, v as createConnectedChannelStatusPatch, vn as resolveMarkdownTableMode, w as recordPendingHistoryEntryIfEnabled, wi as resolveWhatsAppMediaMaxBytes, wn as resolveTextChunkLimit, wr as saveMediaBuffer, y as issuePairingChallenge, zt as resolveInboundLastRouteSessionKey } from "./model-auth-BS7HpR5p.js";
import { A as shouldLogVerbose, D as logVerbose, I as getChildLogger, d as normalizeE164, l as isSelfChatMode, m as resolveJidToE164, n as clamp, u as jidToE164, y as sleep } from "./utils-TRCG_6qz.js";
import "./paths-D6tDENa_.js";
import { a as createSubsystemLogger, l as defaultRuntime } from "./logger-FUtSVyxb.js";
...
import { i as markdownToWhatsApp, r as sendReactionWhatsApp, t as sendMessageWhatsApp } from "./outbound-Blp7M5KF.js";
import "./brazil-jid-resolver-BGqPyw4z.js";
import { i as waitForWaConnection, n as formatError, r as getStatusCode, t as createWaSocket } from "./session-BeYWuZZi.js";
import { i as noteContactName, r as loadContactNameCache, t as createWebSendApi } from "./send-api-D00OrIDv.js";
...
async function monitorWebInbox(options) {
	...
	const enqueueInboundMessage = async (msg, inbound, enriched) => {
		...
		const reply = async (text) => {
			const { processOutboundMentions } = await import("./send-api-D00OrIDv.js").then((n) => n.n);

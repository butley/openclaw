import { R as resolveStorePath, fn as normalizeAgentId, ln as buildGroupHistoryKey, on as DEFAULT_MAIN_KEY, sn as buildAgentMainSessionKey } from "./query-expansion-BxprTffT.js";
import "./paths-DinMprTu.js";
import { A as shouldLogVerbose, D as logVerbose, I as getChildLogger, d as normalizeE164, l as isSelfChatMode, m as resolveJidToE164, n as clamp, u as jidToE164, y as sleep } from "./utils-JVEJbNcG.js";
import { a as createSubsystemLogger, l as defaultRuntime } from "./logger-Db6pUr8E.js";
import { $ as finalizeInboundContext, $t as resolveOpenProviderRuntimeGroupPolicy, A as resolveDmGroupAccessWithCommandGate, An as resolveMarkdownTableMode, At as computeBackoff, B as formatInboundEnvelope, Bi as readWebSelfId, Bt as buildAgentSessionKey, C as createConnectedChannelStatusPatch, D as createReplyPrefixOptions, F as shouldAckReactionForWhatsApp, Fi as logWebSelfId, Fn as resolveChunkMode, Ft as normalizeGroupActivation, Ht as resolveAgentRoute, I as dispatchReplyWithBufferedBlockDispatcher, In as resolveTextChunkLimit, It as parseActivationCommand, Ji as formatCliCommand, Lt as upsertChannelPairingRequest, M as resolvePinnedMainDmOwnerFromAllowlist, Mi as resolveWhatsAppMediaMaxBytes, Mt as createDedupeCache, Ni as WA_WEB_AUTH_DIR, Nr as saveMediaBuffer, Pi as getWebAuthAgeMs, Pn as chunkMarkdownTextWithMode, Qt as resolveDefaultGroupPolicy, R as createInboundDebouncer, Ri as pickWebChannel, Rt as formatLocationText, T as resolveMentionGating, Ut as resolveInboundLastRouteSessionKey, V as getReplyFromConfig, Vt as deriveLastRoutePolicy, Wi as webAuthExists, Wr as registerUnhandledRejectionHandler, Y as convertMarkdownTables, Yr as loadConfig, _i as buildHistoryContextFromEntries, ai as normalizeStreamLevel, b as resolveInboundSessionEnvelopeContext, bi as buildMentionRegexes, en as warnMissingProviderGroupPolicyFallbackOnce, er as loadSessionStore, fa as resolveIdentityNamePrefix, hn as enqueueSystemEvent, hr as resolveGroupSessionKey, ia as resolveChannelGroupRequireMention, j as resolveDmGroupAccessWithLists, ji as resolveWhatsAppAccount, jt as sleepWithAbort, k as readStoreAllowFromForDmPolicy, kn as loadWebMedia, m as setActiveWebListener, mn as formatDurationPrecise, nr as updateLastRoute, nt as shouldComputeCommandAuthorized, pa as resolveMessagePrefix, qr as getAgentScopedMediaLocalRoots, ra as resolveChannelGroupPolicy, tr as recordSessionMetaFromInbound, tt as hasControlCommand, w as issuePairingChallenge, xi as normalizeMentionText, yi as recordPendingHistoryEntryIfEnabled, z as resolveInboundDebounceMs, zt as toLocationContext } from "./model-auth-DMfjgfhY.js";
...
import { i as markdownToWhatsApp, r as sendReactionWhatsApp, t as sendMessageWhatsApp } from "./outbound-B9BTpeMx.js";
import "./brazil-jid-resolver--EV3aC5l.js";
import { i as waitForWaConnection, n as formatError, r as getStatusCode, t as createWaSocket } from "./session-DcFsEx2Y.js";
import { i as noteContactName, r as loadContactNameCache, t as createWebSendApi } from "./send-api-DVnML6pu.js";
...
async function monitorWebInbox(options) {
	...
	const enqueueInboundMessage = async (msg, inbound, enriched) => {
		...
		const reply = async (text) => {
			const { processOutboundMentions } = await import("./send-api-DVnML6pu.js").then((n) => n.n);

import { Et as resolveSessionAgentId, It as ensureAgentWorkspace, R as resolveStorePath, St as resolveAgentWorkspaceDir, _n as resolveAgentIdFromSessionKey, gn as normalizeMainKey, gt as listAgentIds, hn as normalizeAgentId, vt as resolveAgentDir, wt as resolveEffectiveModelFallbacks, xt as resolveAgentSkillsFilter } from "./query-expansion-BMTgZQ3N.js";
import { $n as loadSessionStore, $r as readConfigFileSnapshotForWrite, An as isSilentReplyText, At as normalizeReplyPayload, B as clearSessionAuthProfileOverride, Bt as resolveOutboundTarget, Cr as normalizeMessageChannel, Ct as applyModelOverrideToSessionEntry, Et as resolveContextTokensForModel, Fi as formatCliCommand, Gn as buildProviderRegistry, Ht as resolveDiscordOwnerAccess, Jr as formatErrorMessage, Jt as buildOutboundSessionContext, K as getRemoteSkillEligibility, Kn as createMediaAttachmentCache, Kr as buildWorkspaceSkillSnapshot, L as getCliSessionId, Ln as resolveTtsConfig, Qn as emitSessionTranscriptUpdate, Qr as loadConfig, Qt as normalizeOutboundPayloadsForJson, R as setCliSessionId, Rn as textToSpeech, Rt as resolveAgentRoute, Sr as isInternalMessageChannel, St as AGENT_LANE_SUBAGENT, Tt as hasNonzeroUsage, U as formatMention, Ut as formatDiscordUserTag, V as applyVerboseOverride, Vt as resolveSessionDeliveryTarget, Xt as formatOutboundPayloadLog, Y as resolveSendPolicy, Yn as runCapability, Yt as deliverOutboundPayloads, Zn as resolveSessionTranscriptFile, Zr as loadModelCatalog, Zt as normalizeOutboundPayloads, _t as registerAgentRunContext, a as normalizeModelRef, ai as DEFAULT_PROVIDER, an as FailoverError, ar as evaluateSessionFreshness, b as isDangerousNameMatchingEnabled, br as isDeliverableMessageChannel, bt as resolveAcpDispatchPolicyError, c as resolveDefaultModelForAgent, cn as clearBootstrapSnapshotOnSessionRollover, cr as resolveSessionResetType, d as resolveCommandSecretRefsViaGateway, di as supportsXHighThinking, dr as resolveExplicitAgentSessionKey, ei as setRuntimeConfigSnapshot, et as runEmbeddedPiAgent, fr as getChannelPlugin, ft as resolveAgentTimeoutMs, gt as emitAgentEvent, ht as clearAgentRunContext, i as modelKey, ii as DEFAULT_MODEL, ir as resolveSessionKey, kn as isSilentReplyPrefixText, l as resolveThinkingDefault, li as normalizeThinkLevel, lr as mergeSessionEntry, mn as toAcpRuntimeError, mt as normalizeSpawnedRunMetadata, n as buildAllowedModelSet, nr as updateSessionStore, nt as resolveBootstrapWarningSignaturesSeen, o as normalizeProviderId, oi as formatThinkingLevels, or as resolveChannelResetConfig, pn as getAcpSessionManager, pr as normalizeChannelId, pt as formatAgentInternalEventsForPrompt, q as getSkillsSnapshotVersion, qn as normalizeMediaAttachments, r as isCliProvider, rn as runWithModelFallback, rr as normalizeAccountId, s as resolveConfiguredModelRef, si as formatXHighModelHint, sr as resolveSessionResetPolicy, t as ensureAuthProfileStore, tn as resolveMessageChannelSelection, tt as prepareSessionManagerForRun, u as getAgentRuntimeCommandSecretTargetIds, ui as normalizeVerboseLevel, ur as setSessionRuntimeModel, vt as resolveAcpSessionCwd, wr as resolveMessageChannel, wt as deriveSessionTotalTokens, xr as isGatewayMessageChannel, xt as AGENT_LANE_NESTED, yr as INTERNAL_MESSAGE_CHANNEL, yt as resolveAcpAgentPolicyError, z as runCliAgent, zn as parseTtsDirectives } from "./model-auth-BWjCRDK2.js";
import "./paths-Dmn791zP.js";
import { A as shouldLogVerbose, D as logVerbose, q as resolvePreferredOpenClawTmpDir } from "./utils-BdIQ65UN.js";
...
function loadWhatsAppSenderRuntime() {
	whatsappSenderRuntimePromise ??= import("./deps-send-whatsapp.runtime-n6a8mUW6.js");
	return whatsappSenderRuntimePromise;
}
function loadTelegramSenderRuntime() {
	telegramSenderRuntimePromise ??= import("./deps-send-telegram.runtime-DM8aiixU.js");
	return telegramSenderRuntimePromise;
}
function loadDiscordSenderRuntime() {
	discordSenderRuntimePromise ??= import("./deps-send-discord.runtime-CnLu4Mqo.js");
	return discordSenderRuntimePromise;
}
function loadSlackSenderRuntime() {
	slackSenderRuntimePromise ??= import("./deps-send-slack.runtime-CoGCFGPF.js");
	return slackSenderRuntimePromise;
}
function loadSignalSenderRuntime() {
	signalSenderRuntimePromise ??= import("./deps-send-signal.runtime-D0FR8Pjt.js");
	return signalSenderRuntimePromise;
}
function loadIMessageSenderRuntime() {
	imessageSenderRuntimePromise ??= import("./deps-send-imessage.runtime-CvW2dpSp.js");

import { Ct as resolveAgentWorkspaceDir, Dt as resolveSessionAgentId, Gt as ensureAgentWorkspace, R as resolveStorePath, St as resolveAgentSkillsFilter, Tt as resolveEffectiveModelFallbacks, _n as normalizeAgentId, _t as listAgentIds, vn as normalizeMainKey, yn as resolveAgentIdFromSessionKey, yt as resolveAgentDir } from "./query-expansion-CCRjQs0L.js";
import { $t as normalizeOutboundPayloadsForJson, An as isSilentReplyPrefixText, At as hasNonzeroUsage, Br as isGatewayMessageChannel, Ci as DEFAULT_PROVIDER, Ct as resolveAcpSessionCwd, Dt as AGENT_LANE_SUBAGENT, E as isDangerousNameMatchingEnabled, Et as AGENT_LANE_NESTED, Ft as normalizeReplyPayload, G as clearSessionAuthProfileOverride, Gn as buildProviderRegistry, Gt as resolveOutboundTarget, H as getCliSessionId, Hr as normalizeMessageChannel, Ii as formatCliCommand, J as formatMention, Jt as formatDiscordUserTag, K as applyVerboseOverride, Kn as createMediaAttachmentCache, Kt as resolveSessionDeliveryTarget, Ln as resolveTtsConfig, Ot as applyModelOverrideToSessionEntry, Q as getSkillsSnapshotVersion, Qt as normalizeOutboundPayloads, Rn as textToSpeech, Rr as INTERNAL_MESSAGE_CHANNEL, Si as DEFAULT_MODEL, St as registerAgentRunContext, Tt as resolveAcpDispatchPolicyError, U as setCliSessionId, Ur as resolveMessageChannel, Ut as resolveAgentRoute, Vr as isInternalMessageChannel, W as runCliAgent, Xt as deliverOutboundPayloads, Yn as runCapability, Yt as buildOutboundSessionContext, Z as getRemoteSkillEligibility, Zt as formatOutboundPayloadLog, _r as normalizeChannelId, _t as resolveAgentTimeoutMs, ai as formatErrorMessage, an as runWithModelFallback, at as runEmbeddedPiAgent, bi as supportsXHighThinking, bt as clearAgentRunContext, c as modelKey, cr as resolveSessionKey, d as resolveConfiguredModelRef, dr as resolveSessionResetPolicy, er as loadModelCatalog, et as resolveSendPolicy, f as resolveDefaultModelForAgent, fi as buildWorkspaceSkillSnapshot, fr as resolveSessionResetType, gi as formatXHighModelHint, gr as getChannelPlugin, h as resolveCommandSecretRefsViaGateway, hi as formatThinkingLevels, hn as toAcpRuntimeError, hr as resolveExplicitAgentSessionKey, i as setRuntimeConfigSnapshot, jn as isSilentReplyText, jt as resolveContextTokensForModel, kt as deriveSessionTotalTokens, l as normalizeModelRef, ln as clearBootstrapSnapshotOnSessionRollover, lr as evaluateSessionFreshness, m as getAgentRuntimeCommandSecretTargetIds, mi as ensureAuthProfileStore, mn as getAcpSessionManager, mr as setSessionRuntimeModel, n as loadConfig, nr as emitSessionTranscriptUpdate, o as buildAllowedModelSet, on as FailoverError, or as updateSessionStore, ot as prepareSessionManagerForRun, p as resolveThinkingDefault, pr as mergeSessionEntry, qn as normalizeMediaAttachments, qt as resolveDiscordOwnerAccess, r as readConfigFileSnapshotForWrite, rn as resolveMessageChannelSelection, rr as loadSessionStore, s as isCliProvider, sr as normalizeAccountId, st as resolveBootstrapWarningSignaturesSeen, tr as resolveSessionTranscriptFile, u as normalizeProviderId, ur as resolveChannelResetConfig, vi as normalizeThinkLevel, vt as formatAgentInternalEventsForPrompt, wt as resolveAcpAgentPolicyError, xt as emitAgentEvent, yi as normalizeVerboseLevel, yt as normalizeSpawnedRunMetadata, zn as parseTtsDirectives, zr as isDeliverableMessageChannel } from "./onboard-helpers-DNfqbxEP.js";
...
function loadWhatsAppSenderRuntime() {
	whatsappSenderRuntimePromise ??= import("./deps-send-whatsapp.runtime-DiXxWYAG.js");
	return whatsappSenderRuntimePromise;
}
function loadTelegramSenderRuntime() {
	telegramSenderRuntimePromise ??= import("./deps-send-telegram.runtime-CeYjwSv9.js");
	return telegramSenderRuntimePromise;
}
function loadDiscordSenderRuntime() {
	discordSenderRuntimePromise ??= import("./deps-send-discord.runtime-CsO-mqPJ.js");
	return discordSenderRuntimePromise;
}
function loadSlackSenderRuntime() {
	slackSenderRuntimePromise ??= import("./deps-send-slack.runtime-Db2lkEmx.js");
	return slackSenderRuntimePromise;
}
function loadSignalSenderRuntime() {
	signalSenderRuntimePromise ??= import("./deps-send-signal.runtime-Bahp28fT.js");
	return signalSenderRuntimePromise;
}
function loadIMessageSenderRuntime() {
	imessageSenderRuntimePromise ??= import("./deps-send-imessage.runtime-DE5qYR7n.js");

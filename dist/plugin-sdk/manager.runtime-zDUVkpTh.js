import { $t as normalizeAgentId, R as resolveStorePath, Tt as ensureAgentWorkspace, at as listAgentIds, dt as resolveAgentWorkspaceDir, en as normalizeMainKey, ht as resolveSessionAgentId, pt as resolveEffectiveModelFallbacks, st as resolveAgentDir, tn as resolveAgentIdFromSessionKey, ut as resolveAgentSkillsFilter } from "./query-expansion-Drh7939j.js";
import { A as shouldLogVerbose, D as logVerbose, q as resolvePreferredOpenClawTmpDir } from "./utils-Dn7zeJA1.js";
import "./paths-Dmn791zP.js";
import { a as createSubsystemLogger, l as defaultRuntime } from "./logger-CsS7uJ1Q.js";
import { $ as resolveSendPolicy, $n as resolveSessionTranscriptFile, At as resolveContextTokensForModel, Bn as textToSpeech, Ci as formatThinkingLevels, Ct as resolveAcpAgentPolicyError, Di as normalizeVerboseLevel, Dt as applyModelOverrideToSessionEntry, Ei as normalizeThinkLevel, Et as AGENT_LANE_SUBAGENT, Fr as isDeliverableMessageChannel, Ft as normalizeReplyPayload, G as applyVerboseOverride, Gt as resolveOutboundTarget, H as setCliSessionId, Ir as isGatewayMessageChannel, Jn as createMediaAttachmentCache, Jt as formatDiscordUserTag, Kt as resolveSessionDeliveryTarget, Lr as isInternalMessageChannel, Mn as isSilentReplyPrefixText, Nn as isSilentReplyText, Oi as supportsXHighThinking, Ot as deriveSessionTotalTokens, Pr as INTERNAL_MESSAGE_CHANNEL, Rr as normalizeMessageChannel, Si as DEFAULT_PROVIDER, Sn as toAcpRuntimeError, St as resolveAcpSessionCwd, Tt as AGENT_LANE_NESTED, U as runCliAgent, Ut as resolveAgentRoute, V as getCliSessionId, Vn as parseTtsDirectives, W as clearSessionAuthProfileOverride, X as getRemoteSkillEligibility, Yn as normalizeMediaAttachments, Z as getSkillsSnapshotVersion, Zn as runCapability, _t as formatAgentInternalEventsForPrompt, a as normalizeModelRef, an as normalizeOutboundPayloads, ar as normalizeAccountId, at as prepareSessionManagerForRun, bt as emitAgentEvent, c as resolveDefaultModelForAgent, cr as resolveChannelResetConfig, d as resolveCommandSecretRefsViaGateway, dn as runWithModelFallback, dr as mergeSessionEntry, er as emitSessionTranscriptUpdate, fr as setSessionRuntimeModel, gi as setRuntimeConfigSnapshot, gn as clearBootstrapSnapshotOnSessionRollover, gt as resolveAgentTimeoutMs, hi as readConfigFileSnapshotForWrite, hr as normalizeChannelId, i as modelKey, in as formatOutboundPayloadLog, ir as updateSessionStore, it as runEmbeddedPiAgent, ji as formatCliCommand, kt as hasNonzeroUsage, l as resolveThinkingDefault, ln as resolveMessageChannelSelection, lr as resolveSessionResetPolicy, mi as loadConfig, mr as getChannelPlugin, n as buildAllowedModelSet, nn as buildOutboundSessionContext, o as normalizeProviderId, on as normalizeOutboundPayloadsForJson, or as resolveSessionKey, ot as resolveBootstrapWarningSignaturesSeen, pi as loadModelCatalog, pn as FailoverError, pr as resolveExplicitAgentSessionKey, q as formatMention, qn as buildProviderRegistry, qt as resolveDiscordOwnerAccess, r as isCliProvider, rn as deliverOutboundPayloads, s as resolveConfiguredModelRef, si as buildWorkspaceSkillSnapshot, sr as evaluateSessionFreshness, t as ensureAuthProfileStore, tr as loadSessionStore, u as getAgentRuntimeCommandSecretTargetIds, ui as formatErrorMessage, ur as resolveSessionResetType, vt as normalizeSpawnedRunMetadata, w as isDangerousNameMatchingEnabled, wi as formatXHighModelHint, wt as resolveAcpDispatchPolicyError, xi as DEFAULT_MODEL, xn as getAcpSessionManager, xt as registerAgentRunContext, yt as clearAgentRunContext, zn as resolveTtsConfig, zr as resolveMessageChannel } from "./model-auth-DNLOR58z.js";
...
function loadWhatsAppSenderRuntime() {
	whatsappSenderRuntimePromise ??= import("./deps-send-whatsapp.runtime-5-z3bByc.js");
	return whatsappSenderRuntimePromise;
}
function loadTelegramSenderRuntime() {
	telegramSenderRuntimePromise ??= import("./deps-send-telegram.runtime-D3VnA9XX.js");
	return telegramSenderRuntimePromise;
}
function loadDiscordSenderRuntime() {
	discordSenderRuntimePromise ??= import("./deps-send-discord.runtime-Dg269lgr.js");
	return discordSenderRuntimePromise;
}
function loadSlackSenderRuntime() {
	slackSenderRuntimePromise ??= import("./deps-send-slack.runtime-BTOsXC3i.js");
	return slackSenderRuntimePromise;
}
function loadSignalSenderRuntime() {
	signalSenderRuntimePromise ??= import("./deps-send-signal.runtime-DIwkjnaP.js");
	return signalSenderRuntimePromise;
}
function loadIMessageSenderRuntime() {
	imessageSenderRuntimePromise ??= import("./deps-send-imessage.runtime-BTgTkXbd.js");

import { $t as normalizeAgentId, Jt as buildAgentMainSessionKey, R as resolveStorePath, Xt as buildGroupHistoryKey, qt as DEFAULT_MAIN_KEY } from "./query-expansion-BPUkatG6.js";
import { A as shouldLogVerbose, D as logVerbose, I as getChildLogger, d as normalizeE164, l as isSelfChatMode, m as resolveJidToE164, n as clamp, u as jidToE164, y as sleep } from "./utils-AQ99HeFP.js";
import "./paths-Dmn791zP.js";
import { a as createSubsystemLogger, l as defaultRuntime } from "./logger-Dqg6iK_S.js";
import { $n as recordSessionMetaFromInbound, $r as loadConfig, A as resolvePinnedMainDmOwnerFromAllowlist, B as getReplyFromConfig, Bi as pickWebChannel, Bt as resolveAgentRoute, D as readStoreAllowFromForDmPolicy, Dn as resolveMarkdownTableMode, E as recordPendingHistoryEntryIfEnabled, En as loadWebMedia, F as createInboundDebouncer, Fi as WA_WEB_AUTH_DIR, Fn as resolveMessagePrefix, Ft as normalizeGroupActivation, Hi as readWebSelfId, I as resolveInboundDebounceMs, Ii as getWebAuthAgeMs, It as parseActivationCommand, J as convertMarkdownTables, Jr as registerUnhandledRejectionHandler, Ki as webAuthExists, L as formatInboundEnvelope, Li as logWebSelfId, Lt as upsertChannelPairingRequest, M as shouldAckReactionForWhatsApp, Mn as resolveChunkMode, Mt as sleepWithAbort, N as dispatchReplyWithBufferedBlockDispatcher, Ni as resolveWhatsAppAccount, Nn as resolveTextChunkLimit, Nt as createDedupeCache, O as resolveDmGroupAccessWithCommandGate, Oi as formatLocationText, Pi as resolveWhatsAppMediaMaxBytes, Pn as resolveIdentityNamePrefix, Pr as saveMediaBuffer, Q as finalizeInboundContext, Qn as loadSessionStore, Qt as warnMissingProviderGroupPolicyFallbackOnce, Rt as buildAgentSessionKey, T as buildHistoryContextFromEntries, Vt as resolveInboundLastRouteSessionKey, Xt as resolveDefaultGroupPolicy, Zi as formatCliCommand, Zr as getAgentScopedMediaLocalRoots, Zt as resolveOpenProviderRuntimeGroupPolicy, _ as resolveInboundSessionEnvelopeContext, b as issuePairingChallenge, dn as formatDurationPrecise, er as updateLastRoute, et as hasControlCommand, fn as enqueueSystemEvent, gr as resolveGroupSessionKey, jn as chunkMarkdownTextWithMode, jt as computeBackoff, k as resolveDmGroupAccessWithLists, ki as toLocationContext, li as normalizeStreamLevel, m as setActiveWebListener, mr as resolveChannelGroupRequireMention, nt as buildMentionRegexes, pr as resolveChannelGroupPolicy, rt as normalizeMentionText, tt as shouldComputeCommandAuthorized, w as createReplyPrefixOptions, x as resolveMentionGating, y as createConnectedChannelStatusPatch, zt as deriveLastRoutePolicy } from "./model-auth-B9IUb6BE.js";
...
import { i as markdownToWhatsApp, r as sendReactionWhatsApp, t as sendMessageWhatsApp } from "./outbound-CHWS6Kbt.js";
import "./brazil-jid-resolver-DlFWgrqS.js";
import { i as waitForWaConnection, n as formatError, r as getStatusCode, t as createWaSocket } from "./session-Dj1wn1Rp.js";
import { i as noteContactName, r as loadContactNameCache, t as createWebSendApi } from "./send-api-CyN9OjoN.js";
...
async function monitorWebInbox(options) {
	...
	const enqueueInboundMessage = async (msg, inbound, enriched) => {
		...
		const reply = async (text) => {
			const { processOutboundMentions } = await import("./send-api-CyN9OjoN.js").then((n) => n.n);

import { R as resolveStorePath, fn as buildGroupHistoryKey, hn as normalizeAgentId, ln as DEFAULT_MAIN_KEY, un as buildAgentMainSessionKey } from "./query-expansion-DWjVp8XV.js";
import { A as readStoreAllowFromForDmPolicy, Ai as readWebSelfId, An as resolveMarkdownTableMode, B as getReplyFromConfig, Bt as buildAgentSessionKey, C as createConnectedChannelStatusPatch, Ci as WA_WEB_AUTH_DIR, D as createReplyPrefixOptions, F as dispatchReplyWithBufferedBlockDispatcher, Fn as resolveMessagePrefix, Ft as normalizeGroupActivation, Gi as formatCliCommand, Ht as resolveAgentRoute, It as parseActivationCommand, J as convertMarkdownTables, L as createInboundDebouncer, Lt as upsertChannelPairingRequest, M as resolveDmGroupAccessWithLists, Mt as sleepWithAbort, N as resolvePinnedMainDmOwnerFromAllowlist, Nt as createDedupeCache, O as buildHistoryContextFromEntries, Oi as pickWebChannel, P as shouldAckReactionForWhatsApp, Pi as webAuthExists, Pn as resolveIdentityNamePrefix, Pr as saveMediaBuffer, Q as finalizeInboundContext, Qn as getAgentScopedMediaLocalRoots, Qr as normalizeStreamLevel, R as resolveInboundDebounceMs, Rt as formatLocationText, Si as resolveWhatsAppMediaMaxBytes, Sr as resolveGroupSessionKey, T as resolveMentionGating, Ti as logWebSelfId, Ut as resolveInboundLastRouteSessionKey, Vt as deriveLastRoutePolicy, Xn as registerUnhandledRejectionHandler, Xt as resolveOpenProviderRuntimeGroupPolicy, Yt as resolveDefaultGroupPolicy, Zt as warnMissingProviderGroupPolicyFallbackOnce, br as resolveChannelGroupRequireMention, ci as resolveTextChunkLimit, et as hasControlCommand, ir as updateLastRoute, j as resolveDmGroupAccessWithCommandGate, jt as computeBackoff, k as recordPendingHistoryEntryIfEnabled, kn as loadWebMedia, ln as formatDurationPrecise, n as loadConfig, nr as loadSessionStore, nt as buildMentionRegexes, oi as chunkMarkdownTextWithMode, rr as recordSessionMetaFromInbound, rt as normalizeMentionText, si as resolveChunkMode, tt as shouldComputeCommandAuthorized, un as enqueueSystemEvent, v as setActiveWebListener, w as issuePairingChallenge, wi as getWebAuthAgeMs, x as resolveInboundSessionEnvelopeContext, xi as resolveWhatsAppAccount, yr as resolveChannelGroupPolicy, z as formatInboundEnvelope, zt as toLocationContext } from "./send-CwvTMBTz.js";
import { A as shouldLogVerbose, D as logVerbose, I as getChildLogger, d as normalizeE164, l as isSelfChatMode, m as resolveJidToE164, n as clamp, u as jidToE164, y as sleep } from "./utils-DQ-ML02Y.js";
import "./paths-D6tDENa_.js";
import { a as createSubsystemLogger, l as defaultRuntime } from "./logger-B-E3Q8nf.js";
...
import { i as markdownToWhatsApp, r as sendReactionWhatsApp, t as sendMessageWhatsApp } from "./outbound-3vVTnTvW.js";
import "./brazil-jid-resolver-CfFJxvpm.js";
import { i as waitForWaConnection, n as formatError, r as getStatusCode, t as createWaSocket } from "./session-BwYPxcwJ.js";
import { i as noteContactName, r as loadContactNameCache, t as createWebSendApi } from "./send-api-BMFbtO8N.js";
import { t as loginWeb } from "./login-BSrWvnl-.js";
...
async function monitorWebInbox(options) {
	...
	const enqueueInboundMessage = async (msg, inbound, enriched) => {
		...
		const reply = async (text) => {
			const { processOutboundMentions } = await import("./send-api-BMFbtO8N.js").then((n) => n.n);

import { Dn as DEFAULT_ACCOUNT_ID, R as resolveStorePath, _n as buildGroupHistoryKey, bn as normalizeAgentId, hn as buildAgentMainSessionKey, mn as DEFAULT_MAIN_KEY } from "./query-expansion-BdKlqnVJ.js";
import { $s as resolveChannelGroupRequireMention, $t as createInboundDebouncer, At as recordPendingHistoryEntryIfEnabled, Ba as loadSessionStore, Cn as finalizeInboundContext, Dn as buildMentionRegexes, Ea as getAgentScopedMediaLocalRoots, En as shouldComputeCommandAuthorized, H as setActiveWebListener, Ha as updateLastRoute, Hc as normalizeChatChannelId, It as resolveDmGroupAccessWithCommandGate, Ji as chunkMarkdownTextWithMode, Kr as warnMissingProviderGroupPolicyFallbackOnce, Kt as convertMarkdownTables, Lt as resolveDmGroupAccessWithLists, Nt as readStoreAllowFromForDmPolicy, On as normalizeMentionText, Qs as resolveChannelGroupPolicy, Tc as saveMediaBuffer, Tn as hasControlCommand, Ui as loadWebMedia, Ur as resolveDefaultGroupPolicy, Va as recordSessionMetaFromInbound, Wi as resolveMarkdownTableMode, Wr as resolveOpenProviderRuntimeGroupPolicy, Xi as resolveTextChunkLimit, Xt as shouldAckReactionForWhatsApp, Yi as resolveChunkMode, Zt as dispatchReplyWithBufferedBlockDispatcher, _r as buildAgentSessionKey, an as getReplyFromConfig, br as resolveInboundLastRouteSessionKey, ci as formatDurationPrecise, cr as parseActivationCommand, dl as normalizeStreamLevel, dr as readChannelAllowFromStoreSync, ea as resolveIdentityNamePrefix, en as resolveInboundDebounceMs, et as resolveInboundSessionEnvelopeContext, fr as upsertChannelPairingRequest, ft as createConnectedChannelStatusPatch, gr as toLocationContext, gs as resolveWhatsAppMediaMaxBytes, hr as formatLocationText, i as loadConfig, ir as createDedupeCache, li as enqueueSystemEvent, ms as resolveWhatsAppAccount, mt as resolveMentionGating, nc as resolveGroupSessionKey, nl as formatCliCommand, nr as computeBackoff, pt as issuePairingChallenge, rr as sleepWithAbort, sr as normalizeGroupActivation, ta as resolveMessagePrefix, tn as formatInboundEnvelope, vr as deriveLastRoutePolicy, vs as getWebAuthAgeMs, wa as registerUnhandledRejectionHandler, ws as readWebSelfId, wt as buildHistoryContextFromEntries, yr as resolveAgentRoute, yt as createReplyPrefixOptions, zt as resolvePinnedMainDmOwnerFromAllowlist } from "./thread-bindings-vVd-6uYc.js";
import { A as shouldLogVerbose, D as logVerbose, I as getChildLogger, d as normalizeE164, l as isSelfChatMode, m as resolveJidToE164, n as clamp, u as jidToE164, y as sleep } from "./utils-C8fHFCVG.js";
import { a as createSubsystemLogger, l as defaultRuntime } from "./logger-CxSdVzf_.js";
import { n as recordChannelActivity } from "./channel-activity-DVuTt2Mq.js";
import { i as markdownToWhatsApp, r as sendReactionWhatsApp } from "./outbound-NytA87EE.js";
import { i as waitForWaConnection, n as formatError, r as getStatusCode, t as createWaSocket } from "./session-DrbDh_Vc.js";
import { i as noteContactName, r as loadContactNameCache, t as createWebSendApi } from "./send-api-B95H4kh2.js";
...
async function monitorWebInbox(options) {
	...
	const enqueueInboundMessage = async (msg, inbound, enriched) => {
		...
		const reply = async (text) => {
			const { processOutboundMentions } = await import("./send-api-B95H4kh2.js").then((n) => n.n);

import { Et as resolveSessionAgentId, It as ensureAgentWorkspace, R as resolveStorePath, St as resolveAgentWorkspaceDir, fn as normalizeAgentId, gt as listAgentIds, mn as resolveAgentIdFromSessionKey, pn as normalizeMainKey, vt as resolveAgentDir, wt as resolveEffectiveModelFallbacks, xt as resolveAgentSkillsFilter } from "./query-expansion-BxprTffT.js";
import "./paths-DinMprTu.js";
import { A as shouldLogVerbose, D as logVerbose, q as resolvePreferredOpenClawTmpDir } from "./utils-JVEJbNcG.js";
import { a as createSubsystemLogger, l as defaultRuntime } from "./logger-Db6pUr8E.js";
import { $n as emitSessionTranscriptUpdate, Ci as normalizeChannelId, Ct as resolveAcpDispatchPolicyError, Dt as deriveSessionTotalTokens, E as isDangerousNameMatchingEnabled, Et as applyModelOverrideToSessionEntry, G as clearSessionAuthProfileOverride, Gr as formatErrorMessage, H as getCliSessionId, Ht as resolveAgentRoute, J as formatMention, Ji as formatCliCommand, Jn as normalizeMediaAttachments, Jr as loadModelCatalog, Jt as resolveOutboundTarget, K as applyVerboseOverride, Kn as buildProviderRegistry, Ln as resolveTtsConfig, Mn as isSilentReplyPrefixText, Nn as isSilentReplyText, Ot as hasNonzeroUsage, Pt as normalizeReplyPayload, Q as getSkillsSnapshotVersion, Qn as resolveSessionTranscriptFile, Rn as textToSpeech, Si as getChannelPlugin, Sn as toAcpRuntimeError, St as resolveAcpAgentPolicyError, Tt as AGENT_LANE_SUBAGENT, U as setCliSessionId, Ur as buildWorkspaceSkillSnapshot, W as runCliAgent, Xn as runCapability, Xr as readConfigFileSnapshotForWrite, Xt as resolveDiscordOwnerAccess, Yr as loadConfig, Yt as resolveSessionDeliveryTarget, Z as getRemoteSkillEligibility, Zr as setRuntimeConfigSnapshot, Zt as formatDiscordUserTag, _r as isDeliverableMessageChannel, _t as normalizeSpawnedRunMetadata, a as normalizeModelRef, an as normalizeOutboundPayloadsForJson, ar as normalizeAccountId, at as resolveBootstrapWarningSignaturesSeen, br as normalizeMessageChannel, bt as registerAgentRunContext, c as resolveDefaultModelForAgent, ci as supportsXHighThinking, cr as resolveChannelResetConfig, d as resolveCommandSecretRefsViaGateway, dn as runWithModelFallback, dr as mergeSessionEntry, er as loadSessionStore, et as resolveSendPolicy, fr as setSessionRuntimeModel, gn as clearBootstrapSnapshotOnSessionRollover, gr as INTERNAL_MESSAGE_CHANNEL, gt as formatAgentInternalEventsForPrompt, ht as resolveAgentTimeoutMs, i as modelKey, ii as formatXHighModelHint, in as normalizeOutboundPayloads, it as prepareSessionManagerForRun, kt as resolveContextTokensForModel, l as resolveThinkingDefault, ln as resolveMessageChannelSelection, lr as resolveSessionResetPolicy, n as buildAllowedModelSet, ni as DEFAULT_PROVIDER, nn as deliverOutboundPayloads, o as normalizeProviderId, oi as normalizeThinkLevel, or as resolveSessionKey, pn as FailoverError, pr as resolveExplicitAgentSessionKey, qn as createMediaAttachmentCache, r as isCliProvider, ri as formatThinkingLevels, rn as formatOutboundPayloadLog, rr as updateSessionStore, rt as runEmbeddedPiAgent, s as resolveConfiguredModelRef, si as normalizeVerboseLevel, sr as evaluateSessionFreshness, t as ensureAuthProfileStore, ti as DEFAULT_MODEL, tn as buildOutboundSessionContext, u as getAgentRuntimeCommandSecretTargetIds, ur as resolveSessionResetType, vr as isGatewayMessageChannel, vt as clearAgentRunContext, wt as AGENT_LANE_NESTED, xn as getAcpSessionManager, xr as resolveMessageChannel, xt as resolveAcpSessionCwd, yr as isInternalMessageChannel, yt as emitAgentEvent, zn as parseTtsDirectives } from "./model-auth-DMfjgfhY.js";
...
function loadWhatsAppSenderRuntime() {
	whatsappSenderRuntimePromise ??= import("./deps-send-whatsapp.runtime-BPegG9LT.js");
	return whatsappSenderRuntimePromise;
}
function loadTelegramSenderRuntime() {
	telegramSenderRuntimePromise ??= import("./deps-send-telegram.runtime-Cv1woBOA.js");
	return telegramSenderRuntimePromise;
}
function loadDiscordSenderRuntime() {
	discordSenderRuntimePromise ??= import("./deps-send-discord.runtime-dCqV1Gk-.js");
	return discordSenderRuntimePromise;
}
function loadSlackSenderRuntime() {
	slackSenderRuntimePromise ??= import("./deps-send-slack.runtime-BHaF2ytq.js");
	return slackSenderRuntimePromise;
}
function loadSignalSenderRuntime() {
	signalSenderRuntimePromise ??= import("./deps-send-signal.runtime-BwdK9-CI.js");
	return signalSenderRuntimePromise;
}
function loadIMessageSenderRuntime() {
	imessageSenderRuntimePromise ??= import("./deps-send-imessage.runtime--_c-iWsj.js");

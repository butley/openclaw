import { $ as formatMention, Ai as getChannelPlugin, At as deriveSessionTotalTokens, Bn as parseTtsDirectives, Cr as isInternalMessageChannel, Ct as registerAgentRunContext, D as isDangerousNameMatchingEnabled, Dt as AGENT_LANE_NESTED, Et as resolveAcpDispatchPolicyError, Hr as formatErrorMessage, It as normalizeReplyPayload, J as runCliAgent, Jn as normalizeMediaAttachments, Jt as resolveDiscordOwnerAccess, K as getCliSessionId, Kn as buildProviderRegistry, Kt as resolveOutboundTarget, Mn as isSilentReplyText, Mt as resolveContextTokensForModel, Ot as AGENT_LANE_SUBAGENT, Rn as resolveTtsConfig, Si as buildWorkspaceSkillSnapshot, Sr as isGatewayMessageChannel, St as emitAgentEvent, Tr as resolveMessageChannel, Tt as resolveAcpAgentPolicyError, Wt as resolveAgentRoute, X as clearSessionAuthProfileOverride, Xn as runCapability, Yt as formatDiscordUserTag, Z as applyVerboseOverride, _r as resolveExplicitAgentSessionKey, an as normalizeOutboundPayloadsForJson, bi as getRemoteSkillEligibility, bn as getAcpSessionManager, br as INTERNAL_MESSAGE_CHANNEL, bt as normalizeSpawnedRunMetadata, c as isCliProvider, ct as resolveBootstrapWarningSignaturesSeen, d as normalizeProviderId, di as formatThinkingLevels, dn as runWithModelFallback, dr as evaluateSessionFreshness, f as resolveConfiguredModelRef, fi as formatXHighModelHint, fn as FailoverError, fr as resolveChannelResetConfig, g as resolveCommandSecretRefsViaGateway, gi as supportsXHighThinking, gr as setSessionRuntimeModel, h as getAgentRuntimeCommandSecretTargetIds, hi as normalizeVerboseLevel, hn as clearBootstrapSnapshotOnSessionRollover, hr as mergeSessionEntry, in as normalizeOutboundPayloads, ir as loadSessionStore, ji as normalizeChannelId, jn as isSilentReplyPrefixText, jt as hasNonzeroUsage, kt as applyModelOverrideToSessionEntry, l as modelKey, ln as resolveMessageChannelSelection, lr as normalizeAccountId, m as resolveThinkingDefault, mi as normalizeThinkLevel, mr as resolveSessionResetType, ni as readConfigFileSnapshotForWrite, nn as deliverOutboundPayloads, nr as resolveSessionTranscriptFile, ot as runEmbeddedPiAgent, p as resolveDefaultModelForAgent, pr as resolveSessionResetPolicy, q as setCliSessionId, qn as createMediaAttachmentCache, qt as resolveSessionDeliveryTarget, ri as setRuntimeConfigSnapshot, rn as formatOutboundPayloadLog, rr as emitSessionTranscriptUpdate, rt as resolveSendPolicy, s as buildAllowedModelSet, sr as updateSessionStore, st as prepareSessionManagerForRun, ta as formatCliCommand, ti as loadConfig, tn as buildOutboundSessionContext, tr as loadModelCatalog, u as normalizeModelRef, ui as ensureAuthProfileStore, ur as resolveSessionKey, vi as DEFAULT_MODEL, vt as resolveAgentTimeoutMs, wr as normalizeMessageChannel, wt as resolveAcpSessionCwd, xi as getSkillsSnapshotVersion, xn as toAcpRuntimeError, xr as isDeliverableMessageChannel, xt as clearAgentRunContext, yi as DEFAULT_PROVIDER, yt as formatAgentInternalEventsForPrompt, zn as textToSpeech } from "./skill-commands-U25WKbOZ.js";
import { Et as resolveSessionAgentId, It as ensureAgentWorkspace, R as resolveStorePath, St as resolveAgentWorkspaceDir, fn as normalizeAgentId, gt as listAgentIds, mn as resolveAgentIdFromSessionKey, pn as normalizeMainKey, vt as resolveAgentDir, wt as resolveEffectiveModelFallbacks, xt as resolveAgentSkillsFilter } from "./query-expansion-Dw2mzlyF.js";
import "./paths-DBpXUsXY.js";
import { A as shouldLogVerbose, D as logVerbose, q as resolvePreferredOpenClawTmpDir } from "./utils-C6un-a5o.js";
...
function loadWhatsAppSenderRuntime() {
	whatsappSenderRuntimePromise ??= import("./deps-send-whatsapp.runtime-BiEIl_kw.js");
	return whatsappSenderRuntimePromise;
}
function loadTelegramSenderRuntime() {
	telegramSenderRuntimePromise ??= import("./deps-send-telegram.runtime-BosUz8yb.js");
	return telegramSenderRuntimePromise;
}
function loadDiscordSenderRuntime() {
	discordSenderRuntimePromise ??= import("./deps-send-discord.runtime-B-eTBFF0.js");
	return discordSenderRuntimePromise;
}
function loadSlackSenderRuntime() {
	slackSenderRuntimePromise ??= import("./deps-send-slack.runtime-Dty8nIfx.js");
	return slackSenderRuntimePromise;
}
function loadSignalSenderRuntime() {
	signalSenderRuntimePromise ??= import("./deps-send-signal.runtime-C0_A30ht.js");
	return signalSenderRuntimePromise;
}
function loadIMessageSenderRuntime() {
	imessageSenderRuntimePromise ??= import("./deps-send-imessage.runtime-DynBHUVF.js");

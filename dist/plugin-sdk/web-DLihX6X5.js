import { $t as normalizeAgentId, Jt as buildAgentMainSessionKey, R as resolveStorePath, Xt as buildGroupHistoryKey, qt as DEFAULT_MAIN_KEY } from "./query-expansion-DLDOQvjB.js";
import { A as shouldLogVerbose, D as logVerbose, I as getChildLogger, d as normalizeE164, l as isSelfChatMode, m as resolveJidToE164, n as clamp, u as jidToE164, y as sleep } from "./utils-Dn7zeJA1.js";
import "./paths-Dmn791zP.js";
import { a as createSubsystemLogger, l as defaultRuntime } from "./logger-CsS7uJ1Q.js";
import { $t as resolveDefaultGroupPolicy, A as recordPendingHistoryEntryIfEnabled, Ai as normalizeStreamLevel, An as resolveMarkdownTableMode, Ar as webAuthExists, B as createInboundDebouncer, Bt as parseActivationCommand, C as issuePairingChallenge, D as createReplyPrefixOptions, Er as readWebSelfId, Fi as formatCliCommand, Fn as resolveChunkMode, Ft as sleepWithAbort, Gt as deriveLastRoutePolicy, H as formatInboundEnvelope, Ht as formatLocationText, In as resolveTextChunkLimit, Ir as resolveChannelGroupPolicy, It as createDedupeCache, Kt as resolveAgentRoute, L as shouldAckReactionForWhatsApp, Lr as resolveChannelGroupRequireMention, M as resolveDmGroupAccessWithCommandGate, N as resolveDmGroupAccessWithLists, P as resolvePinnedMainDmOwnerFromAllowlist, Pn as chunkMarkdownTextWithMode, Pt as computeBackoff, R as dispatchReplyWithBufferedBlockDispatcher, Rn as resolveIdentityNamePrefix, S as createConnectedChannelStatusPatch, U as getReplyFromConfig, Ut as toLocationContext, V as resolveInboundDebounceMs, Vt as upsertChannelPairingRequest, Wt as buildAgentSessionKey, Z as convertMarkdownTables, _r as resolveWhatsAppAccount, at as buildMentionRegexes, br as getWebAuthAgeMs, en as resolveOpenProviderRuntimeGroupPolicy, gi as registerUnhandledRejectionHandler, hn as enqueueSystemEvent, ir as updateLastRoute, it as shouldComputeCommandAuthorized, j as readStoreAllowFromForDmPolicy, k as buildHistoryContextFromEntries, kn as loadWebMedia, mn as formatDurationPrecise, nr as loadSessionStore, ot as normalizeMentionText, p as setActiveWebListener, qt as resolveInboundLastRouteSessionKey, ri as saveMediaBuffer, rr as recordSessionMetaFromInbound, rt as hasControlCommand, tn as warnMissingProviderGroupPolicyFallbackOnce, tt as finalizeInboundContext, v as resolveInboundSessionEnvelopeContext, vr as resolveWhatsAppMediaMaxBytes, w as resolveMentionGating, wr as pickWebChannel, xi as loadConfig, xr as logWebSelfId, yi as getAgentScopedMediaLocalRoots, yr as WA_WEB_AUTH_DIR, zn as resolveMessagePrefix, zr as resolveGroupSessionKey, zt as normalizeGroupActivation } from "./model-auth-BHLRs93v.js";
...
import { i as markdownToWhatsApp, r as sendReactionWhatsApp, t as sendMessageWhatsApp } from "./outbound-DAtJEUkv.js";
import "./brazil-jid-resolver-DoKIKiSa.js";
import { i as waitForWaConnection, n as formatError, r as getStatusCode, t as createWaSocket } from "./session-BiO19npI.js";
import { i as noteContactName, r as loadContactNameCache, t as createWebSendApi } from "./send-api-BpCS3TfM.js";
...
async function monitorWebInbox(options) {
	...
	const enqueueInboundMessage = async (msg, inbound, enriched) => {
		...
		const reply = async (text) => {
			const { processOutboundMentions } = await import("./send-api-BpCS3TfM.js").then((n) => n.n);

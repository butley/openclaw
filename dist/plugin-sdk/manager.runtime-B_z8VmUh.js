import { $t as normalizeAgentId, R as resolveStorePath, Tt as ensureAgentWorkspace, at as listAgentIds, dt as resolveAgentWorkspaceDir, en as normalizeMainKey, ht as resolveSessionAgentId, pt as resolveEffectiveModelFallbacks, st as resolveAgentDir, tn as resolveAgentIdFromSessionKey, ut as resolveAgentSkillsFilter } from "./query-expansion-BPUkatG6.js";
import { A as shouldLogVerbose, D as logVerbose, q as resolvePreferredOpenClawTmpDir } from "./utils-AQ99HeFP.js";
import "./paths-Dmn791zP.js";
import { a as createSubsystemLogger, l as defaultRuntime } from "./logger-Dqg6iK_S.js";
import { $ as resolveSendPolicy, $r as loadConfig, $t as buildOutboundSessionContext, An as isSilentReplyText, At as resolveContextTokensForModel, Bt as resolveAgentRoute, Ct as resolveAcpAgentPolicyError, Dt as applyModelOverrideToSessionEntry, Et as AGENT_LANE_SUBAGENT, G as applyVerboseOverride, Gn as createMediaAttachmentCache, Gt as formatDiscordUserTag, H as setCliSessionId, Ht as resolveOutboundTarget, In as resolveTtsConfig, Jn as runCapability, Kn as normalizeMediaAttachments, Ln as textToSpeech, Ot as deriveSessionTotalTokens, Pt as normalizeReplyPayload, Qn as loadSessionStore, Qr as loadModelCatalog, Rn as parseTtsDirectives, S as isDangerousNameMatchingEnabled, Sr as resolveMessageChannel, St as resolveAcpSessionCwd, Tt as AGENT_LANE_NESTED, U as runCliAgent, Ut as resolveSessionDeliveryTarget, V as getCliSessionId, W as clearSessionAuthProfileOverride, Wn as buildProviderRegistry, Wr as buildWorkspaceSkillSnapshot, Wt as resolveDiscordOwnerAccess, X as getRemoteSkillEligibility, Xn as resolveSessionTranscriptFile, Yr as formatErrorMessage, Z as getSkillsSnapshotVersion, Zi as formatCliCommand, Zn as emitSessionTranscriptUpdate, _r as INTERNAL_MESSAGE_CHANNEL, _t as formatAgentInternalEventsForPrompt, a as normalizeModelRef, ai as DEFAULT_MODEL, ar as resolveChannelResetConfig, at as prepareSessionManagerForRun, br as isInternalMessageChannel, bt as emitAgentEvent, c as resolveDefaultModelForAgent, ci as formatXHighModelHint, cn as runWithModelFallback, cr as mergeSessionEntry, d as resolveCommandSecretRefsViaGateway, di as normalizeVerboseLevel, dr as getChannelPlugin, ei as readConfigFileSnapshotForWrite, en as deliverOutboundPayloads, fi as supportsXHighThinking, fr as normalizeChannelId, gt as resolveAgentTimeoutMs, i as modelKey, ir as evaluateSessionFreshness, it as runEmbeddedPiAgent, kn as isSilentReplyPrefixText, kt as hasNonzeroUsage, l as resolveThinkingDefault, lr as setSessionRuntimeModel, n as buildAllowedModelSet, nn as normalizeOutboundPayloads, nr as normalizeAccountId, o as normalizeProviderId, oi as DEFAULT_PROVIDER, on as resolveMessageChannelSelection, or as resolveSessionResetPolicy, ot as resolveBootstrapWarningSignaturesSeen, pn as clearBootstrapSnapshotOnSessionRollover, q as formatMention, r as isCliProvider, rn as normalizeOutboundPayloadsForJson, rr as resolveSessionKey, s as resolveConfiguredModelRef, si as formatThinkingLevels, sr as resolveSessionResetType, t as ensureAuthProfileStore, ti as setRuntimeConfigSnapshot, tn as formatOutboundPayloadLog, tr as updateSessionStore, u as getAgentRuntimeCommandSecretTargetIds, ui as normalizeThinkLevel, un as FailoverError, ur as resolveExplicitAgentSessionKey, vn as getAcpSessionManager, vr as isDeliverableMessageChannel, vt as normalizeSpawnedRunMetadata, wt as resolveAcpDispatchPolicyError, xr as normalizeMessageChannel, xt as registerAgentRunContext, yn as toAcpRuntimeError, yr as isGatewayMessageChannel, yt as clearAgentRunContext } from "./model-auth-B9IUb6BE.js";
...
function loadWhatsAppSenderRuntime() {
	whatsappSenderRuntimePromise ??= import("./deps-send-whatsapp.runtime-BN5GwSTE.js");
	return whatsappSenderRuntimePromise;
}
function loadTelegramSenderRuntime() {
	telegramSenderRuntimePromise ??= import("./deps-send-telegram.runtime-zMK7F4TF.js");
	return telegramSenderRuntimePromise;
}
function loadDiscordSenderRuntime() {
	discordSenderRuntimePromise ??= import("./deps-send-discord.runtime-Bay8zWqm.js");
	return discordSenderRuntimePromise;
}
function loadSlackSenderRuntime() {
	slackSenderRuntimePromise ??= import("./deps-send-slack.runtime-CjyaD8Ih.js");
	return slackSenderRuntimePromise;
}
function loadSignalSenderRuntime() {
	signalSenderRuntimePromise ??= import("./deps-send-signal.runtime-DkRBUyph.js");
	return signalSenderRuntimePromise;
}
function loadIMessageSenderRuntime() {
	imessageSenderRuntimePromise ??= import("./deps-send-imessage.runtime-eQRGutBY.js");

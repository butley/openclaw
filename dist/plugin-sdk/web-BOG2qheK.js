import { $ as shouldComputeCommandAuthorized, $r as saveMediaBuffer, A as resolvePinnedMainDmOwnerFromAllowlist, An as resolveMarkdownTableMode, At as sleepWithAbort, Bt as resolveAgentRoute, C as createReplyPrefixOptions, Cr as pickWebChannel, D as resolveDmGroupAccessWithCommandGate, E as readStoreAllowFromForDmPolicy, Ei as normalizeStreamLevel, F as createInboundDebouncer, Fn as resolveChunkMode, Fr as resolveGroupSessionKey, Ft as upsertChannelPairingRequest, I as resolveInboundDebounceMs, In as resolveTextChunkLimit, It as formatLocationText, Jt as resolveDefaultGroupPolicy, K as convertMarkdownTables, L as formatInboundEnvelope, Ln as resolveIdentityNamePrefix, Lt as toLocationContext, M as shouldAckReactionForWhatsApp, Mr as resolveChannelGroupPolicy, N as dispatchReplyWithBufferedBlockDispatcher, Nr as resolveChannelGroupRequireMention, Nt as normalizeGroupActivation, O as resolveDmGroupAccessWithLists, Pn as chunkMarkdownTextWithMode, Pt as parseActivationCommand, Q as hasControlCommand, R as getReplyFromConfig, Rn as resolveMessagePrefix, Rt as buildAgentSessionKey, T as recordPendingHistoryEntryIfEnabled, Tr as readWebSelfId, Vt as resolveInboundLastRouteSessionKey, X as finalizeInboundContext, Xt as warnMissingProviderGroupPolicyFallbackOnce, Yt as resolveOpenProviderRuntimeGroupPolicy, _ as resolveInboundSessionEnvelopeContext, _r as resolveWhatsAppMediaMaxBytes, b as issuePairingChallenge, br as logWebSelfId, et as buildMentionRegexes, gr as resolveWhatsAppAccount, hi as loadConfig, ji as formatCliCommand, jt as createDedupeCache, kn as loadWebMedia, kr as webAuthExists, kt as computeBackoff, ln as formatDurationPrecise, m as setActiveWebListener, nr as recordSessionMetaFromInbound, pi as getAgentScopedMediaLocalRoots, rr as updateLastRoute, tr as loadSessionStore, tt as normalizeMentionText, ui as registerUnhandledRejectionHandler, un as enqueueSystemEvent, vr as WA_WEB_AUTH_DIR, w as buildHistoryContextFromEntries, x as resolveMentionGating, y as createConnectedChannelStatusPatch, yr as getWebAuthAgeMs, zt as deriveLastRoutePolicy } from "./model-auth-B4iX-62f.js";
import { R as resolveStorePath, fn as buildGroupHistoryKey, hn as normalizeAgentId, ln as DEFAULT_MAIN_KEY, un as buildAgentMainSessionKey } from "./query-expansion-Cy7x_bIl.js";
import { A as shouldLogVerbose, D as logVerbose, I as getChildLogger, d as normalizeE164, l as isSelfChatMode, m as resolveJidToE164, n as clamp, u as jidToE164, y as sleep } from "./utils-9F32eDeY.js";
import "./paths-D6tDENa_.js";
import { a as createSubsystemLogger, l as defaultRuntime } from "./logger-nrQzrFsv.js";
...
import { i as markdownToWhatsApp, r as sendReactionWhatsApp, t as sendMessageWhatsApp } from "./outbound-CMhldcjG.js";
import "./brazil-jid-resolver-BvRAIhhZ.js";
import { i as waitForWaConnection, n as formatError, r as getStatusCode, t as createWaSocket } from "./session-BTQCHdQT.js";
import { i as noteContactName, r as loadContactNameCache, t as createWebSendApi } from "./send-api-BUBewNp-.js";
...
async function monitorWebInbox(options) {
	...
	const enqueueInboundMessage = async (msg, inbound, enriched) => {
		...
		const reply = async (text) => {
			const { processOutboundMentions } = await import("./send-api-BUBewNp-.js").then((n) => n.n);

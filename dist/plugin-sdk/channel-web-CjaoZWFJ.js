import { Sn as DEFAULT_ACCOUNT_ID, fn as buildGroupHistoryKey, hn as normalizeAgentId, ln as DEFAULT_MAIN_KEY, m as resolveStorePath, un as buildAgentMainSessionKey } from "./query-expansion-D3Y5TJkU.js";
import { $t as deriveLastRoutePolicy, A as resolveMentionGating, At as recordSessionMetaFromInbound, B as shouldAckReactionForWhatsApp, Bn as loadWebMedia, C as setActiveWebListener, Di as resolveWhatsAppAccount, E as resolveInboundSessionEnvelopeContext, F as readStoreAllowFromForDmPolicy, G as formatInboundEnvelope, Gi as formatCliCommand, Gn as chunkMarkdownTextWithMode, Ht as computeBackoff, I as resolveDmGroupAccessWithCommandGate, Jn as resolveIdentityNamePrefix, Jt as readChannelAllowFromStoreSync, K as getReplyFromConfig, Kn as resolveChunkMode, Kt as normalizeGroupActivation, L as resolveDmGroupAccessWithLists, Li as readWebSelfId, M as createReplyPrefixOptions, N as buildHistoryContextFromEntries, O as createConnectedChannelStatusPatch, P as recordPendingHistoryEntryIfEnabled, Qr as resolveGroupSessionKey, Qt as buildAgentSessionKey, R as resolvePinnedMainDmOwnerFromAllowlist, Tr as saveMediaBuffer, U as createInboundDebouncer, Ui as normalizeChatChannelId, Ut as sleepWithAbort, V as dispatchReplyWithBufferedBlockDispatcher, Vn as resolveMarkdownTableMode, Vr as normalizeStreamLevel, W as resolveInboundDebounceMs, Wt as createDedupeCache, Xt as formatLocationText, Yn as resolveMessagePrefix, Yt as upsertChannelPairingRequest, Zt as toLocationContext, _n as formatDurationPrecise, ct as buildMentionRegexes, en as resolveAgentRoute, et as convertMarkdownTables, fi as resolveDefaultGroupPolicy, fr as getAgentScopedMediaLocalRoots, it as finalizeInboundContext, ji as getWebAuthAgeMs, jt as updateLastRoute, k as issuePairingChallenge, ki as resolveWhatsAppMediaMaxBytes, kt as loadSessionStore, li as resolveChannelGroupPolicy, lt as normalizeMentionText, mi as warnMissingProviderGroupPolicyFallbackOnce, ot as hasControlCommand, pi as resolveOpenProviderRuntimeGroupPolicy, qn as resolveTextChunkLimit, qt as parseActivationCommand, s as loadConfig, st as shouldComputeCommandAuthorized, tn as resolveInboundLastRouteSessionKey, ui as resolveChannelGroupRequireMention, ur as registerUnhandledRejectionHandler, vn as enqueueSystemEvent } from "./sessions-BO0fT50W.js";
...
import { n as recordChannelActivity } from "./channel-activity-BSy3oFSy.js";
import { i as markdownToWhatsApp, r as sendReactionWhatsApp } from "./outbound-DfhJLxM0.js";
import { i as waitForWaConnection, n as formatError, r as getStatusCode, t as createWaSocket } from "./session-yuatQMvq.js";
import { i as noteContactName, r as loadContactNameCache, t as createWebSendApi } from "./send-api-BssirKlF.js";
...
async function monitorWebInbox(options) {
	...
	const enqueueInboundMessage = async (msg, inbound, enriched) => {
		...
		const reply = async (text) => {
			const { processOutboundMentions } = await import("./send-api-BssirKlF.js").then((n) => n.n);

import { Et as resolveSessionAgentId, It as ensureAgentWorkspace, R as resolveStorePath, St as resolveAgentWorkspaceDir, _n as resolveAgentIdFromSessionKey, gn as normalizeMainKey, gt as listAgentIds, hn as normalizeAgentId, vt as resolveAgentDir, wt as resolveEffectiveModelFallbacks, xt as resolveAgentSkillsFilter } from "./query-expansion-Q-LrwXu2.js";
import { $n as resolveSessionResetType, $r as normalizeThinkLevel, $t as runWithModelFallback, An as parseTtsDirectives, At as normalizeReplyPayload, B as clearSessionAuthProfileOverride, Bn as runCapability, Bt as resolveOutboundTarget, Ct as applyModelOverrideToSessionEntry, Et as resolveContextTokensForModel, Gt as deliverOutboundPayloads, Hn as resolveSessionTranscriptFile, Hr as loadConfig, Ht as resolveDiscordOwnerAccess, In as buildProviderRegistry, Jn as normalizeAccountId, Jr as DEFAULT_MODEL, Jt as normalizeOutboundPayloadsForJson, K as getRemoteSkillEligibility, Kt as formatOutboundPayloadLog, L as getCliSessionId, Ln as createMediaAttachmentCache, On as resolveTtsConfig, Pr as buildWorkspaceSkillSnapshot, Qn as resolveSessionResetPolicy, R as setCliSessionId, Rn as normalizeMediaAttachments, Rr as formatErrorMessage, Rt as resolveAgentRoute, St as AGENT_LANE_SUBAGENT, Tt as hasNonzeroUsage, U as formatMention, Un as emitSessionTranscriptUpdate, Ur as readConfigFileSnapshotForWrite, Ut as formatDiscordUserTag, V as applyVerboseOverride, Vr as loadModelCatalog, Vt as resolveSessionDeliveryTarget, Wn as loadSessionStore, Wr as setRuntimeConfigSnapshot, Wt as buildOutboundSessionContext, Xi as formatCliCommand, Xn as evaluateSessionFreshness, Xr as formatThinkingLevels, Y as resolveSendPolicy, Yn as resolveSessionKey, Yr as DEFAULT_PROVIDER, Zn as resolveChannelResetConfig, Zr as formatXHighModelHint, Zt as resolveMessageChannelSelection, _t as registerAgentRunContext, a as normalizeModelRef, bn as isSilentReplyPrefixText, bt as resolveAcpDispatchPolicyError, c as resolveDefaultModelForAgent, cr as isDeliverableMessageChannel, d as resolveCommandSecretRefsViaGateway, dr as normalizeMessageChannel, ei as normalizeVerboseLevel, er as mergeSessionEntry, et as runEmbeddedPiAgent, fr as resolveMessageChannel, ft as resolveAgentTimeoutMs, gt as emitAgentEvent, ht as clearAgentRunContext, i as modelKey, in as clearBootstrapSnapshotOnSessionRollover, ir as normalizeChannelId, kn as textToSpeech, l as resolveThinkingDefault, ln as getAcpSessionManager, lr as isGatewayMessageChannel, mt as normalizeSpawnedRunMetadata, n as buildAllowedModelSet, nr as resolveExplicitAgentSessionKey, nt as resolveBootstrapWarningSignaturesSeen, o as normalizeProviderId, pt as formatAgentInternalEventsForPrompt, q as getSkillsSnapshotVersion, qn as updateSessionStore, qt as normalizeOutboundPayloads, r as isCliProvider, rr as getChannelPlugin, s as resolveConfiguredModelRef, sr as INTERNAL_MESSAGE_CHANNEL, t as ensureAuthProfileStore, ti as supportsXHighThinking, tn as FailoverError, tr as setSessionRuntimeModel, tt as prepareSessionManagerForRun, u as getAgentRuntimeCommandSecretTargetIds, un as toAcpRuntimeError, ur as isInternalMessageChannel, vt as resolveAcpSessionCwd, wt as deriveSessionTotalTokens, x as isDangerousNameMatchingEnabled, xn as isSilentReplyText, xt as AGENT_LANE_NESTED, yt as resolveAcpAgentPolicyError, z as runCliAgent } from "./model-auth-BS7HpR5p.js";
import { A as shouldLogVerbose, D as logVerbose, q as resolvePreferredOpenClawTmpDir } from "./utils-TRCG_6qz.js";
...
function loadWhatsAppSenderRuntime() {
	whatsappSenderRuntimePromise ??= import("./deps-send-whatsapp.runtime-BSvCCZaJ.js");
	return whatsappSenderRuntimePromise;
}
function loadTelegramSenderRuntime() {
	telegramSenderRuntimePromise ??= import("./deps-send-telegram.runtime-CYcQq0o_.js");
	return telegramSenderRuntimePromise;
}
function loadDiscordSenderRuntime() {
	discordSenderRuntimePromise ??= import("./deps-send-discord.runtime-BmZL_Ryn.js");
	return discordSenderRuntimePromise;
}
function loadSlackSenderRuntime() {
	slackSenderRuntimePromise ??= import("./deps-send-slack.runtime-DTKU3h33.js");
	return slackSenderRuntimePromise;
}
function loadSignalSenderRuntime() {
	signalSenderRuntimePromise ??= import("./deps-send-signal.runtime-CcfZspa0.js");
	return signalSenderRuntimePromise;
}
function loadIMessageSenderRuntime() {
	imessageSenderRuntimePromise ??= import("./deps-send-imessage.runtime-CFvOXBTS.js");

import { R as resolveStorePath, fn as normalizeAgentId, ln as buildGroupHistoryKey, on as DEFAULT_MAIN_KEY, sn as buildAgentMainSessionKey } from "./query-expansion-Y8YnBjWR.js";
import "./paths-DinMprTu.js";
import { A as shouldLogVerbose, D as logVerbose, I as getChildLogger, d as normalizeE164, l as isSelfChatMode, m as resolveJidToE164, n as clamp, u as jidToE164, y as sleep } from "./utils-CcGpZmcv.js";
import { a as createSubsystemLogger, l as defaultRuntime } from "./logger-CsZhFfSe.js";
import { $ as hasControlCommand, $t as warnMissingProviderGroupPolicyFallbackOnce, At as createDedupeCache, Bi as WA_WEB_AUTH_DIR, Bt as buildAgentSessionKey, D as resolveDmGroupAccessWithLists, Di as recordPendingHistoryEntryIfEnabled, E as resolveDmGroupAccessWithCommandGate, F as resolveInboundDebounceMs, Fn as resolveChunkMode, Gi as pickWebChannel, Hi as logWebSelfId, Ht as resolveAgentRoute, I as formatInboundEnvelope, In as resolveTextChunkLimit, Ln as resolveIdentityNamePrefix, M as dispatchReplyWithBufferedBlockDispatcher, Mn as loadWebMedia, Mt as normalizeGroupActivation, Nn as resolveMarkdownTableMode, Nt as parseActivationCommand, Oi as buildMentionRegexes, Ot as computeBackoff, P as createInboundDebouncer, Pn as chunkMarkdownTextWithMode, Pr as saveMediaBuffer, Pt as upsertChannelPairingRequest, Qr as loadConfig, Qt as resolveOpenProviderRuntimeGroupPolicy, Ri as resolveWhatsAppAccount, Rn as resolveMessagePrefix, Rt as formatLocationText, T as readStoreAllowFromForDmPolicy, Ut as resolveInboundLastRouteSessionKey, Vi as getWebAuthAgeMs, Vt as deriveLastRoutePolicy, Xr as getAgentScopedMediaLocalRoots, Z as finalizeInboundContext, Zi as webAuthExists, Zt as resolveDefaultGroupPolicy, aa as resolveChannelGroupRequireMention, b as createConnectedChannelStatusPatch, ci as normalizeStreamLevel, ea as formatCliCommand, et as shouldComputeCommandAuthorized, fn as formatDurationPrecise, hr as resolveGroupSessionKey, ia as resolveChannelGroupPolicy, j as shouldAckReactionForWhatsApp, k as resolvePinnedMainDmOwnerFromAllowlist, ki as normalizeMentionText, kt as sleepWithAbort, m as setActiveWebListener, mi as resolveMentionGating, nr as recordSessionMetaFromInbound, pn as enqueueSystemEvent, q as convertMarkdownTables, qi as readWebSelfId, qr as registerUnhandledRejectionHandler, rr as updateLastRoute, tr as loadSessionStore, v as resolveInboundSessionEnvelopeContext, w as createReplyPrefixOptions, wi as buildHistoryContextFromEntries, x as issuePairingChallenge, z as getReplyFromConfig, zi as resolveWhatsAppMediaMaxBytes, zt as toLocationContext } from "./model-auth-Cl3gCsxG.js";
...
import { i as markdownToWhatsApp, r as sendReactionWhatsApp, t as sendMessageWhatsApp } from "./outbound-vQrPK9Il.js";
import "./brazil-jid-resolver-BHREr0wf.js";
import { i as waitForWaConnection, n as formatError, r as getStatusCode, t as createWaSocket } from "./session-Chgq7l7R.js";
import { i as noteContactName, r as loadContactNameCache, t as createWebSendApi } from "./send-api-jN9mfkTZ.js";
...
async function monitorWebInbox(options) {
	...
	const enqueueInboundMessage = async (msg, inbound, enriched) => {
		...
		const reply = async (text) => {
			const { processOutboundMentions } = await import("./send-api-jN9mfkTZ.js").then((n) => n.n);

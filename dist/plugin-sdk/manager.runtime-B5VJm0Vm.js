import { At as resolveSessionAgentId, Bt as ensureAgentWorkspace, Et as resolveAgentWorkspaceDir, Ot as resolveEffectiveModelFallbacks, R as resolveStorePath, Sn as resolveAgentIdFromSessionKey, St as resolveAgentDir, Tt as resolveAgentSkillsFilter, bn as normalizeAgentId, bt as listAgentIds, xn as normalizeMainKey } from "./query-expansion-BdKlqnVJ.js";
import { $a as getChannelPlugin, $c as ensureAuthProfileStore, $n as deriveSessionTotalTokens, A as buildAllowedModelSet, Ai as toAcpRuntimeError, An as prepareSessionManagerForRun, Ar as resolveSessionDeliveryTarget, Ba as loadSessionStore, Bc as buildWorkspaceSkillSnapshot, Da as loadModelCatalog, F as resolveConfiguredModelRef, Ga as resolveSessionKey, Gn as emitAgentEvent, Gt as formatMention, Hn as formatAgentInternalEventsForPrompt, I as resolveDefaultModelForAgent, Ja as resolveSessionResetPolicy, Jn as resolveAcpAgentPolicyError, Jr as deliverOutboundPayloads, Ka as evaluateSessionFreshness, Ki as isSilentReplyPrefixText, Kn as registerAgentRunContext, L as resolveThinkingDefault, M as modelKey, N as normalizeModelRef, Nr as resolveDiscordOwnerAccess, P as normalizeProviderId, Pr as formatDiscordUserTag, Qa as resolveExplicitAgentSessionKey, Qn as applyModelOverrideToSessionEntry, R as getAgentRuntimeCommandSecretTargetIds, Ra as resolveSessionTranscriptFile, Ua as updateSessionStore, Un as normalizeSpawnedRunMetadata, Vn as resolveAgentTimeoutMs, Wa as normalizeAccountId, Wn as clearAgentRunContext, Xa as mergeSessionEntry, Xn as AGENT_LANE_NESTED, Xr as normalizeOutboundPayloads, Ya as resolveSessionResetType, Yn as resolveAcpDispatchPolicyError, Yr as formatOutboundPayloadLog, Za as setSessionRuntimeModel, Zn as AGENT_LANE_SUBAGENT, Zr as normalizeOutboundPayloadsForJson, _a as normalizeMediaAttachments, _l as DEFAULT_PROVIDER, a as readConfigFileSnapshotForWrite, ac as isGatewayMessageChannel, ai as FailoverError, bn as getSkillsSnapshotVersion, cc as resolveMessageChannel, cn as runCliAgent, di as clearBootstrapSnapshotOnSessionRollover, eo as normalizeChannelId, er as hasNonzeroUsage, fl as normalizeThinkLevel, fn as getRemoteSkillEligibility, ga as createMediaAttachmentCache, gl as DEFAULT_MODEL, gt as isDangerousNameMatchingEnabled, ha as buildProviderRegistry, i as loadConfig, ia as parseTtsDirectives, ic as isDeliverableMessageChannel, ii as runWithModelFallback, j as isCliProvider, jn as resolveBootstrapWarningSignaturesSeen, kc as formatErrorMessage, kn as runEmbeddedPiAgent, kr as resolveOutboundTarget, ll as formatThinkingLevels, ln as clearSessionAuthProfileOverride, ml as supportsXHighThinking, na as resolveTtsConfig, ni as resolveMessageChannelSelection, nl as formatCliCommand, o as setRuntimeConfigSnapshot, oc as isInternalMessageChannel, on as getCliSessionId, or as normalizeReplyPayload, pl as normalizeVerboseLevel, qa as resolveChannelResetConfig, qi as isSilentReplyText, qn as resolveAcpSessionCwd, qr as buildOutboundSessionContext, ra as textToSpeech, rc as INTERNAL_MESSAGE_CHANNEL, sc as normalizeMessageChannel, sn as setCliSessionId, tr as resolveContextTokensForModel, ul as formatXHighModelHint, un as applyVerboseOverride, wn as resolveSendPolicy, xi as getAcpSessionManager, ya as runCapability, yr as resolveAgentRoute, z as resolveCommandSecretRefsViaGateway, za as emitSessionTranscriptUpdate } from "./thread-bindings-vVd-6uYc.js";
import "./paths-DBpXUsXY.js";
import "./github-copilot-token-e8eK8CQv.js";
import { A as shouldLogVerbose, D as logVerbose, J as resolvePreferredOpenClawTmpDir } from "./utils-C8fHFCVG.js";
...
function loadWhatsAppSenderRuntime() {
	whatsappSenderRuntimePromise ??= import("./deps-send-whatsapp.runtime-k0XSirrc.js");
	return whatsappSenderRuntimePromise;
}
function loadTelegramSenderRuntime() {
	telegramSenderRuntimePromise ??= import("./deps-send-telegram.runtime-Cx7w37T5.js");
	return telegramSenderRuntimePromise;
}
function loadDiscordSenderRuntime() {
	discordSenderRuntimePromise ??= import("./deps-send-discord.runtime-88keYciL.js");
	return discordSenderRuntimePromise;
}
function loadSlackSenderRuntime() {
	slackSenderRuntimePromise ??= import("./deps-send-slack.runtime-JbdxUxeh.js");
	return slackSenderRuntimePromise;
}
function loadSignalSenderRuntime() {
	signalSenderRuntimePromise ??= import("./deps-send-signal.runtime-C_f0SZmE.js");
	return signalSenderRuntimePromise;
}
function loadIMessageSenderRuntime() {
	imessageSenderRuntimePromise ??= import("./deps-send-imessage.runtime-DaJL0J-X.js");

import { R as resolveStorePath, fn as buildGroupHistoryKey, hn as normalizeAgentId, ln as DEFAULT_MAIN_KEY, un as buildAgentMainSessionKey } from "./query-expansion-BMTgZQ3N.js";
import { $ as normalizeMentionText, $n as loadSessionStore, A as shouldAckReactionForWhatsApp, Ai as webAuthExists, C as buildHistoryContextFromEntries, D as resolveDmGroupAccessWithLists, Dn as resolveMarkdownTableMode, Dt as computeBackoff, E as resolveDmGroupAccessWithCommandGate, Ei as readWebSelfId, En as loadWebMedia, F as formatInboundEnvelope, Fi as formatCliCommand, Fn as resolveIdentityNamePrefix, Ft as toLocationContext, Gt as resolveDefaultGroupPolicy, I as getReplyFromConfig, In as resolveMessagePrefix, Ir as saveMediaBuffer, It as buildAgentSessionKey, J as finalizeInboundContext, Kt as resolveOpenProviderRuntimeGroupPolicy, Lt as deriveLastRoutePolicy, Mn as resolveChunkMode, Mt as parseActivationCommand, N as createInboundDebouncer, Nn as resolveTextChunkLimit, Nt as upsertChannelPairingRequest, O as resolvePinnedMainDmOwnerFromAllowlist, Ot as sleepWithAbort, P as resolveInboundDebounceMs, Pt as formatLocationText, Q as buildMentionRegexes, Qr as loadConfig, Rt as resolveAgentRoute, S as createReplyPrefixOptions, T as readStoreAllowFromForDmPolicy, W as convertMarkdownTables, X as hasControlCommand, Xr as getAgentScopedMediaLocalRoots, Z as shouldComputeCommandAuthorized, _i as resolveWhatsAppAccount, bi as getWebAuthAgeMs, ci as normalizeStreamLevel, er as recordSessionMetaFromInbound, g as resolveInboundSessionEnvelopeContext, gr as resolveChannelGroupRequireMention, hr as resolveChannelGroupPolicy, j as dispatchReplyWithBufferedBlockDispatcher, jn as chunkMarkdownTextWithMode, jt as normalizeGroupActivation, kt as createDedupeCache, on as formatDurationPrecise, p as setActiveWebListener, pi as resolveMentionGating, qr as registerUnhandledRejectionHandler, qt as warnMissingProviderGroupPolicyFallbackOnce, sn as enqueueSystemEvent, tr as updateLastRoute, v as createConnectedChannelStatusPatch, vi as resolveWhatsAppMediaMaxBytes, vr as resolveGroupSessionKey, w as recordPendingHistoryEntryIfEnabled, wi as pickWebChannel, xi as logWebSelfId, y as issuePairingChallenge, yi as WA_WEB_AUTH_DIR, zt as resolveInboundLastRouteSessionKey } from "./model-auth-BWjCRDK2.js";
import "./paths-Dmn791zP.js";
import { A as shouldLogVerbose, D as logVerbose, I as getChildLogger, d as normalizeE164, l as isSelfChatMode, m as resolveJidToE164, n as clamp, u as jidToE164, y as sleep } from "./utils-BdIQ65UN.js";
import { a as createSubsystemLogger, s as defaultRuntime } from "./logger-suFbq0p_.js";
...
import { i as markdownToWhatsApp, r as sendReactionWhatsApp, t as sendMessageWhatsApp } from "./outbound-BzRPthUr.js";
import "./brazil-jid-resolver-COKGgFjG.js";
import { i as waitForWaConnection, n as formatError, r as getStatusCode, t as createWaSocket } from "./session-D_GzIsJE.js";
import { i as noteContactName, r as loadContactNameCache, t as createWebSendApi } from "./send-api-B6p7kXt0.js";
...
async function monitorWebInbox(options) {
	...
	const enqueueInboundMessage = async (msg, inbound, enriched) => {
		...
		const reply = async (text) => {
			const { processOutboundMentions } = await import("./send-api-B6p7kXt0.js").then((n) => n.n);

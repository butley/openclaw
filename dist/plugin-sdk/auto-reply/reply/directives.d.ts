...
import { type ElevatedLevel, type StreamLevel, type ThinkLevel, type VerboseLevel } from "../thinking.js";
...
export declare function extractStreamDirective(body?: string): {
    cleaned: string;

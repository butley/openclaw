import { Et as resolveSessionAgentId, It as ensureAgentWorkspace, R as resolveStorePath, St as resolveAgentWorkspaceDir, fn as normalizeAgentId, gt as listAgentIds, mn as resolveAgentIdFromSessionKey, pn as normalizeMainKey, vt as resolveAgentDir, wt as resolveEffectiveModelFallbacks, xt as resolveAgentSkillsFilter } from "./query-expansion-Y8YnBjWR.js";
import "./paths-DinMprTu.js";
import { A as shouldLogVerbose, D as logVerbose, q as resolvePreferredOpenClawTmpDir } from "./utils-CcGpZmcv.js";
import { a as createSubsystemLogger, l as defaultRuntime } from "./logger-CsZhFfSe.js";
import { $n as resolveSessionTranscriptFile, $r as readConfigFileSnapshotForWrite, Ai as getChannelPlugin, B as getCliSessionId, Bn as textToSpeech, Ct as AGENT_LANE_SUBAGENT, Dt as resolveContextTokensForModel, Et as hasNonzeroUsage, Gt as resolveSessionDeliveryTarget, H as runCliAgent, Ht as resolveAgentRoute, Jn as createMediaAttachmentCache, Jr as formatErrorMessage, K as formatMention, Kt as resolveDiscordOwnerAccess, Q as resolveSendPolicy, Qr as loadConfig, S as isDangerousNameMatchingEnabled, Si as isSilentReplyText, St as AGENT_LANE_NESTED, Tt as deriveSessionTotalTokens, U as clearSessionAuthProfileOverride, V as setCliSessionId, Vn as parseTtsDirectives, W as applyVerboseOverride, Wr as buildWorkspaceSkillSnapshot, Wt as resolveOutboundTarget, X as getSkillsSnapshotVersion, Y as getRemoteSkillEligibility, Yn as normalizeMediaAttachments, Zn as runCapability, Zr as loadModelCatalog, _r as isDeliverableMessageChannel, _t as emitAgentEvent, a as normalizeModelRef, ai as DEFAULT_PROVIDER, ar as normalizeAccountId, bn as toAcpRuntimeError, br as normalizeMessageChannel, bt as resolveAcpAgentPolicyError, c as resolveDefaultModelForAgent, cr as resolveChannelResetConfig, d as resolveCommandSecretRefsViaGateway, di as supportsXHighThinking, dn as FailoverError, dr as mergeSessionEntry, ea as formatCliCommand, ei as setRuntimeConfigSnapshot, en as buildOutboundSessionContext, er as emitSessionTranscriptUpdate, fr as setSessionRuntimeModel, gr as INTERNAL_MESSAGE_CHANNEL, gt as clearAgentRunContext, ht as normalizeSpawnedRunMetadata, i as modelKey, ii as DEFAULT_MODEL, in as normalizeOutboundPayloadsForJson, ir as updateSessionStore, ji as normalizeChannelId, jt as normalizeReplyPayload, l as resolveThinkingDefault, li as normalizeThinkLevel, ln as runWithModelFallback, lr as resolveSessionResetPolicy, mn as clearBootstrapSnapshotOnSessionRollover, mt as formatAgentInternalEventsForPrompt, n as buildAllowedModelSet, nn as formatOutboundPayloadLog, nt as prepareSessionManagerForRun, o as normalizeProviderId, oi as formatThinkingLevels, or as resolveSessionKey, pr as resolveExplicitAgentSessionKey, pt as resolveAgentTimeoutMs, qn as buildProviderRegistry, qt as formatDiscordUserTag, r as isCliProvider, rn as normalizeOutboundPayloads, rt as resolveBootstrapWarningSignaturesSeen, s as resolveConfiguredModelRef, si as formatXHighModelHint, sn as resolveMessageChannelSelection, sr as evaluateSessionFreshness, t as ensureAuthProfileStore, tn as deliverOutboundPayloads, tr as loadSessionStore, tt as runEmbeddedPiAgent, u as getAgentRuntimeCommandSecretTargetIds, ui as normalizeVerboseLevel, ur as resolveSessionResetType, vr as isGatewayMessageChannel, vt as registerAgentRunContext, wt as applyModelOverrideToSessionEntry, xi as isSilentReplyPrefixText, xr as resolveMessageChannel, xt as resolveAcpDispatchPolicyError, yn as getAcpSessionManager, yr as isInternalMessageChannel, yt as resolveAcpSessionCwd, zn as resolveTtsConfig } from "./model-auth-Cl3gCsxG.js";
...
function loadWhatsAppSenderRuntime() {
	whatsappSenderRuntimePromise ??= import("./deps-send-whatsapp.runtime-BKCwkzYe.js");
	return whatsappSenderRuntimePromise;
}
function loadTelegramSenderRuntime() {
	telegramSenderRuntimePromise ??= import("./deps-send-telegram.runtime-B-m6f7wk.js");
	return telegramSenderRuntimePromise;
}
function loadDiscordSenderRuntime() {
	discordSenderRuntimePromise ??= import("./deps-send-discord.runtime-DZt8HpwV.js");
	return discordSenderRuntimePromise;
}
function loadSlackSenderRuntime() {
	slackSenderRuntimePromise ??= import("./deps-send-slack.runtime-DkyeYm2v.js");
	return slackSenderRuntimePromise;
}
function loadSignalSenderRuntime() {
	signalSenderRuntimePromise ??= import("./deps-send-signal.runtime-DKkICYqD.js");
	return signalSenderRuntimePromise;
}
function loadIMessageSenderRuntime() {
	imessageSenderRuntimePromise ??= import("./deps-send-imessage.runtime-DnIbHLto.js");

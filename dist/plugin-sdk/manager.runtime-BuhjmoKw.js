import { $ as resolveSendPolicy, $n as buildProviderRegistry, Ai as setRuntimeConfigSnapshot, At as resolveContextTokensForModel, Bi as normalizeVerboseLevel, Cn as toAcpRuntimeError, Ct as resolveAcpAgentPolicyError, Di as loadModelCatalog, Dt as applyModelOverrideToSessionEntry, Et as AGENT_LANE_SUBAGENT, Fi as DEFAULT_PROVIDER, G as applyVerboseOverride, Gn as resolveTtsConfig, Gt as resolveAgentRoute, H as setCliSessionId, Ii as formatThinkingLevels, Jr as isGatewayMessageChannel, Jt as resolveSessionDeliveryTarget, Kn as textToSpeech, Kr as INTERNAL_MESSAGE_CHANNEL, Li as formatXHighModelHint, Oi as loadConfig, Ot as deriveSessionTotalTokens, Pi as DEFAULT_MODEL, Pt as normalizeReplyPayload, Rn as isSilentReplyPrefixText, Sn as getAcpSessionManager, St as resolveAcpSessionCwd, T as isDangerousNameMatchingEnabled, Tt as AGENT_LANE_NESTED, U as runCliAgent, Ui as formatCliCommand, V as getCliSessionId, Vi as supportsXHighThinking, W as clearSessionAuthProfileOverride, X as getRemoteSkillEligibility, Xr as normalizeMessageChannel, Xt as formatDiscordUserTag, Yr as isInternalMessageChannel, Yt as resolveDiscordOwnerAccess, Z as getSkillsSnapshotVersion, Zr as resolveMessageChannel, _n as clearBootstrapSnapshotOnSessionRollover, _r as mergeSessionEntry, _t as formatAgentInternalEventsForPrompt, a as normalizeModelRef, an as formatOutboundPayloadLog, ar as resolveSessionTranscriptFile, at as prepareSessionManagerForRun, br as getChannelPlugin, bt as emitAgentEvent, c as resolveDefaultModelForAgent, d as resolveCommandSecretRefsViaGateway, dr as normalizeAccountId, er as createMediaAttachmentCache, fn as runWithModelFallback, fr as resolveSessionKey, gr as resolveSessionResetType, gt as resolveAgentTimeoutMs, hr as resolveSessionResetPolicy, i as modelKey, in as deliverOutboundPayloads, it as runEmbeddedPiAgent, ki as readConfigFileSnapshotForWrite, kt as hasNonzeroUsage, l as resolveThinkingDefault, mn as FailoverError, mr as resolveChannelResetConfig, n as buildAllowedModelSet, o as normalizeProviderId, on as normalizeOutboundPayloads, or as emitSessionTranscriptUpdate, ot as resolveBootstrapWarningSignaturesSeen, pr as evaluateSessionFreshness, q as formatMention, qn as parseTtsDirectives, qr as isDeliverableMessageChannel, qt as resolveOutboundTarget, r as isCliProvider, rn as buildOutboundSessionContext, rr as runCapability, s as resolveConfiguredModelRef, sn as normalizeOutboundPayloadsForJson, sr as loadSessionStore, t as ensureAuthProfileStore, tr as normalizeMediaAttachments, u as getAgentRuntimeCommandSecretTargetIds, un as resolveMessageChannelSelection, ur as updateSessionStore, vr as setSessionRuntimeModel, vt as normalizeSpawnedRunMetadata, wi as formatErrorMessage, wt as resolveAcpDispatchPolicyError, xr as normalizeChannelId, xt as registerAgentRunContext, yi as buildWorkspaceSkillSnapshot, yr as resolveExplicitAgentSessionKey, yt as clearAgentRunContext, zi as normalizeThinkLevel, zn as isSilentReplyText } from "./model-auth-Cc8TeNFD.js";
import { Et as resolveSessionAgentId, It as ensureAgentWorkspace, R as resolveStorePath, St as resolveAgentWorkspaceDir, _n as resolveAgentIdFromSessionKey, gn as normalizeMainKey, gt as listAgentIds, hn as normalizeAgentId, vt as resolveAgentDir, wt as resolveEffectiveModelFallbacks, xt as resolveAgentSkillsFilter } from "./query-expansion-Cy7x_bIl.js";
import { A as shouldLogVerbose, D as logVerbose, q as resolvePreferredOpenClawTmpDir } from "./utils-9F32eDeY.js";
...
function loadWhatsAppSenderRuntime() {
	whatsappSenderRuntimePromise ??= import("./deps-send-whatsapp.runtime-Bz1FW-2r.js");
	return whatsappSenderRuntimePromise;
}
function loadTelegramSenderRuntime() {
	telegramSenderRuntimePromise ??= import("./deps-send-telegram.runtime-DhXQDFFg.js");
	return telegramSenderRuntimePromise;
}
function loadDiscordSenderRuntime() {
	discordSenderRuntimePromise ??= import("./deps-send-discord.runtime-BmqOSk0Q.js");
	return discordSenderRuntimePromise;
}
function loadSlackSenderRuntime() {
	slackSenderRuntimePromise ??= import("./deps-send-slack.runtime-DsshAKoI.js");
	return slackSenderRuntimePromise;
}
function loadSignalSenderRuntime() {
	signalSenderRuntimePromise ??= import("./deps-send-signal.runtime-C2DKEg8R.js");
	return signalSenderRuntimePromise;
}
function loadIMessageSenderRuntime() {
	imessageSenderRuntimePromise ??= import("./deps-send-imessage.runtime-8Sq9gqNW.js");

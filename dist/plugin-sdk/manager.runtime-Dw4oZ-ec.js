import { Bt as ensureAgentWorkspace, Et as resolveSessionAgentId, R as resolveStorePath, St as resolveAgentWorkspaceDir, _n as resolveAgentIdFromSessionKey, gn as normalizeMainKey, gt as listAgentIds, hn as normalizeAgentId, vt as resolveAgentDir, wt as resolveEffectiveModelFallbacks, xt as resolveAgentSkillsFilter } from "./query-expansion-bC8cAT7-.js";
import { $t as normalizeOutboundPayloadsForJson, An as isSilentReplyPrefixText, At as hasNonzeroUsage, Cr as isInternalMessageChannel, Ct as resolveAcpSessionCwd, Dt as AGENT_LANE_SUBAGENT, E as isDangerousNameMatchingEnabled, Et as AGENT_LANE_NESTED, Ft as normalizeReplyPayload, G as clearSessionAuthProfileOverride, Gn as buildProviderRegistry, Gt as resolveOutboundTarget, H as getCliSessionId, Hi as formatCliCommand, J as formatMention, Jr as buildWorkspaceSkillSnapshot, Jt as formatDiscordUserTag, K as applyVerboseOverride, Kn as createMediaAttachmentCache, Kt as resolveSessionDeliveryTarget, Ln as resolveTtsConfig, Ot as applyModelOverrideToSessionEntry, Q as getSkillsSnapshotVersion, Qr as formatXHighModelHint, Qt as normalizeOutboundPayloads, Rn as textToSpeech, Sr as isGatewayMessageChannel, St as registerAgentRunContext, Tr as resolveMessageChannel, Tt as resolveAcpDispatchPolicyError, U as setCliSessionId, Ut as resolveAgentRoute, Vr as formatErrorMessage, W as runCliAgent, Xr as ensureAuthProfileStore, Xt as deliverOutboundPayloads, Yn as runCapability, Yt as buildOutboundSessionContext, Z as getRemoteSkillEligibility, Zr as formatThinkingLevels, Zt as formatOutboundPayloadLog, _r as normalizeChannelId, _t as resolveAgentTimeoutMs, ai as DEFAULT_PROVIDER, an as runWithModelFallback, at as runEmbeddedPiAgent, br as INTERNAL_MESSAGE_CHANNEL, bt as clearAgentRunContext, c as modelKey, cr as resolveSessionKey, d as resolveConfiguredModelRef, dr as resolveSessionResetPolicy, ei as normalizeThinkLevel, er as loadModelCatalog, et as resolveSendPolicy, f as resolveDefaultModelForAgent, fr as resolveSessionResetType, gr as getChannelPlugin, h as resolveCommandSecretRefsViaGateway, hn as toAcpRuntimeError, hr as resolveExplicitAgentSessionKey, i as setRuntimeConfigSnapshot, ii as DEFAULT_MODEL, jn as isSilentReplyText, jt as resolveContextTokensForModel, kt as deriveSessionTotalTokens, l as normalizeModelRef, ln as clearBootstrapSnapshotOnSessionRollover, lr as evaluateSessionFreshness, m as getAgentRuntimeCommandSecretTargetIds, mn as getAcpSessionManager, mr as setSessionRuntimeModel, n as loadConfig, ni as supportsXHighThinking, nr as emitSessionTranscriptUpdate, o as buildAllowedModelSet, on as FailoverError, or as updateSessionStore, ot as prepareSessionManagerForRun, p as resolveThinkingDefault, pr as mergeSessionEntry, qn as normalizeMediaAttachments, qt as resolveDiscordOwnerAccess, r as readConfigFileSnapshotForWrite, rn as resolveMessageChannelSelection, rr as loadSessionStore, s as isCliProvider, sr as normalizeAccountId, st as resolveBootstrapWarningSignaturesSeen, ti as normalizeVerboseLevel, tr as resolveSessionTranscriptFile, u as normalizeProviderId, ur as resolveChannelResetConfig, vt as formatAgentInternalEventsForPrompt, wr as normalizeMessageChannel, wt as resolveAcpAgentPolicyError, xr as isDeliverableMessageChannel, xt as emitAgentEvent, yt as normalizeSpawnedRunMetadata, zn as parseTtsDirectives } from "./onboard-helpers-BVDZTEur.js";
...
function loadWhatsAppSenderRuntime() {
	whatsappSenderRuntimePromise ??= import("./deps-send-whatsapp.runtime-DiekziG4.js");
	return whatsappSenderRuntimePromise;
}
function loadTelegramSenderRuntime() {
	telegramSenderRuntimePromise ??= import("./deps-send-telegram.runtime-C9lAzaUn.js");
	return telegramSenderRuntimePromise;
}
function loadDiscordSenderRuntime() {
	discordSenderRuntimePromise ??= import("./deps-send-discord.runtime-_RElncyU.js");
	return discordSenderRuntimePromise;
}
function loadSlackSenderRuntime() {
	slackSenderRuntimePromise ??= import("./deps-send-slack.runtime-B3nYOY0e.js");
	return slackSenderRuntimePromise;
}
function loadSignalSenderRuntime() {
	signalSenderRuntimePromise ??= import("./deps-send-signal.runtime-pl3mAfiV.js");
	return signalSenderRuntimePromise;
}
function loadIMessageSenderRuntime() {
	imessageSenderRuntimePromise ??= import("./deps-send-imessage.runtime-DUqKYZrV.js");

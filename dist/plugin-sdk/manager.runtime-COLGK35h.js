import { A as shouldLogVerbose, D as logVerbose, q as resolvePreferredOpenClawTmpDir } from "./utils-bXhxAwKI.js";
import "./paths-DinMprTu.js";
import { a as createSubsystemLogger, l as defaultRuntime } from "./logger-DjiLKutJ.js";
import { $ as getSkillsSnapshotVersion, $t as buildOutboundSessionContext, At as deriveSessionTotalTokens, B as setCliSessionId, Bi as DEFAULT_PROVIDER, C as isDangerousNameMatchingEnabled, Ct as registerAgentRunContext, Di as setRuntimeConfigSnapshot, Dt as AGENT_LANE_NESTED, Ei as readConfigFileSnapshotForWrite, Et as resolveAcpDispatchPolicyError, Fn as isSilentReplyPrefixText, G as formatMention, Gi as normalizeVerboseLevel, Gr as isGatewayMessageChannel, H as clearSessionAuthProfileOverride, Hi as formatXHighModelHint, Hn as resolveTtsConfig, In as isSilentReplyText, It as normalizeReplyPayload, J as getRemoteSkillEligibility, Jr as resolveMessageChannel, Jt as resolveDiscordOwnerAccess, Ki as supportsXHighThinking, Kr as isInternalMessageChannel, Kt as resolveOutboundTarget, Mt as resolveContextTokensForModel, Ot as AGENT_LANE_SUBAGENT, Qn as normalizeMediaAttachments, St as emitAgentEvent, Ti as loadConfig, Tt as resolveAcpAgentPolicyError, U as applyVerboseOverride, Un as textToSpeech, Ur as INTERNAL_MESSAGE_CHANNEL, V as runCliAgent, Vi as formatThinkingLevels, Wi as normalizeThinkLevel, Wn as parseTtsDirectives, Wr as isDeliverableMessageChannel, Wt as resolveAgentRoute, Xn as buildProviderRegistry, Yt as formatDiscordUserTag, Zn as createMediaAttachmentCache, _r as getChannelPlugin, a as modelKey, bn as toAcpRuntimeError, bt as normalizeSpawnedRunMetadata, c as resolveConfiguredModelRef, cn as runWithModelFallback, cr as normalizeAccountId, ct as resolveBootstrapWarningSignaturesSeen, d as getAgentRuntimeCommandSecretTargetIds, dr as resolveChannelResetConfig, en as deliverOutboundPayloads, er as runCapability, f as resolveCommandSecretRefsViaGateway, fr as resolveSessionResetPolicy, gr as resolveExplicitAgentSessionKey, hr as setSessionRuntimeModel, i as isCliProvider, ir as loadSessionStore, jt as hasNonzeroUsage, kt as applyModelOverrideToSessionEntry, l as resolveDefaultModelForAgent, lr as resolveSessionKey, mn as clearBootstrapSnapshotOnSessionRollover, mr as mergeSessionEntry, n as ensureAuthProfileStore, nn as normalizeOutboundPayloads, nr as resolveSessionTranscriptFile, o as normalizeModelRef, on as resolveMessageChannelSelection, ot as runEmbeddedPiAgent, pr as resolveSessionResetType, qi as formatCliCommand, qr as normalizeMessageChannel, qt as resolveSessionDeliveryTarget, r as buildAllowedModelSet, rn as normalizeOutboundPayloadsForJson, rr as emitSessionTranscriptUpdate, s as normalizeProviderId, sr as updateSessionStore, st as prepareSessionManagerForRun, tn as formatOutboundPayloadLog, tt as resolveSendPolicy, u as resolveThinkingDefault, un as FailoverError, ur as evaluateSessionFreshness, vr as normalizeChannelId, vt as resolveAgentTimeoutMs, wi as loadModelCatalog, wt as resolveAcpSessionCwd, xi as formatErrorMessage, xt as clearAgentRunContext, yi as buildWorkspaceSkillSnapshot, yn as getAcpSessionManager, yt as formatAgentInternalEventsForPrompt, z as getCliSessionId, zi as DEFAULT_MODEL } from "./auth-profiles-B9Aa0E_q.js";
import { Et as resolveSessionAgentId, It as ensureAgentWorkspace, R as resolveStorePath, St as resolveAgentWorkspaceDir, fn as normalizeAgentId, gt as listAgentIds, mn as resolveAgentIdFromSessionKey, pn as normalizeMainKey, vt as resolveAgentDir, wt as resolveEffectiveModelFallbacks, xt as resolveAgentSkillsFilter } from "./query-expansion-DU6KGAmp.js";
...
function loadWhatsAppSenderRuntime() {
	whatsappSenderRuntimePromise ??= import("./deps-send-whatsapp.runtime-_EcsHlWT.js");
	return whatsappSenderRuntimePromise;
}
function loadTelegramSenderRuntime() {
	telegramSenderRuntimePromise ??= import("./deps-send-telegram.runtime-DQw59b2z.js");
	return telegramSenderRuntimePromise;
}
function loadDiscordSenderRuntime() {
	discordSenderRuntimePromise ??= import("./deps-send-discord.runtime-CqVYm7Vv.js");
	return discordSenderRuntimePromise;
}
function loadSlackSenderRuntime() {
	slackSenderRuntimePromise ??= import("./deps-send-slack.runtime-B4S-F0XF.js");
	return slackSenderRuntimePromise;
}
function loadSignalSenderRuntime() {
	signalSenderRuntimePromise ??= import("./deps-send-signal.runtime-COcVOCJv.js");
	return signalSenderRuntimePromise;
}
function loadIMessageSenderRuntime() {
	imessageSenderRuntimePromise ??= import("./deps-send-imessage.runtime-BtJnoyCg.js");

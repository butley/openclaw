import { A as shouldLogVerbose, D as logVerbose, I as getChildLogger, d as normalizeE164, l as isSelfChatMode, m as resolveJidToE164, n as clamp, u as jidToE164, y as sleep } from "./utils-bXhxAwKI.js";
import "./paths-DinMprTu.js";
import { a as createSubsystemLogger, l as defaultRuntime } from "./logger-DjiLKutJ.js";
import { A as resolvePinnedMainDmOwnerFromAllowlist, Ar as pickWebChannel, Bn as resolveIdentityNamePrefix, Br as resolveChannelGroupRequireMention, Bt as formatLocationText, Ci as getAgentScopedMediaLocalRoots, Cr as resolveWhatsAppAccount, D as readStoreAllowFromForDmPolicy, Dr as logWebSelfId, E as recordPendingHistoryEntryIfEnabled, Er as getWebAuthAgeMs, F as createInboundDebouncer, Ft as createDedupeCache, Gt as resolveInboundLastRouteSessionKey, Hr as resolveGroupSessionKey, Ht as buildAgentSessionKey, I as resolveInboundDebounceMs, Ir as webAuthExists, K as convertMarkdownTables, L as formatInboundEnvelope, Ln as chunkMarkdownTextWithMode, Lt as normalizeGroupActivation, M as shouldAckReactionForWhatsApp, Mn as loadWebMedia, Mr as readWebSelfId, N as dispatchReplyWithBufferedBlockDispatcher, Nn as resolveMarkdownTableMode, Nt as computeBackoff, O as resolveDmGroupAccessWithCommandGate, Pt as sleepWithAbort, Qt as warnMissingProviderGroupPolicyFallbackOnce, R as getReplyFromConfig, Rn as resolveChunkMode, Rt as parseActivationCommand, S as resolveMentionGating, T as buildHistoryContextFromEntries, Ti as loadConfig, Tr as WA_WEB_AUTH_DIR, Ui as normalizeStreamLevel, Ut as deriveLastRoutePolicy, Vn as resolveMessagePrefix, Vt as toLocationContext, Wt as resolveAgentRoute, Xt as resolveDefaultGroupPolicy, Zt as resolveOpenProviderRuntimeGroupPolicy, _ as resolveInboundSessionEnvelopeContext, ar as recordSessionMetaFromInbound, at as normalizeMentionText, b as createConnectedChannelStatusPatch, bi as registerUnhandledRejectionHandler, dn as formatDurationPrecise, et as finalizeInboundContext, fn as enqueueSystemEvent, ir as loadSessionStore, it as buildMentionRegexes, k as resolveDmGroupAccessWithLists, li as saveMediaBuffer, m as setActiveWebListener, nt as hasControlCommand, or as updateLastRoute, qi as formatCliCommand, rt as shouldComputeCommandAuthorized, w as createReplyPrefixOptions, wr as resolveWhatsAppMediaMaxBytes, x as issuePairingChallenge, zn as resolveTextChunkLimit, zr as resolveChannelGroupPolicy, zt as upsertChannelPairingRequest } from "./auth-profiles-B9Aa0E_q.js";
import { R as resolveStorePath, fn as normalizeAgentId, ln as buildGroupHistoryKey, on as DEFAULT_MAIN_KEY, sn as buildAgentMainSessionKey } from "./query-expansion-DU6KGAmp.js";
...
import { i as markdownToWhatsApp, r as sendReactionWhatsApp, t as sendMessageWhatsApp } from "./outbound-B7dXYBdk.js";
import "./brazil-jid-resolver-BAXOPaw6.js";
import { i as waitForWaConnection, n as formatError, r as getStatusCode, t as createWaSocket } from "./session-Ek8L89UO.js";
import { i as noteContactName, r as loadContactNameCache, t as createWebSendApi } from "./send-api-BW3Zw_h4.js";
...
async function monitorWebInbox(options) {
	...
	const enqueueInboundMessage = async (msg, inbound, enriched) => {
		...
		const reply = async (text) => {
			const { processOutboundMentions } = await import("./send-api-BW3Zw_h4.js").then((n) => n.n);

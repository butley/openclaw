import { $t as resolveOpenProviderRuntimeGroupPolicy, B as shouldAckReactionForWhatsApp, Bi as WA_WEB_AUTH_DIR, Bt as formatLocationText, Di as recordPendingHistoryEntryIfEnabled, E as resolveMentionGating, F as resolveDmGroupAccessWithLists, Fn as resolveTextChunkLimit, Ft as createDedupeCache, G as getReplyFromConfig, Gi as pickWebChannel, Gt as resolveInboundLastRouteSessionKey, Hi as logWebSelfId, Ht as buildAgentSessionKey, In as resolveIdentityNamePrefix, L as resolvePinnedMainDmOwnerFromAllowlist, Ln as resolveMessagePrefix, Lt as normalizeGroupActivation, N as readStoreAllowFromForDmPolicy, Nn as chunkMarkdownTextWithMode, Nt as computeBackoff, Oi as buildMentionRegexes, On as loadWebMedia, P as resolveDmGroupAccessWithCommandGate, Pn as resolveChunkMode, Pt as sleepWithAbort, Qn as registerUnhandledRejectionHandler, Qt as resolveDefaultGroupPolicy, Ri as resolveWhatsAppAccount, Rr as saveMediaBuffer, Rt as parseActivationCommand, T as issuePairingChallenge, U as createInboundDebouncer, Ut as deriveLastRoutePolicy, V as dispatchReplyWithBufferedBlockDispatcher, Vi as getWebAuthAgeMs, Vt as toLocationContext, W as resolveInboundDebounceMs, Wt as resolveAgentRoute, Zi as webAuthExists, ar as recordSessionMetaFromInbound, at as shouldComputeCommandAuthorized, da as resolveChannelGroupRequireMention, en as warnMissingProviderGroupPolicyFallbackOnce, er as getAgentScopedMediaLocalRoots, et as convertMarkdownTables, fa as formatInboundEnvelope, ir as loadSessionStore, it as hasControlCommand, k as createReplyPrefixOptions, ki as normalizeMentionText, kn as resolveMarkdownTableMode, mn as enqueueSystemEvent, nt as finalizeInboundContext, or as updateLastRoute, pi as normalizeStreamLevel, pn as formatDurationPrecise, qi as readWebSelfId, ta as formatCliCommand, ti as loadConfig, ua as resolveChannelGroupPolicy, v as setActiveWebListener, w as createConnectedChannelStatusPatch, wi as buildHistoryContextFromEntries, x as resolveInboundSessionEnvelopeContext, yr as resolveGroupSessionKey, zi as resolveWhatsAppMediaMaxBytes, zt as upsertChannelPairingRequest } from "./skill-commands-U25WKbOZ.js";
import { R as resolveStorePath, fn as normalizeAgentId, ln as buildGroupHistoryKey, on as DEFAULT_MAIN_KEY, sn as buildAgentMainSessionKey } from "./query-expansion-Dw2mzlyF.js";
import "./paths-DBpXUsXY.js";
import { A as shouldLogVerbose, D as logVerbose, I as getChildLogger, d as normalizeE164, l as isSelfChatMode, m as resolveJidToE164, n as clamp, u as jidToE164, y as sleep } from "./utils-C6un-a5o.js";
import { a as createSubsystemLogger, l as defaultRuntime } from "./logger-CKBciSpj.js";
...
import { i as markdownToWhatsApp, r as sendReactionWhatsApp, t as sendMessageWhatsApp } from "./outbound-DeVT_GDG.js";
import "./brazil-jid-resolver-B4cf5Y19.js";
import { i as waitForWaConnection, n as formatError, r as getStatusCode, t as createWaSocket } from "./session-DYwLGbaO.js";
import { i as noteContactName, r as loadContactNameCache, t as createWebSendApi } from "./send-api-O-r3Wdm4.js";
import { t as loginWeb } from "./login-BCrcoyRH.js";
...
async function monitorWebInbox(options) {
	...
	const enqueueInboundMessage = async (msg, inbound, enriched) => {
		...
		const reply = async (text) => {
			const { processOutboundMentions } = await import("./send-api-O-r3Wdm4.js").then((n) => n.n);

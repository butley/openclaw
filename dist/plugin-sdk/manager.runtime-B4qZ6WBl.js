import { Et as resolveSessionAgentId, It as ensureAgentWorkspace, St as resolveAgentWorkspaceDir, _n as resolveAgentIdFromSessionKey, gn as normalizeMainKey, gt as listAgentIds, hn as normalizeAgentId, m as resolveStorePath, vt as resolveAgentDir, wt as resolveEffectiveModelFallbacks, xt as resolveAgentSkillsFilter } from "./query-expansion-D3Y5TJkU.js";
import { $ as formatMention, $r as INTERNAL_MESSAGE_CHANNEL, Br as formatXHighModelHint, Bt as hasNonzeroUsage, Ct as formatAgentInternalEventsForPrompt, Dn as setSessionRuntimeModel, Dt as registerAgentRunContext, En as mergeSessionEntry, Et as emitAgentEvent, Ft as resolveAcpDispatchPolicyError, Gi as formatCliCommand, Gt as normalizeReplyPayload, Hr as normalizeThinkLevel, Ir as buildWorkspaceSkillSnapshot, It as AGENT_LANE_NESTED, J as setCliSessionId, Kr as DEFAULT_MODEL, Lt as AGENT_LANE_SUBAGENT, Mt as updateSessionStore, Nt as resolveAcpSessionCwd, On as toAcpRuntimeError, Ot as resolveSessionTranscriptFile, Pt as resolveAcpAgentPolicyError, Qn as parseTtsDirectives, Rr as ensureAuthProfileStore, Rt as applyModelOverrideToSessionEntry, St as resolveAgentTimeoutMs, Tn as getAcpSessionManager, Tt as clearAgentRunContext, Un as isSilentReplyPrefixText, Ur as normalizeVerboseLevel, Vt as resolveContextTokensForModel, Wn as isSilentReplyText, Wr as supportsXHighThinking, X as clearSessionAuthProfileOverride, Xn as resolveTtsConfig, Xr as normalizeChannelId, Y as runCliAgent, Yr as getChannelPlugin, Z as applyVerboseOverride, Zn as textToSpeech, _ as resolveDefaultModelForAgent, a as resolveSessionResetType, an as resolveDiscordOwnerAccess, ar as createMediaAttachmentCache, at as resolveSendPolicy, b as resolveCommandSecretRefsViaGateway, c as readConfigFileSnapshotForWrite, cn as deliverOutboundPayloads, cr as runCapability, d as buildAllowedModelSet, dn as normalizeOutboundPayloadsForJson, dt as prepareSessionManagerForRun, ei as isDeliverableMessageChannel, en as resolveAgentRoute, f as isCliProvider, ft as resolveBootstrapWarningSignaturesSeen, g as resolveConfiguredModelRef, gn as FailoverError, h as normalizeProviderId, hn as runWithModelFallback, i as resolveSessionResetPolicy, ii as resolveMessageChannel, in as normalizeAccountId, ir as buildProviderRegistry, j as isDangerousNameMatchingEnabled, kr as formatErrorMessage, kt as loadSessionStore, l as setRuntimeConfigSnapshot, ln as formatOutboundPayloadLog, m as normalizeModelRef, n as evaluateSessionFreshness, ni as isInternalMessageChannel, nn as resolveOutboundTarget, nt as getRemoteSkillEligibility, o as resolveExplicitAgentSessionKey, on as formatDiscordUserTag, or as normalizeMediaAttachments, p as modelKey, pn as resolveMessageChannelSelection, pr as loadModelCatalog, q as getCliSessionId, qr as DEFAULT_PROVIDER, r as resolveChannelResetConfig, ri as normalizeMessageChannel, rn as resolveSessionDeliveryTarget, rt as getSkillsSnapshotVersion, s as loadConfig, sn as buildOutboundSessionContext, t as resolveSessionKey, ti as isGatewayMessageChannel, un as normalizeOutboundPayloads, ut as runEmbeddedPiAgent, v as resolveThinkingDefault, wn as emitSessionTranscriptUpdate, wt as normalizeSpawnedRunMetadata, y as getAgentRuntimeCommandSecretTargetIds, yn as clearBootstrapSnapshotOnSessionRollover, zr as formatThinkingLevels, zt as deriveSessionTotalTokens } from "./sessions-BO0fT50W.js";
import { A as shouldLogVerbose, D as logVerbose, q as resolvePreferredOpenClawTmpDir } from "./utils-DQ-ML02Y.js";
...
function loadWhatsAppSenderRuntime() {
	whatsappSenderRuntimePromise ??= import("./deps-send-whatsapp.runtime-bYVERwMF.js");
	return whatsappSenderRuntimePromise;
}
function loadTelegramSenderRuntime() {
	telegramSenderRuntimePromise ??= import("./deps-send-telegram.runtime-Dex2Q4ng.js");
	return telegramSenderRuntimePromise;
}
function loadDiscordSenderRuntime() {
	discordSenderRuntimePromise ??= import("./deps-send-discord.runtime-C8o7pAQ9.js");
	return discordSenderRuntimePromise;
}
function loadSlackSenderRuntime() {
	slackSenderRuntimePromise ??= import("./deps-send-slack.runtime-DerFVFMe.js");
	return slackSenderRuntimePromise;
}
function loadSignalSenderRuntime() {
	signalSenderRuntimePromise ??= import("./deps-send-signal.runtime-v9O6Bf6k.js");
	return signalSenderRuntimePromise;
}
function loadIMessageSenderRuntime() {
	imessageSenderRuntimePromise ??= import("./deps-send-imessage.runtime-BahBkwmO.js");

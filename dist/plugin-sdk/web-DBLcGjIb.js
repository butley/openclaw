import { $ as finalizeInboundContext, $r as saveMediaBuffer, A as readStoreAllowFromForDmPolicy, B as formatInboundEnvelope, Bn as resolveChunkMode, Bt as toLocationContext, C as createConnectedChannelStatusPatch, Cr as pickWebChannel, D as createReplyPrefixOptions, F as shouldAckReactionForWhatsApp, Fn as resolveMarkdownTableMode, Fr as resolveGroupSessionKey, Hn as resolveIdentityNamePrefix, Ht as deriveLastRoutePolicy, I as dispatchReplyWithBufferedBlockDispatcher, It as normalizeGroupActivation, Lt as parseActivationCommand, M as resolveDmGroupAccessWithLists, Mr as resolveChannelGroupPolicy, Mt as computeBackoff, N as resolvePinnedMainDmOwnerFromAllowlist, Nr as resolveChannelGroupRequireMention, Nt as sleepWithAbort, O as buildHistoryContextFromEntries, Pn as loadWebMedia, Pt as createDedupeCache, R as createInboundDebouncer, Rt as upsertChannelPairingRequest, T as resolveMentionGating, Ti as normalizeStreamLevel, Tr as readWebSelfId, Un as resolveMessagePrefix, Ut as resolveAgentRoute, V as getReplyFromConfig, Vn as resolveTextChunkLimit, Vt as buildAgentSessionKey, Wt as resolveInboundLastRouteSessionKey, Xt as resolveOpenProviderRuntimeGroupPolicy, Y as convertMarkdownTables, Yt as resolveDefaultGroupPolicy, Zt as warnMissingProviderGroupPolicyFallbackOnce, _r as resolveWhatsAppMediaMaxBytes, br as logWebSelfId, di as registerUnhandledRejectionHandler, gi as loadConfig, gr as resolveWhatsAppAccount, h as setActiveWebListener, hn as enqueueSystemEvent, it as normalizeMentionText, j as resolveDmGroupAccessWithCommandGate, k as recordPendingHistoryEntryIfEnabled, ki as formatCliCommand, kr as webAuthExists, mi as getAgentScopedMediaLocalRoots, mn as formatDurationPrecise, nr as recordSessionMetaFromInbound, nt as shouldComputeCommandAuthorized, rr as updateLastRoute, rt as buildMentionRegexes, tr as loadSessionStore, tt as hasControlCommand, vr as WA_WEB_AUTH_DIR, w as issuePairingChallenge, x as resolveInboundSessionEnvelopeContext, yr as getWebAuthAgeMs, z as resolveInboundDebounceMs, zn as chunkMarkdownTextWithMode, zt as formatLocationText } from "./tts-core-CYHgjKkM.js";
import { A as shouldLogVerbose, D as logVerbose, I as getChildLogger, d as normalizeE164, l as isSelfChatMode, m as resolveJidToE164, n as clamp, u as jidToE164, y as sleep } from "./utils-FKnHtVac.js";
import "./paths-Dmn791zP.js";
import { a as createSubsystemLogger, l as defaultRuntime } from "./logger-BxQoHGVb.js";
import "./fetch-TN5GkqVm.js";
import { R as resolveStorePath, an as DEFAULT_MAIN_KEY, cn as buildGroupHistoryKey, dn as normalizeAgentId, on as buildAgentMainSessionKey } from "./query-expansion-DreZMgcy.js";
import "./github-copilot-token-DMvRH42f.js";
import { n as recordChannelActivity } from "./channel-activity-DVuTt2Mq.js";
import { i as markdownToWhatsApp, r as sendReactionWhatsApp, t as sendMessageWhatsApp } from "./outbound-C8-ogLpc.js";
import "./brazil-jid-resolver-CUUBpgW2.js";
import { i as waitForWaConnection, n as formatError, r as getStatusCode, t as createWaSocket } from "./session-DjS9w5Pi.js";
import { i as noteContactName, r as loadContactNameCache, t as createWebSendApi } from "./send-api-D3guwuhA.js";
...
async function monitorWebInbox(options) {
	...
	const enqueueInboundMessage = async (msg, inbound, enriched) => {
		...
		const reply = async (text) => {
			const { processOutboundMentions } = await import("./send-api-D3guwuhA.js").then((n) => n.n);

...
import { a as setConsoleSubsystemFilter, c as sanitizeForLog, n as runtimeForLogger, o as setConsoleTimestampPrefix, p as defaultRuntime, t as createSubsystemLogger } from "./subsystem-JJ8bgFw2.js";
import "./boolean-DTgd5CzD.js";
import { a as logAcceptedEnvOption, i as isTruthyEnvValue } from "./entry.js";
import { $c as validateDevicePairApproveParams, $f as mergeDeliveryContext, $h as disableTailscaleFunnel, $i as computeBackoff, $l as validateWizardNextParams, $p as cleanStaleLockFiles, $u as enqueueCommandInLane, A as resolveAllowedModelRef, Ac as validateAgentsListParams, Af as estimateBase64DecodedBytes, Ag as loadModelCatalog, Ah as readGatewayTokenEnv, Ai as resolveAnnounceTargetFromKey, Al as validateSecretsResolveParams, Ao as formatDoctorNonInteractiveHint, Av as formatThinkingLevels, B as createPluginRuntime, Ba as buildOutboundSessionContext, Bc as validateConfigPatchParams, Bd as resolveUserTimezone, Bf as parseSessionThreadInfo, Bg as readBestEffortConfig, Bi as canonicalizeSpawnedByForAgent, Bl as validateSessionsUsageParams, Bn as primeRemoteSkillsCache, Bo as resolveCronStaggerMs, Bp as isGatewayMessageChannel, Br as waitForActiveEmbeddedRuns, Bs as resolveSystemRunApprovalRequestContext, Bv as normalizeVerboseLevel, C as isCliProvider, C_ as ensureControlUiAllowedOriginsForNonLoopbackBind, Cc as validateAgentParams, Cg as extractTextFromChatContent, Ch as authorizeWsControlUiGatewayConnect, Ci as getAgentRunContext, Cl as validateNodePendingAckParams, Cm as inspectPortUsage, Cn as setCliSessionId, Cp as resolveAgentMainSessionKey, Cr as extractImageContentFromSource, Cs as isKnownSecretTargetId, Cu as ensureExecApprovals, D as normalizeModelSelection, Dc as validateAgentsFilesGetParams, Dg as registerUnhandledRejectionHandler, Dl as validatePollParams, Dm as formatPortDiagnostics, Do as cleanStaleGatewayProcessesSync, Dp as snapshotSessionOrigin, Dr as normalizeSendPolicy, Ec as validateAgentsDeleteParams, El as validateNodeRenameParams, En as resolveSessionAuthProfileOverride, Ep as resolveMainSessionKeyFromConfig, Eu as mergeExecApprovalsSocketDefaults, Ev as normalizeSecretInput, F_ as resolveSubagentMaxConcurrent, Fc as validateChatHistoryParams, Fd as ToolInputError, Fh as createAuthRateLimiter, Fi as applyModelOverrideToSessionEntry, Fl as validateSessionsListParams, Fo as writeRestartSentinel, Ft as normalizeControlUiBasePath, Fv as normalizeFastMode, G as formatHelpExamples, Gc as validateConnectParams, Gd as SILENT_REPLY_TOKEN, Gg as writeConfigFile, Gh as resolveClientIp, Gi as loadSessionEntry, Gl as validateTalkConfigParams, Gn as setSkillsRemoteRegistry, Go as normalizeOptionalText$1, Gp as GATEWAY_CLIENT_CAPS, Gr as resolveFastModeState, Gs as matchSystemRunApprovalBinding, Hc as validateConfigSchemaLookupResult, Hf as archiveRemovedSessionTranscripts, Hg as readConfigFileSnapshotForWrite, Hh as isValidIPv4, Hi as listAgentsForGateway, Hl as validateSkillsInstallParams, Hn as refreshRemoteBinsForConnectedNodes, Hp as isWebchatClient, Hv as supportsXHighThinking, I as resolveSubagentConfiguredModelSelection, Ic as validateChatInjectParams, Ig as migrateLegacyConfig, Ih as normalizeRateLimitClientIp, Ii as loadProviderUsageSummary, Il as validateSessionsPatchParams, Io as normalizeHttpWebhookUrl, Ir as runEmbeddedPiAgent, It as resolveAssistantAvatarUrl, Iu as saveExecApprovals, Iv as normalizeReasoningLevel, Ja as resolveOutboundChannelPlugin, Jc as validateCronRemoveParams, Jh as resolveRequestClientIp, Ji as resolveSessionModelRef, Jl as validateUpdateRunParams, Jn as rejectNodePairing, Jp as GATEWAY_CLIENT_NAMES, Jr as resolveCronStyleNow, Js as toSystemRunApprovalMismatchError, K_ as getGlobalHookRunner, Ka as normalizeReplyPayloadsForDelivery, Kc as validateCronAddParams, Kg as validateConfigObjectWithPlugins, Kh as resolveGatewayBindHost, Ki as pruneLegacyStoreKeys, Kl as validateTalkModeParams, Kn as approveNodePairing, Ko as normalizePayloadToSystemText, Kp as GATEWAY_CLIENT_IDS, Ks as missingSystemRunApprovalBinding, L as resolveThinkingDefault, Lc as validateChatSendParams, Lf as resolveAgentSessionDirs, Lg as createConfigIO, Lh as isLocalishHost, Ll as validateSessionsPreviewParams, Lo as normalizeCronJobCreate, Lp as INTERNAL_MESSAGE_CHANNEL, M as resolveConfiguredModelRef, Ma as resolveSessionDeliveryTarget, Mc as validateChannelsLogoutParams, Mh as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN, Ml as validateSendParams, Mm as rawDataToString, Mn as parseVerboseOverride, Mr as isAbortRequestText, N as resolveDefaultModelForAgent, N_ as buildTalkConfigResponse, Nc as validateChannelsStatusParams, Nh as AUTH_RATE_LIMIT_SCOPE_HOOK_AUTH, Ni as resolveNestedAgentLane, Nl as validateSessionsCompactParams, Nm as cleanOldMedia, Nn as unbindThreadBindingsBySessionKey, No as summarizeRestartSentinel, Nr as stopSubagentsForRequester, Nt as CONTROL_UI_AVATAR_PREFIX, Oc as validateAgentsFilesListParams, Ol as validatePushTestParams, Or as resolveSendPolicy, Ou as normalizeExecApprovals, Ov as DEFAULT_MODEL, P as resolveHooksGmailModel, P_ as resolveAgentMaxConcurrent, Pc as validateChatAbortParams, Ph as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, Pi as resolvePreferredSessionKeyForSessionIdMatches, Pl as validateSessionsDeleteParams, Pm as saveMediaBuffer, Pt as buildControlUiAvatarUrl, Pv as normalizeElevatedLevel, Qa as buildChannelUiCatalog, Qc as validateCronUpdateParams, Qd as resolveAgentIdentity, Qf as deliveryContextFromSession, Qg as parseByteSize, Qh as safeEqualSecret, Ql as validateWizardCancelParams, Qm as resolveConfiguredSecretInputString, Qn as verifyNodeToken, Qr as buildDefaultToolPolicyPipelineSteps, Qs as isSystemEventContextChanged, Qu as clearBootstrapSnapshotOnSessionRollover, Rc as validateConfigApplyParams, Rg as loadConfig, Rh as isLoopbackAddress, Rl as validateSessionsResetParams, Ro as normalizeCronJobPatch, Rp as isDeliverableMessageChannel, Rr as abortEmbeddedPiRun, Rt as resolveExecApprovalCommandDisplay, Ru as getPluginToolMeta, Rv as normalizeThinkLevel, S as getModelRefStatus, S_ as applyLegacyMigrations, Sc as validateAgentIdentityParams, Sd as getAcpSessionManager, Sh as authorizeHttpGatewayConnect, Si as emitAgentEvent, Sl as validateNodePairVerifyParams, Sm as ensurePortAvailable, Sn as getCliSessionId, Sp as canonicalizeMainSessionAlias, Sr as extractFileContentFromSource, Tc as validateAgentsCreateParams, Tg as SsrFBlockedError, Th as resolveGatewayAuth, Ti as registerAgentRunContext, Tl as validateNodePendingEnqueueParams, Tp as resolveMainSessionKey, Tr as resolveInputFileLimits, U as withProgress, Uc as validateConfigSchemaParams, Uf as loadSessionStore, Ug as resolveConfigSnapshotHash, Uh as normalizeHostHeader, Ui as listSessionsFromStore, Ul as validateSkillsStatusParams, Un as refreshRemoteNodeBins, Uo as normalizeOptionalAgentId, Up as normalizeMessageChannel, Us as resolveSystemRunCommandRequest, Va as deliverOutboundPayloads, Vc as validateConfigSchemaLookupParams, Vg as readConfigFileSnapshot, Vh as isTrustedProxyAddress, Vl as validateSkillsBinsParams, Vn as recordRemoteNodeInfo, Vo as resolveDefaultCronStaggerMs, Vr as waitForEmbeddedPiRunEnd, Vs as resolveSystemRunApprovalRuntimeContext, Wc as validateConfigSetParams, Wh as pickPrimaryLanIPv4, Wi as loadCombinedSessionStoreForGateway, Wl as validateSkillsUpdateParams, Wn as removeRemoteNodeInfo, Wo as normalizeOptionalSessionKey, Wr as resolveBootstrapWarningSignaturesSeen, Ws as buildSystemRunApprovalBinding, Wt as resolveAgentAvatar, Xc as validateCronRunsParams, Xh as pickPrimaryTailnetIPv4, Xl as validateWebLoginStartParams, Xm as mergeGatewayAuthConfig, Xn as requestNodePairing, Xo as normalizeLegacyDeliveryInput, Xp as normalizeGatewayClientMode, Xr as resolveToolLoopDetectionConfig, Xt as createReplyPrefixOptions, Ya as applyPluginAutoEnable, Yc as validateCronRunParams, Yl as validateWakeParams, Ym as ensureGatewayStartupAuth, Yn as renamePairedNode, Yo as parseAbsoluteTimeMs, Yp as hasGatewayClientCap, Yu as listChannelAgentTools, Zc as validateCronStatusParams, Zh as pickPrimaryTailnetIPv6, Zi as lookupContextTokens, Zl as validateWebLoginWaitParams, Zm as mergeGatewayTailscaleConfig, Zn as updatePairedNodeMetadata, Zr as applyToolPolicyPipeline, Zs as enqueueSystemEvent, Zt as buildHistoryContextFromEntries, Zu as clearBootstrapSnapshot, _a as readChannelAllowFromStoreSync, _c as WRITE_SCOPE, _d as resolveMemorySearchConfig, _i as resolveAgentTimeoutMs, _l as validateNodeListParams, _o as markGatewaySigusr1RestartHandled, _p as resolveSessionResetPolicy, _s as prepareSecretsRuntimeSnapshot, _u as publicKeyRawBase64UrlFromPem, a_ as isAvatarHttpUrl, ac as setHeartbeatsEnabled, ad as setCommandLaneConcurrency, af as resolveTtsApiKey, ai as runBeforeToolCallHook, al as validateExecApprovalRequestParams, ao as normalizePollInput, ap as cleanupArchivedSessionTranscripts, ar as formatZonedTimestamp, at as resolveAgentOutboundIdentity, au as ConnectErrorDetailCodes, bi as resolveIngressWorkspaceOverrideForSpawnedRun, bl as validateNodePairRejectParams, bm as movePathToTrash, bn as resolveCronStorePath, bo as setPreRestartDeferralCheck, br as DEFAULT_INPUT_IMAGE_MIMES, bs as evaluateGatewayAuthSurfaceStates, bt as handleReset, bu as buildExecApprovalPendingReplyPayload, cc as callGateway, cf as resolveTtsPrefsPath, cl as validateExecApprovalsNodeGetParams, cp as resolveSessionTranscriptCandidates, cs as detectSuspiciousPatterns, cu as buildDeviceAuthPayload, df as setTtsProvider, dg as mergeAlsoAllowPolicy, dl as validateLogsTailParams, dp as stripInlineDirectiveTagsForDisplay, ds as closeTrackedBrowserTabsForSessions, ea as sleepWithAbort, ed as getActiveTaskCount, eg as disableTailscaleServe, el as validateDevicePairListParams, em as isPidAlive, ep as normalizeSessionDeliveryFields, et as createWhatsAppLoginTool, eu as validateWizardStartParams, fa as ensureOutboundSessionEntry, fd as isDiagnosticsEnabled, ff as textToSpeech, fg as resolveToolProfilePolicy, fi as listDescendantRunsForRequester, fl as validateModelsListParams, fo as resolveFailoverReasonFromError, fp as stripInlineDirectiveTagsFromMessageForDisplay, fs as applyBrowserProxyPaths, fu as normalizeDeviceAuthScopes, gg as resolveCoreToolProfiles, gl as validateNodeInvokeResultParams, gm as startBrowserControlServiceFromConfig, gn as getTotalPendingReplies, go as isGatewaySigusr1RestartExternallyAllowed, gr as registerSkillsChangeListener, gs as getActiveSecretsRuntimeSnapshot, gu as normalizeDevicePublicKeyBase64Url, hc as PAIRING_SCOPE$1, hg as listCoreToolSections, hl as validateNodeInvokeParams, hm as createBrowserControlContext, hn as createReplyDispatcher, ho as emitGatewayRestart, hp as evaluateSessionFreshness, hr as getSkillsSnapshotVersion, hs as clearSecretsRuntimeSnapshot, hu as loadOrCreateDeviceIdentity, i_ as AVATAR_MAX_BYTES, ia as normalizeGroupActivation, id as resetAllLanes, if as isTtsProviderConfigured, ig as getTailnetHostname, il as validateDeviceTokenRotateParams, io as resolveMessageChannelSelection, ip as capArrayByJsonBytes, ir as listAgentWorkspaceDirs, iu as parseSessionLabel, ja as resolveOutboundTarget, jc as validateAgentsUpdateParams, jd as isRestartEnabled, jl as validateSecretsResolveResult, jn as applyVerboseOverride, jo as formatRestartSentinelMessage, ju as readExecApprovalsSnapshot, jv as formatXHighModelHint, kc as validateAgentsFilesSetParams, kh as readGatewayPasswordEnv, ki as readLatestAssistantReply, kl as validateRequestFrame, ko as consumeRestartSentinel, kr as onInboundMessageEvent, kv as DEFAULT_PROVIDER, ld as startDiagnosticHeartbeat, lf as resolveTtsProviderOrder, ll as validateExecApprovalsNodeSetParams, lp as stripEnvelopeFromMessage, ls as getHookType, lu as buildDeviceAuthPayloadV3, mc as APPROVALS_SCOPE$1, mf as OPENAI_TTS_VOICES, ml as validateNodeEventParams, mm as createBrowserRouteDispatcher, mn as dispatchInboundMessage, mo as deferGatewayRestartUntilIdle, ms as activateSecretsRuntimeSnapshot, mu as deriveDeviceIdFromPublicKey, na as clearSessionQueues, nd as getTotalQueueSize, nf as getTtsProvider, ng as enableTailscaleServe, ni as resolveGroupToolPolicy, nl as validateDevicePairRemoveParams, nm as readJsonFile, no as resetDirectoryCache, np as archiveFileOnDisk, nu as ErrorCodes, o_ as isAvatarImageDataUrl, od as waitForActiveTasks, of as resolveTtsAutoMode, oi as createOpenClawTools, ol as validateExecApprovalResolveParams, op as readSessionMessages, ou as resolveAuthConnectErrorDetailCode, pa as resolveOutboundSessionRoute, pc as ADMIN_SCOPE$3, pf as OPENAI_TTS_MODELS, pg as PROFILE_OPTIONS, pl as validateNodeDescribeParams, po as consumeGatewaySigusr1RestartAuthorization, pp as normalizeInputProvenance, ps as persistBrowserProxyFiles, pu as loadGatewayTlsRuntime$1, q_ as runGlobalGatewayStopSafely, qc as validateCronListParams, qd as isSilentReplyText, qf as updateSessionStore, qg as OpenClawSchema, qh as resolveGatewayListenHosts, qi as resolveGatewaySessionStoreTarget, ql as validateToolsCatalogParams, qn as listNodePairing, qo as normalizeRequiredName, qp as GATEWAY_CLIENT_MODES, rc as requestHeartbeatNow, rd as markGatewayDraining, rf as isTtsEnabled, ri as resolveSubagentToolPolicy, rl as validateDeviceTokenRevokeParams, rm as writeJsonAtomic, rp as archiveSessionTranscripts, rt as buildTelegramExecApprovalButtons, ru as errorShape, s_ as looksLikeAvatarPath, sd as CommandLane, sf as resolveTtsConfig, si as countActiveDescendantRuns, sl as validateExecApprovalsGetParams, sn as sendTypingTelegram, so as runWithModelFallback, sp as readSessionPreviewItemsFromTranscript, ss as buildSafeExternalPrompt, st as handleSlackHttpRequest, su as resolveDeviceAuthConnectErrorDetailCode, tg as enableTailscaleFunnel, ti as resolveEffectiveToolPolicy, tl as validateDevicePairRejectParams, tm as createAsyncLock, to as maybeResolveIdLikeTarget, tu as validateWizardStatusParams, ud as stopDiagnosticHeartbeat, uf as setTtsEnabled, ug as collectExplicitAllowlist, ui as initSubagentRegistry, ul as validateExecApprovalsSetParams, up as stripEnvelopeFromMessages, us as isExternalHookSession, uu as normalizeDeviceMetadataForAuth, vc as authorizeOperatorScopesForMethod, vd as getMachineDisplayName, vl as validateNodePairApproveParams, vn as buildBareSessionResetPrompt, vo as scheduleGatewaySigusr1Restart, vs as resolveCommandSecretsFromActiveRuntimeSnapshot, wc as validateAgentWaitParams, wg as fetchWithSsrFGuard, wh as isLocalDirectRequest, wi as onAgentEvent, wl as validateNodePendingDrainParams, wn as runCliAgent, wp as resolveExplicitAgentSessionKey, wr as normalizeMimeList, x_ as applyMergePatch, xc as formatValidationErrors, xd as stripHeartbeatToken, xh as assertGatewayAuthConfigured, xi as clearAgentRunContext, xl as validateNodePairRequestParams, xn as saveCronStore, xo as triggerOpenClawRestart, xp as setSessionRuntimeModel, xr as DEFAULT_INPUT_TIMEOUT_MS, xu as DEFAULT_EXEC_APPROVAL_TIMEOUT_MS, y as buildAllowedModelSet, yc as isNodeRoleMethod, yi as normalizeSpawnedRunMetadata, yl as validateNodePairListParams, yn as loadCronStore, yo as setGatewaySigusr1RestartPolicy, yp as mergeSessionEntry, yr as DEFAULT_INPUT_IMAGE_MAX_BYTES, ys as GATEWAY_AUTH_SURFACE_PATHS, yu as verifyDeviceSignature, z as loadOpenClawPlugins, zc as validateConfigGetParams, zf as extractDeliveryInfo, zg as parseConfigJson5, zh as isLoopbackHost, zl as validateSessionsResolveParams, zn as getRemoteSkillEligibility, zo as normalizeCronStaggerMs, zp as isGatewayCliClient, zr as getActiveEmbeddedRunCount, zt as sanitizeExecApprovalDisplayText, zu as resolvePluginTools, zv as normalizeUsageDisplay } from "./auth-profiles-C0kh5mIB.js";
import { t as formatCliCommand } from "./command-format-BTnLVWI8.js";
import { C as DEFAULT_MEMORY_FILENAME, D as ensureAgentWorkspace, E as DEFAULT_USER_FILENAME, M as resolveWorkspaceTemplateDir, S as DEFAULT_MEMORY_ALT_FILENAME, T as DEFAULT_TOOLS_FILENAME, _ as DEFAULT_AGENTS_FILENAME, a as resolveAgentDir, b as DEFAULT_HEARTBEAT_FILENAME, d as resolveAgentWorkspaceDir, f as resolveDefaultAgentId, h as resolveSessionAgentId, i as resolveAgentConfig, j as resolveDefaultAgentWorkspaceDir, k as isWorkspaceOnboardingCompleted, l as resolveAgentModelFallbacksOverride, n as listAgentEntries, r as listAgentIds, u as resolveAgentSkillsFilter, w as DEFAULT_SOUL_FILENAME, x as DEFAULT_IDENTITY_FILENAME, y as DEFAULT_BOOTSTRAP_FILENAME } from "./agent-scope-C4S7fG5T.js";
import { C as isCronRunSessionKey, E as parseAgentSessionKey$1, S as isAcpSessionKey, T as isSubagentSessionKey, _ as normalizeAccountId$1, c as normalizeAgentId, g as DEFAULT_ACCOUNT_ID, h as toAgentStoreSessionKey, l as normalizeMainKey, m as toAgentRequestSessionKey, o as classifySessionKeyShape, r as buildAgentMainSessionKey, t as DEFAULT_AGENT_ID, u as resolveAgentIdFromSessionKey } from "./session-key-51LnISpq.js";
import { E as isPlainObject, S as sleep, T as truncateUtf16Safe, n as clamp, s as ensureDir, v as resolveUserPath, x as shortenHomePath } from "./utils-CtED9zde.js";
import { a as sameFileIdentity, i as openVerifiedFileSync, m as matchesSkillFilter, n as openBoundaryFile, r as openBoundaryFileSync, u as isNotFoundPathError } from "./boundary-file-read-B1ga_qm2.js";
import { i as logWarn, t as logDebug } from "./logger-BUMgVwAa.js";
import { n as runExec, t as runCommandWithTimeout } from "./exec-W1AIRZPs.js";
import { t as resolveOpenClawPackageRoot } from "./openclaw-root-J9AoIWqc.js";
import { a as hasConfiguredSecretInput } from "./types.secrets-BvNoSfUf.js";
import "./github-copilot-token-Dgt86bL5.js";
import { C as createInternalHookEvent, S as clearInternalHooks, T as triggerInternalHook, b as canonicalizePathVariant, h as createEmptyPluginRegistry, t as CHANNEL_IDS, u as getActivePluginRegistry, v as PROTECTED_PLUGIN_ROUTE_PREFIXES, w as registerInternalHook, y as canonicalizePathForSecurity } from "./registry-BfhkiWvO.js";
import { T as isTestDefaultMemorySlotDisabled, i as loadWorkspaceSkillEntries, r as buildWorkspaceSkillSnapshot } from "./skills-Cb5J3NWM.js";
...
import { i as parseDurationMs, r as resolveMemoryBackendConfig, t as getMemorySearchManager } from "./search-manager-DSd7jCvQ.js";
import { U as resolveWhatsAppAccount, ct as normalizeWhatsAppTarget, g as buildChannelAccountBindings, lt as resolveChannelDefaultAccountId, n as listChannelPlugins, r as normalizeChannelId, t as getChannelPlugin } from "./plugins-LGMtobye.js";
import { B as readLocalFileSafely, H as writeFileWithinRoot, L as openFileWithinRoot, N as SafeOpenError, W as detectMime } from "./query-expansion-CU62AsAp.js";
import { a as testRegexWithBoundedInput, i as compileSafeRegex } from "./redact-gt8ZHLqM.js";
import { l as isErrno, n as runCommandWithRuntime, o as formatErrorMessage } from "./cli-utils-Cs2-IJRN.js";
import "./fetch-KA2Mm62U.js";
import { n as assertNoPathAliasEscape } from "./path-alias-guards-B3hD8xdj.js";
import "./delivery-queue-_GnNO_Fd.js";
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent, i as resolveSessionFilePathOptions, l as resolveStorePath, r as resolveSessionFilePath } from "./paths--60oHXZP.js";
import { c as formatUsd, d as deriveSessionTotalTokens, f as hasNonzeroUsage, i as loadSessionUsageTimeSeries, n as loadCostUsageSummary, r as loadSessionCostSummary, s as formatTokenCount, t as discoverAllSessions } from "./session-cost-usage-DoUewFvY.js";
...
import { t as buildWorkspaceSkillStatus } from "./skills-status-DqPPL9io.js";
import { i as onHeartbeatEvent, r as getLastHeartbeatEvent, t as resolveHeartbeatVisibility } from "./heartbeat-visibility-B2fQzX9P.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-Cm5LpoJ4.js";
import { n as DEFAULT_GATEWAY_HTTP_TOOL_DENY } from "./dangerous-tools-Bku5G9nA.js";
import { t as readSecretFromFile } from "./secret-file-Ch_sSlXY.js";
import { n as inheritOptionFromParent } from "./command-options-D1cOsiu_.js";
import { t as WizardCancelledError } from "./prompts-Cf1Gw-Mf.js";
import { a as pruneAgentConfig, i as loadAgentIdentity, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-BNvCri5D.js";
import { t as isWithinDir } from "./path-safety-ETdLtnIt.js";
import "./install-safe-path-DhZbPmg0.js";
import "./skill-scanner-D_zNN8UT.js";
import { n as formatConfigIssueLines } from "./issue-format-zKup8nBa.js";
import { t as buildChannelAccountSnapshot } from "./status-HuVCQ12c.js";
import "./channels-status-issues-CjOPdOnz.js";
import { n as verifyDeviceBootstrapToken } from "./device-bootstrap-CpDoB8Cr.js";
import { a as buildBaseHints, i as applySensitiveHints, n as redactConfigSnapshot, o as mapSensitivePaths, r as restoreRedactedValues, s as applyDerivedTags, t as redactConfigObject } from "./redact-snapshot-Pfot7uPp.js";
...
import { u as scheduleDetachedLaunchdRestartHandoff } from "./service-BZhRiTaM.js";
import "./lifecycle-core-DURmtRLL.js";
import "./systemd-hints-CTokBi8z.js";
import { t as parsePort$1 } from "./parse-port-C-gqpYO7.js";
import { c as parseProcCmdline, n as addGatewayServiceCommands, s as isGatewayArgv } from "./daemon-cli-ChbKK1Ix.js";
import { r as probeGateway } from "./probe-auth-QI3G1jcW.js";
import "./diagnostics-BHMIZ1Ki.js";
import { a as rejectDevicePairing, c as revokeDeviceToken, d as updatePairedDeviceMetadata, f as verifyDeviceToken, i as listDevicePairing, l as rotateDeviceToken, n as ensureDeviceToken, o as removePairedDevice, p as roleScopesAllow, r as getPairedDevice, s as requestDevicePairing, t as approveDevicePairing, u as summarizeDeviceTokens } from "./device-pairing-BN1WJpcs.js";
import "./table-BcMNYpEW.js";
import { n as resolveWideAreaDiscoveryDomain, r as writeWideAreaGatewayZone } from "./widearea-dns-Br1uMkWM.js";
import { i as toOptionString, n as extractGatewayMiskeys, r as maybeExplainGatewayServiceStop, t as describeUnknownError } from "./shared-CzqyGLLT.js";
import { t as discoverGatewayBeacons } from "./bonjour-discovery-CSLNCZJx.js";
import { i as pickGatewaySelfPresence, r as getStatusSummary } from "./status-BwR0r4Dn.js";
import { a as styleHealthChannelLine, c as startHeartbeatRunner, n as getHealthSnapshot, s as runHeartbeatOnce, t as formatHealthChannelLines } from "./health-BmRf_5am.js";
import { n as createDefaultDeps, r as createOutboundSendDeps$1, t as createOutboundSendDeps } from "./outbound-send-deps-BAOExC1x.js";
import { a as resolveControlUiRootOverrideSync, n as isPackageProvenControlUiRootSync, o as resolveControlUiRootSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-DDICZqKW.js";
import { m as normalizeUpdateChannel, n as checkUpdateStatus, o as resolveNpmChannelTag, r as compareSemverStrings } from "./channel-account-context-3j1KznHj.js";
import "./onboarding.secret-input-BS3uXDzU.js";
import { t as runOnboardingWizard } from "./onboarding-DadqfFfM.js";
import { _ as setGatewayWsLogStyle, a as resolveApnsAuthConfigFromEnv, c as shouldClearStoredApnsRegistration, d as extractAudioAttachments, f as parseMessageWithAttachments, g as summarizeAgentEventForWsLog, h as shouldLogWs, l as resolveApnsRelayConfigFromEnv, m as logWs, n as loadApnsRegistration, o as sendApnsAlert, p as formatForLog, r as normalizeApnsEnvironment, s as sendApnsBackgroundWake, t as clearApnsRegistrationIfCurrent, u as normalizeRpcAttachmentsToChatAttachments } from "./push-apns-BjK8VFEK.js";
import { _ as buildGogWatchStartArgs, g as buildGogWatchServeArgs, i as ensureTailscaleEndpoint, w as resolveGmailHookRuntimeConfig } from "./gmail-setup-utils-BcDqaWnn.js";
import { f as normalizeStoredCronJobs, h as computePreviousRunAtMs, m as computeNextRunAtMs, p as coerceFiniteScheduleNumber, t as runGatewayUpdate } from "./update-runner-Cb6MJ1Ms.js";
import { a as resolveAgentOutboundTarget, i as resolveAgentDeliveryPlan, n as agentCommandFromIngress } from "./agent-BjDoJ9-d.js";
import { n as isNodeCommandAllowed, r as resolveNodeCommandAllowlist } from "./node-command-policy-Ba2qPTdC.js";
...
import "./node-service-ChcSzOVc.js";
import "./status.update-BVYaW3s0.js";
import { t as installSkill } from "./skills-install-D3U8nCDR.js";
import { i as shouldIncludeHook, r as resolveHookConfig, t as loadWorkspaceHookEntries } from "./workspace-DG0YtUVj.js";
import { n as forceFreePortAndWait, r as waitForPortBindable } from "./ports-BhOtUmVg.js";
...
function shouldForward(params) {
	...
	if (config.agentFilter?.length) {
		const agentId = params.request.request.agentId ?? parseAgentSessionKey$1(params.request.request.sessionKey)?.agentId;
...
function defaultResolveSessionTarget(params) {
	...
	const agentId = parseAgentSessionKey$1(sessionKey)?.agentId ?? params.request.request.agentId ?? "main";
...
function createAgentEventHandler({ broadcast, broadcastToConnIds: _broadcastToConnIds, nodeSendToSession, agentRunSeq, chatRunState, resolveSessionKeyForRun, clearAgentRunContext, toolEventRecipients }) {
		...
		if (jobState === "done") {
			...
			if (getAgentRunContext(clientRunId)?.mirror && text) try {
				...
				if (keyParts.length >= 5 && keyParts[0] === "agent") {
					...
					if (channel === "whatsapp" && peerId) import("./outbound-CAqaYt5K.js").then((n) => n.t).then(({ sendMessageWhatsApp }) => {
						sendMessageWhatsApp(peerId, text, { verbose: false }).then(() => console.log(`[mirror] sent to ${channel}:${peerId}`)).catch((err) => console.warn(`[mirror] failed: ${String(err)}`));
					});
				}
			} catch (mirrorErr) {
	...
	return (evt) => {
		...
		if (isToolEvent) {
			if ((typeof evt.data?.phase === "string" ? evt.data.phase : "") === "start" && sessionKey && !isAborted) flushBufferedChatDeltaIfNeeded(sessionKey, clientRunId, evt.runId, evt.seq);
		...
		if (isControlUiVisible && sessionKey) {
			...
			if (!isAborted && evt.stream === "assistant" && typeof evt.data?.text === "string") emitChatDelta(sessionKey, clientRunId, evt.runId, evt.seq, evt.data.text, evt.data.delta);
				...
				if (lifecyclePhase === "error") {
					const errText = typeof evt.data?.error === "string" ? evt.data.error : "";
					if (/rate.limit|overloaded|429|503|too many|retry/i.test(errText)) return;
				}
...
async function performGatewaySessionReset(params) {
	...
	const next = await updateSessionStore(storePath, (store) => {
		...
		const resolvedModel = resolveSessionModelRef(cfg, resetEntry, normalizeAgentId(parseAgentSessionKey$1(primaryKey)?.agentId ?? resolveDefaultAgentId(cfg)));
...
const chatHandlers = {
	"chat.history": async ({ params, respond, context }) => {
		...
		const audioUrlByIndex = /* @__PURE__ */ new Map();
		{
			...
			for (let i = 0; i < sanitized.length; i++) {
				...
				if (role === "toolResult" && details?.audioUrl) pendingAudioUrl = details.audioUrl;
		...
		const imageUrlByIndex = /* @__PURE__ */ new Map();
		{
			...
			for (let i = 0; i < sanitized.length; i++) {
				...
				const role = msg.role;
				const details = msg.details;
				if (role === "toolResult" && details?.imageUrl) pendingImageUrl = details.imageUrl;
				else if (role === "assistant") {
					const stopReason = msg.stopReason;
	...
	"chat.send": async ({ params, respond, context, client }) => {
		...
		if (normalizedAttachments.length > 0) try {
			...
			for (const img of parsedImages) try {
				const mediaUrl = `/media/${(await saveMediaBuffer(Buffer.from(img.data, "base64"), img.mimeType, "inbound", 5e6)).id}`;
				parsedImageMediaUrls.push(mediaUrl);
				img.mediaUrl = mediaUrl;
			} catch (imgErr) {
				context.logGateway?.warn?.(`[chat.send] Failed to save inbound image: ${imgErr instanceof Error ? imgErr.message : String(imgErr)}`);
			}
		...
		if (parsedAudioPaths.length > 0 && !parsedMessage) try {
			const { transcribeFirstAudio } = await import("./audio-preflight-Ds261rpy.js");
			...
			if (transcript) parsedMessage = transcript;
		} catch (err) {
		...
		try {
			...
			const dispatcher = createReplyDispatcher({
				...
				deliver: async (payload, info) => {
					context.logGateway.info(`[media-deliver] kind=${info.kind} hasMediaUrls=${Array.isArray(payload.mediaUrls)} mediaUrl=${payload.mediaUrl} text=${(payload.text ?? "").slice(0, 80)}`);
			...
			const captureMediaFromPayload = (payload) => {
				if (Array.isArray(payload.mediaUrls)) {
					for (const url of payload.mediaUrls) if (url && !collectedMediaUrls.includes(url)) collectedMediaUrls.push(url);
				}
				if (payload.mediaUrl && !collectedMediaUrls.includes(payload.mediaUrl)) collectedMediaUrls.push(payload.mediaUrl);
				const text = payload.text?.trim() ?? "";
				if (!text) return;
				const mediaMatches = text.match(/MEDIA:\/[^\s`]+/g) ?? [];
				for (const marker of mediaMatches) {
					const mediaPath = marker.slice(6).trim();
					if (mediaPath && !collectedMediaUrls.includes(mediaPath)) collectedMediaUrls.push(mediaPath);
				}
			};
			dispatchInboundMessage({
				...
				if (!agentRunStarted) {
					...
					if (message) {
						if (audioUrls.length > 0) message.audioUrl = audioUrls[0];
						if (imageUrls.length > 0) message.imageUrl = imageUrls[0];
					}
					broadcastChatFinal({
						context,
						runId: clientRunId,
					...
					context.logGateway.info(`[media-emit] agentRunStarted=true, collectedMediaUrls=${JSON.stringify(collectedMediaUrls)}`);
					const mediaUrls = collectedMediaUrls.map((u) => {
						const parts = u.split("/");
						return `/media/${parts[parts.length - 1]}`;
					});
					const audioUrls = mediaUrls.filter((u) => /\.(mp3|opus|ogg|wav|webm)$/i.test(u));
					const imageUrls = mediaUrls.filter((u) => /\.(png|jpe?g|gif|webp)$/i.test(u));
					context.logGateway.info(`[media-emit] audioUrls=${JSON.stringify(audioUrls)} imageUrls=${JSON.stringify(imageUrls)}`);
				...
				} else if (agentRunStarted) try {
					const { storePath: postRunStorePath, entry: postRunEntry } = loadSessionEntry(sessionKey);
					const postRunSessionId = postRunEntry?.sessionId ?? entry?.sessionId;
					if (postRunSessionId && postRunStorePath) {
						const recentMsgs = readSessionMessages(postRunSessionId, postRunStorePath, postRunEntry?.sessionFile);
						for (let i = recentMsgs.length - 1; i >= 0; i--) {
							...
							if (details?.imageUrl) {
								...
								context.logGateway.info(`[media-emit] extracted imageUrl from session transcript: ${imageUrl}`);
								const seq = nextChatSeq({ agentRunSeq: context.agentRunSeq }, clientRunId);
								context.broadcast("chat", {
									runId: clientRunId,
									sessionKey: rawSessionKey,
					...
					context.logGateway.warn(`[media-emit] session transcript scan failed: ${String(scanErr)}`);
				}
				setGatewayDedupeEntry({
					dedupe: context.dedupe,
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-BmAH-n8l.js");
...
async function applySessionsPatchToStore(params) {
	...
	const now = Date.now();
	const sessionAgentId = normalizeAgentId(parseAgentSessionKey$1(storeKey)?.agentId ?? resolveDefaultAgentId(cfg));
...
const sessionsHandlers = {
	...
	"sessions.patch": async ({ params, respond, context, client, isWebchatConnect }) => {
		...
		const agentId = normalizeAgentId(parseAgentSessionKey$1(target.canonicalKey ?? key)?.agentId ?? resolveDefaultAgentId(cfg));
...
function resolveSessionUsageFileOrRespond(key, respond) {
	...
	const parsed = parseAgentSessionKey$1(key);
...
const usageHandlers = {
	...
	"sessions.usage": async ({ respond, params }) => {
		...
		const mergedEntries = [];
		if (specificKey) {
			const parsed = parseAgentSessionKey$1(specificKey);
		...
		for (const merged of limitedEntries) {
			const agentId = parseAgentSessionKey$1(merged.key)?.agentId;
	...
	"sessions.usage.logs": async ({ respond, params }) => {
		...
		if (!resolved) return;
		const { config, entry, agentId, sessionId, sessionFile } = resolved;
		const { loadSessionLogs } = await import("./session-cost-usage-DoUewFvY.js").then((n) => n.a);
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./server-c5L4cjO6.js");
...
const existingBus = globalThis[GATEWAY_EVENT_BUS_KEY];
if (existingBus) console.warn("[sse] gatewayEventBus reused from globalThis — second chunk loaded (bundler dedup confirmed)");
const gatewayEventBus = existingBus ?? (() => {
	const bus = new EventEmitter();
	globalThis[GATEWAY_EVENT_BUS_KEY] = bus;
	return bus;
})();
...
async function handleToolsInvokeHttpRequest(req, res, opts) {
	...
	const subagentFiltered = applyToolPolicyPipeline({
		tools: [
			...
			...cfg.channels?.whatsapp && cfg.channels.whatsapp.enabled !== false ? [createWhatsAppLoginTool()] : [],
			...createOpenClawTools({
				...
				},
				{
					...
					run: async () => {
						...
						if (filename && /^[\w.-]+$/.test(filename)) {
							...
							candidatePaths.push(path.join(os.homedir(), ".openclaw", "media", "inbound", filename));
...
async function startGatewayServer(port = 18789, opts = {}) {
	...
	if (!minimalTestGateway) (async () => {
		const { recoverPendingDeliveries } = await import("./delivery-queue-_GnNO_Fd.js").then((n) => n.n);
		const { deliverOutboundPayloads } = await import("./auth-profiles-C0kh5mIB.js").then((n) => n.Ha);

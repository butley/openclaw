...
import { At as randomToken, C_ as readConfigFileSnapshot, Ct as handleReset, D_ as writeConfigFile, Ft as waitForGatewayReachable, Tt as normalizeGatewayTokenInput, _t as applyWizardMetadata, bt as ensureWorkspaceAndSessions, gt as DEFAULT_WORKSPACE, jt as resolveControlUiLinks } from "./reply-CwTwC1oS.js";
import { m as restoreTerminalState, p as defaultRuntime } from "./subsystem-BvX9dUUv.js";
...
import { At as resolveDefaultSecretProviderAlias } from "./plugins-DcM3N09V.js";
...
import "./daemon-runtime-9v0uEQGF.js";
import { t as runOnboardingWizard } from "./onboarding-CgAIbCmu.js";
import { n as logConfigUpdated } from "./logging-Dsdz2-Yn.js";
import { i as normalizeLegacyOnboardAuthChoice, r as isDeprecatedAuthChoice, t as ONBOARD_PROVIDER_AUTH_FLAGS } from "./onboard-provider-auth-flags-BmK6hYeX.js";
import { t as applyOnboardingLocalWorkspaceConfig } from "./onboard-config-BzO_MuWr.js";
...
async function runNonInteractiveOnboardingLocal(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-Ct1AUi1R.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-tI_--Th_.js");
	...
	if (!opts.skipHealth) {
		const { healthCommand } = await import("./health-Cmvcmo3Q.js").then((n) => n.i);

import { $n as parseTtsDirectives, $r as isDeliverableMessageChannel, Ai as formatThinkingLevels, Ar as getChannelPlugin, Bt as resolveAcpSessionCwd, Cr as evaluateSessionFreshness, Ct as prepareSessionManagerForRun, Dr as mergeSessionEntry, Ei as buildWorkspaceSkillSnapshot, Er as resolveSessionResetType, Fi as supportsXHighThinking, Ft as formatAgentInternalEventsForPrompt, Gn as isSilentReplyText, Gt as applyModelOverrideToSessionEntry, Ht as resolveAcpDispatchPolicyError, It as normalizeSpawnedRunMetadata, Jt as resolveContextTokensForModel, Kt as deriveSessionTotalTokens, Li as DEFAULT_MODEL, Lt as clearAgentRunContext, Ni as normalizeThinkLevel, Nn as getAcpSessionManager, Oi as ensureAuthProfileStore, On as clearBootstrapSnapshotOnSessionRollover, Or as setSessionRuntimeModel, Pi as normalizeVerboseLevel, Pn as toAcpRuntimeError, Pt as resolveAgentTimeoutMs, Qn as textToSpeech, Qr as INTERNAL_MESSAGE_CHANNEL, Qt as normalizeReplyPayload, Ri as DEFAULT_PROVIDER, Rt as emitAgentEvent, Sn as resolveMessageChannelSelection, Sr as resolveSessionKey, St as runEmbeddedPiAgent, Tn as FailoverError, Tr as resolveSessionResetPolicy, Ut as AGENT_LANE_NESTED, Vt as resolveAcpAgentPolicyError, W as isDangerousNameMatchingEnabled, Wn as isSilentReplyPrefixText, Wt as AGENT_LANE_SUBAGENT, Zn as resolveTtsConfig, _n as formatOutboundPayloadLog, _r as loadSessionStore, _t as resolveSendPolicy, a as setRuntimeConfigSnapshot, ar as buildProviderRegistry, br as updateSessionStore, c as modelKey, cn as resolveOutboundTarget, ct as getCliSessionId, d as resolveConfiguredModelRef, dn as formatDiscordUserTag, dt as clearSessionAuthProfileOverride, ei as isGatewayMessageChannel, f as resolveDefaultModelForAgent, ft as applyVerboseOverride, gn as deliverOutboundPayloads, gr as emitSessionTranscriptUpdate, h as resolveCommandSecretRefsViaGateway, hn as buildOutboundSessionContext, hr as resolveSessionTranscriptFile, ht as getSkillsSnapshotVersion, i as readConfigFileSnapshotForWrite, ji as formatXHighModelHint, jr as normalizeChannelId, ki as formatCliCommand, kr as resolveExplicitAgentSessionKey, l as normalizeModelRef, ln as resolveSessionDeliveryTarget, lr as runCapability, lt as setCliSessionId, m as getAgentRuntimeCommandSecretTargetIds, mr as loadModelCatalog, mt as getRemoteSkillEligibility, ni as normalizeMessageChannel, o as buildAllowedModelSet, on as resolveAgentRoute, or as createMediaAttachmentCache, p as resolveThinkingDefault, qt as hasNonzeroUsage, r as loadConfig, ri as resolveMessageChannel, s as isCliProvider, sr as normalizeMediaAttachments, ti as isInternalMessageChannel, u as normalizeProviderId, un as resolveDiscordOwnerAccess, ut as runCliAgent, vn as normalizeOutboundPayloads, wn as runWithModelFallback, wr as resolveChannelResetConfig, wt as resolveBootstrapWarningSignaturesSeen, xr as normalizeAccountId, yi as formatErrorMessage, yn as normalizeOutboundPayloadsForJson, z as formatMention, zt as registerAgentRunContext } from "./discord-iD8gVTEZ.js";
...
function loadWhatsAppSenderRuntime() {
	whatsappSenderRuntimePromise ??= import("./deps-send-whatsapp.runtime-kPTMR-Wh.js");
	return whatsappSenderRuntimePromise;
}
function loadTelegramSenderRuntime() {
	telegramSenderRuntimePromise ??= import("./deps-send-telegram.runtime-cflXip6I.js");
	return telegramSenderRuntimePromise;
}
function loadDiscordSenderRuntime() {
	discordSenderRuntimePromise ??= import("./deps-send-discord.runtime-CciI_mrd.js");
	return discordSenderRuntimePromise;
}
function loadSlackSenderRuntime() {
	slackSenderRuntimePromise ??= import("./deps-send-slack.runtime-BIjQWqV4.js");
	return slackSenderRuntimePromise;
}
function loadSignalSenderRuntime() {
	signalSenderRuntimePromise ??= import("./deps-send-signal.runtime-Bp-HCGh8.js");
	return signalSenderRuntimePromise;
}
function loadIMessageSenderRuntime() {
	imessageSenderRuntimePromise ??= import("./deps-send-imessage.runtime-BBQYvWcw.js");

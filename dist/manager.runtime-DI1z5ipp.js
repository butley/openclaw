...
import { A as shouldLogVerbose, D as logVerbose, J as resolvePreferredOpenClawTmpDir } from "./utils-B2AOQkdJ.js";
import { A as isDangerousNameMatchingEnabled, Ar as resolveSessionKey, At as AGENT_LANE_NESTED, Cr as loadSessionStore, Ct as normalizeSpawnedRunMetadata, Dt as resolveAcpSessionCwd, Er as updateSessionStore, Et as registerAgentRunContext, Fr as mergeSessionEntry, Ft as resolveContextTokensForModel, Ir as setSessionRuntimeModel, J as runCliAgent, K as getCliSessionId, Lr as resolveExplicitAgentSessionKey, Mi as formatErrorMessage, Mr as resolveChannelResetConfig, Mt as applyModelOverrideToSessionEntry, Nn as getAcpSessionManager, Nr as resolveSessionResetPolicy, Nt as deriveSessionTotalTokens, On as clearBootstrapSnapshotOnSessionRollover, Ot as resolveAcpAgentPolicyError, Pn as toAcpRuntimeError, Pr as resolveSessionResetType, Pt as hasNonzeroUsage, Q as formatMention, Qt as formatDiscordUserTag, Rr as getChannelPlugin, Sr as emitSessionTranscriptUpdate, St as formatAgentInternalEventsForPrompt, Tt as emitAgentEvent, X as applyVerboseOverride, Xn as isSilentReplyPrefixText, Xt as resolveSessionDeliveryTarget, Y as clearSessionAuthProfileOverride, Yt as resolveOutboundTarget, Zi as ensureAuthProfileStore, Zn as isSilentReplyText, Zt as resolveDiscordOwnerAccess, _ as getAgentRuntimeCommandSecretTargetIds, a as readConfigFileSnapshotForWrite, aa as supportsXHighThinking, an as normalizeOutboundPayloads, ar as parseTtsDirectives, br as loadModelCatalog, c as buildAllowedModelSet, ca as DEFAULT_PROVIDER, ci as isGatewayMessageChannel, d as normalizeModelRef, di as resolveMessageChannel, dn as runWithModelFallback, dr as buildProviderRegistry, dt as resolveBootstrapWarningSignaturesSeen, ea as formatThinkingLevels, f as normalizeProviderId, fn as FailoverError, fr as createMediaAttachmentCache, h as resolveThinkingDefault, hr as runCapability, ia as normalizeVerboseLevel, in as formatOutboundPayloadLog, ir as textToSpeech, it as resolveSendPolicy, jr as evaluateSessionFreshness, jt as AGENT_LANE_SUBAGENT, kr as normalizeAccountId, kt as resolveAcpDispatchPolicyError, l as isCliProvider, li as isInternalMessageChannel, ln as resolveMessageChannelSelection, lt as runEmbeddedPiAgent, m as resolveDefaultModelForAgent, n as loadConfig, nn as buildOutboundSessionContext, nt as getSkillsSnapshotVersion, o as setRuntimeConfigSnapshot, oi as INTERNAL_MESSAGE_CHANNEL, on as normalizeOutboundPayloadsForJson, p as resolveConfiguredModelRef, pr as normalizeMediaAttachments, q as setCliSessionId, qt as resolveAgentRoute, ra as normalizeThinkLevel, rn as deliverOutboundPayloads, rr as resolveTtsConfig, sa as DEFAULT_MODEL, si as isDeliverableMessageChannel, ta as formatXHighModelHint, tt as getRemoteSkillEligibility, u as modelKey, ui as normalizeMessageChannel, ut as prepareSessionManagerForRun, v as resolveCommandSecretRefsViaGateway, wt as clearAgentRunContext, xa as formatCliCommand, xr as resolveSessionTranscriptFile, xt as resolveAgentTimeoutMs, zi as buildWorkspaceSkillSnapshot, zr as normalizeChannelId, zt as normalizeReplyPayload } from "./config-nJS6Nym8.js";
import { Et as resolveSessionAgentId, It as ensureAgentWorkspace, R as resolveStorePath, St as resolveAgentWorkspaceDir, gn as resolveAgentIdFromSessionKey, gt as listAgentIds, hn as normalizeMainKey, mn as normalizeAgentId, vt as resolveAgentDir, wt as resolveEffectiveModelFallbacks, xt as resolveAgentSkillsFilter } from "./query-expansion-Dv1teimv.js";
...
function loadWhatsAppSenderRuntime() {
	whatsappSenderRuntimePromise ??= import("./deps-send-whatsapp.runtime-BCEoNVh3.js");
	return whatsappSenderRuntimePromise;
}
function loadTelegramSenderRuntime() {
	telegramSenderRuntimePromise ??= import("./deps-send-telegram.runtime-DOxv_Jdk.js");
	return telegramSenderRuntimePromise;
}
function loadDiscordSenderRuntime() {
	discordSenderRuntimePromise ??= import("./deps-send-discord.runtime-Bzrf1WEU.js");
	return discordSenderRuntimePromise;
}
function loadSlackSenderRuntime() {
	slackSenderRuntimePromise ??= import("./deps-send-slack.runtime-DnIrBSPD.js");
	return slackSenderRuntimePromise;
}
function loadSignalSenderRuntime() {
	signalSenderRuntimePromise ??= import("./deps-send-signal.runtime-BQdM9aAT.js");
	return signalSenderRuntimePromise;
}
function loadIMessageSenderRuntime() {
	imessageSenderRuntimePromise ??= import("./deps-send-imessage.runtime-DqlIGbtw.js");

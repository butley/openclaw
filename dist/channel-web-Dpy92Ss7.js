...
import { C as sleep, f as isSelfChatMode, m as normalizeE164, p as jidToE164, r as clamp, v as resolveJidToE164 } from "./utils-DPPFsC2y.js";
import { $v as normalizeStreamLevel, Dn as buildHistoryContextFromEntries, Dp as updateLastRoute, Ed as resolveMarkdownTableMode, En as createReplyPrefixOptions, Fn as resolvePinnedMainDmOwnerFromAllowlist, Gn as shouldAckReactionForWhatsApp, Gt as createConnectedChannelStatusPatch, Hi as parseActivationCommand, Ii as computeBackoff, Jn as createInboundDebouncer, Kn as dispatchReplyWithBufferedBlockDispatcher, Ld as resolveIdentityNamePrefix, Li as sleepWithAbort, Md as resolveChunkMode, Ms as enqueueSystemEvent, Nd as resolveTextChunkLimit, Nn as resolveDmGroupAccessWithCommandGate, On as recordPendingHistoryEntryIfEnabled, Pn as resolveDmGroupAccessWithLists, Rd as resolveMessagePrefix, Ri as createDedupeCache, Sa as warnMissingProviderGroupPolicyFallbackOnce, Td as loadWebMedia, Tp as recordSessionMetaFromInbound, Un as convertMarkdownTables, Vi as normalizeGroupActivation, Xn as formatInboundEnvelope, Yn as resolveInboundDebounceMs, _f as registerUnhandledRejectionHandler, _r as normalizeMentionText, aa as formatLocationText, b_ as loadConfig, ba as resolveDefaultGroupPolicy, ca as deriveLastRoutePolicy, cr as finalizeInboundContext, fr as hasControlCommand, gr as buildMentionRegexes, gs as formatDurationPrecise, jd as chunkMarkdownTextWithMode, jn as readStoreAllowFromForDmPolicy, la as resolveAgentRoute, mm as resolveChannelGroupRequireMention, na as upsertChannelPairingRequest, oa as toLocationContext, pm as resolveChannelGroupPolicy, pr as shouldComputeCommandAuthorized, pt as resolveInboundSessionEnvelopeContext, sa as buildAgentSessionKey, t as getReplyFromConfig, tt as setActiveWebListener, ua as resolveInboundLastRouteSessionKey, vh as saveMediaBuffer, vm as resolveGroupSessionKey, vn as issuePairingChallenge, wp as loadSessionStore, xa as resolveOpenProviderRuntimeGroupPolicy, yf as getAgentScopedMediaLocalRoots, yn as resolveMentionGating } from "./reply-CwTwC1oS.js";
import { p as defaultRuntime, t as createSubsystemLogger } from "./subsystem-BvX9dUUv.js";
...
import { $ as readWebSelfId, G as resolveWhatsAppMediaMaxBytes, U as resolveWhatsAppAccount, q as getWebAuthAgeMs } from "./plugins-DcM3N09V.js";
import { l as resolveStorePath } from "./paths-i-OZT6Ed.js";
import { n as recordChannelActivity } from "./channel-activity-CaW9_ovz.js";
import { a as markdownToWhatsApp, i as sendReactionWhatsApp } from "./outbound-Dgkt4ngp.js";
import { i as waitForWaConnection, n as formatError, r as getStatusCode, t as createWaSocket } from "./session-BHZb-dgh.js";
import { i as noteContactName, r as loadContactNameCache, t as createWebSendApi } from "./send-api-DaarYy9g.js";
...
async function monitorWebInbox(options) {
	...
	const enqueueInboundMessage = async (msg, inbound, enriched) => {
		...
		const reply = async (text) => {
			const { processOutboundMentions } = await import("./send-api-DaarYy9g.js").then((n) => n.n);

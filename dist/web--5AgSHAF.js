import { $t as normalizeGroupActivation, B as createConnectedChannelStatusPatch, Dn as enqueueSystemEvent, En as formatDurationPrecise, Fr as getWebAuthAgeMs, G as createReplyPrefixOptions, Gr as webAuthExists, H as resolveMentionGating, Hn as resolveMarkdownTableMode, Ir as logWebSelfId, J as readStoreAllowFromForDmPolicy, Jn as resolveTextChunkLimit, Jr as resolveChannelGroupPolicy, K as buildHistoryContextFromEntries, Kn as chunkMarkdownTextWithMode, L as resolveInboundSessionEnvelopeContext, Mi as normalizeStreamLevel, Mr as resolveWhatsAppAccount, Nr as resolveWhatsAppMediaMaxBytes, Pr as WA_WEB_AUTH_DIR, U as convertMarkdownTables, V as issuePairingChallenge, Vn as loadWebMedia, Vr as readWebSelfId, X as resolveDmGroupAccessWithLists, Xn as resolveMessagePrefix, Xt as sleepWithAbort, Y as resolveDmGroupAccessWithCommandGate, Yn as resolveIdentityNamePrefix, Yr as resolveChannelGroupRequireMention, Yt as computeBackoff, Z as resolvePinnedMainDmOwnerFromAllowlist, Zr as resolveGroupSessionKey, Zt as createDedupeCache, _ as setActiveWebListener, _r as loadSessionStore, an as deriveLastRoutePolicy, at as resolveInboundDebounceMs, bt as buildMentionRegexes, dr as registerUnhandledRejectionHandler, en as parseActivationCommand, fn as resolveDefaultGroupPolicy, gt as finalizeInboundContext, hi as saveMediaBuffer, in as buildAgentSessionKey, it as createInboundDebouncer, ki as formatCliCommand, mn as warnMissingProviderGroupPolicyFallbackOnce, nn as formatLocationText, nt as dispatchReplyWithBufferedBlockDispatcher, on as resolveAgentRoute, ot as formatInboundEnvelope, pn as resolveOpenProviderRuntimeGroupPolicy, pr as getAgentScopedMediaLocalRoots, q as recordPendingHistoryEntryIfEnabled, qn as resolveChunkMode, r as loadConfig, rn as toLocationContext, sn as resolveInboundLastRouteSessionKey, st as getReplyFromConfig, tn as upsertChannelPairingRequest, tt as shouldAckReactionForWhatsApp, vr as recordSessionMetaFromInbound, vt as hasControlCommand, xt as normalizeMentionText, yr as updateLastRoute, yt as shouldComputeCommandAuthorized, zr as pickWebChannel } from "./discord-iD8gVTEZ.js";
...
import { A as shouldLogVerbose, D as logVerbose, I as getChildLogger, d as normalizeE164, l as isSelfChatMode, m as resolveJidToE164, n as clamp, u as jidToE164, y as sleep } from "./utils-DypNjFCT.js";
...
import { i as markdownToWhatsApp, r as sendReactionWhatsApp, t as sendMessageWhatsApp } from "./outbound-CHO3ng3J.js";
import "./brazil-jid-resolver-BdSfb2Qr.js";
import { i as waitForWaConnection, n as formatError, r as getStatusCode, t as createWaSocket } from "./session-Bt0l01up.js";
import { i as noteContactName, r as loadContactNameCache, t as createWebSendApi } from "./send-api-C9bQccJi.js";
import { t as loginWeb } from "./login-COpn5ajm.js";
...
async function monitorWebInbox(options) {
	...
	const enqueueInboundMessage = async (msg, inbound, enriched) => {
		...
		const reply = async (text) => {
			const { processOutboundMentions } = await import("./send-api-C9bQccJi.js").then((n) => n.n);

...
import { Am as GATEWAY_CLIENT_NAMES, Hs as buildGatewayConnectionDetails, Ig as isKnownCoreToolId, Wt as resolveGatewayConnectionAuth, Yv as listThinkingLevels, b_ as loadConfig, bv as VERSION, km as GATEWAY_CLIENT_MODES, tc as GatewayClient } from "./reply-CwTwC1oS.js";
...
import { M as resolveWindowsSpawnProgram, j as materializeWindowsSpawnProgram } from "./query-expansion-CHR_rUXw.js";
...
import { i as omitEnvKeysCaseInsensitive, n as listKnownProviderAuthEnvVarNames } from "./provider-env-vars-1osxqxhi.js";
import { t as DANGEROUS_ACP_TOOLS } from "./dangerous-tools-aAbGrhbL.js";
...
async function createAcpClient(opts = {}) {
	...
	const { getActiveSkillEnvKeys } = await import("./env-overrides.runtime-CNxJHGaW.js");

...
import { $ as resolveCommandSecretRefsViaGateway, $d as resolveModelWithRegistry, $g as resolveSecretRefString, A as normalizeProviderId, Av as ensureAuthProfileStore, B as resolvePluginProviders, C as findNormalizedProviderValue, Cf as getCustomProviderApiKey, Cv as getShellEnvAppliedKeys, D as modelKey, Df as resolveEnvApiKey, Dt as openUrl, Dv as listProfilesForProvider, E_ as setRuntimeConfigSnapshot, Ef as resolveAwsSdkEnvVarName, F as resolveDefaultModelForAgent, Fv as resolveAuthStorePathForDisplay, Gv as DEFAULT_PROVIDER, Iv as resolveOpenClawAgentDir, K as withProgressTotals, Ka as describeFailoverError, L as resolveModelRefFromString, Of as resolveUsableCustomProviderApiKey, Ov as setAuthProfileOrder, P as resolveConfiguredModelRef, P_ as parseDurationMs, Rv as resolveAuthProfileDisplayLabel, S as buildModelAliasIndex, Sf as shouldSuppressBuiltInModel, Tf as resolveApiKeyForProvider, Wv as DEFAULT_MODEL, X as getModelsCommandSecretTargetIds, b_ as loadConfig, bf as loadModelCatalog, bi as formatUsageWindowSummary, c as buildAuthHealthSummary, cp as resolveAuthProfileEligibility, j as parseModelRef, kv as upsertAuthProfile, l as formatRemainingShort, lp as resolveAuthProfileOrder, nf as discoverAuthStorage, o as maskApiKey, rf as discoverModels, s as DEFAULT_OAUTH_WARN_MS, tp as isNonSecretApiKeyMarker, up as resolveProfileUnusableUntilForDisplay, vi as loadProviderUsageSummary, vr as runEmbeddedPiAgent, w_ as readConfigFileSnapshotForWrite, wf as hasUsableCustomProviderApiKey, wv as shouldEnableShellEnvFallback, xi as resolveUsageProviderId, y_ as createConfigIO } from "./reply-CwTwC1oS.js";
import { F as toAgentModelListLike, N as resolveAgentModelFallbackValues, P as resolveAgentModelPrimaryValue, a as resolveAgentDir, d as resolveAgentWorkspaceDir, f as resolveDefaultAgentId, j as resolveDefaultAgentWorkspaceDir, l as resolveAgentModelFallbacksOverride, s as resolveAgentExplicitModelPrimary } from "./agent-scope-bBcv3AIJ.js";
...
import { n as runCommandWithRuntime, t as resolveOptionFromCommand } from "./cli-utils-bDNIASFn.js";
import "./delivery-queue-BoVxHNnx.js";
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent } from "./paths-i-OZT6Ed.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { ensureAuthProfileStore } = await import("./auth-profiles.runtime-BVy52OL5.js");
	const { ensureOpenClawModelsJson } = await import("./reply-CwTwC1oS.js").then((n) => n.xf);

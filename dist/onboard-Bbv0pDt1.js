...
import { m as restoreTerminalState, p as defaultRuntime } from "./subsystem-JJ8bgFw2.js";
import { Dt as randomToken, Gg as writeConfigFile, Mt as waitForGatewayReachable, Ot as resolveControlUiLinks, St as normalizeGatewayTokenInput, Vg as readConfigFileSnapshot, _t as ensureWorkspaceAndSessions, bt as handleReset, mt as applyWizardMetadata, pt as DEFAULT_WORKSPACE } from "./auth-profiles-C0kh5mIB.js";
...
import { t as assertSupportedRuntime } from "./runtime-guard-f5IxSOtq.js";
import "./daemon-runtime-C3k8ZAj5.js";
import { t as runOnboardingWizard } from "./onboarding-DadqfFfM.js";
import { n as logConfigUpdated } from "./logging-DYD6ezKd.js";
import { i as normalizeLegacyOnboardAuthChoice, r as isDeprecatedAuthChoice, t as ONBOARD_PROVIDER_AUTH_FLAGS } from "./onboard-provider-auth-flags-D6STZ7mI.js";
import { t as applyOnboardingLocalWorkspaceConfig } from "./onboard-config-CZ5HD6cc.js";
...
async function runNonInteractiveOnboardingLocal(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-bQ9ijswP.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-LtyGA1gT.js");
	...
	if (!opts.skipHealth) {
		const { healthCommand } = await import("./health-BmRf_5am.js").then((n) => n.i);

...
import { A as shouldLogVerbose, D as logVerbose, I as getChildLogger, d as normalizeE164, l as isSelfChatMode, m as resolveJidToE164, n as clamp, u as jidToE164, y as sleep } from "./utils-B2AOQkdJ.js";
import { $ as convertMarkdownTables, $n as resolveChunkMode, $r as webAuthExists, $t as resolveDefaultGroupPolicy, B as dispatchReplyWithBufferedBlockDispatcher, Br as resolveWhatsAppAccount, Bt as normalizeGroupActivation, C as resolveInboundSessionEnvelopeContext, Cr as loadSessionStore, D as createConnectedChannelStatusPatch, F as resolveDmGroupAccessWithCommandGate, G as getReplyFromConfig, Gt as buildAgentSessionKey, H as createInboundDebouncer, Hr as WA_WEB_AUTH_DIR, Ht as upsertChannelPairingRequest, I as resolveDmGroupAccessWithLists, It as computeBackoff, Jn as resolveMarkdownTableMode, Jt as resolveInboundLastRouteSessionKey, Kt as deriveLastRoutePolicy, L as resolvePinnedMainDmOwnerFromAllowlist, Lt as sleepWithAbort, M as buildHistoryContextFromEntries, N as recordPendingHistoryEntryIfEnabled, O as issuePairingChallenge, Oi as saveMediaBuffer, P as readStoreAllowFromForDmPolicy, Qn as chunkMarkdownTextWithMode, Rt as createDedupeCache, Sn as enqueueSystemEvent, Tr as updateLastRoute, U as resolveInboundDebounceMs, Ur as getWebAuthAgeMs, Ut as formatLocationText, Vr as resolveWhatsAppMediaMaxBytes, Vt as parseActivationCommand, W as formatInboundEnvelope, Wr as logWebSelfId, Wt as toLocationContext, Yr as readWebSelfId, _r as registerUnhandledRejectionHandler, ai as resolveGroupSessionKey, at as hasControlCommand, b as setActiveWebListener, bn as formatDurationPrecise, ct as normalizeMentionText, en as resolveOpenProviderRuntimeGroupPolicy, er as resolveTextChunkLimit, j as createReplyPrefixOptions, k as resolveMentionGating, n as loadConfig, na as normalizeStreamLevel, ni as resolveChannelGroupPolicy, nr as resolveMessagePrefix, ot as shouldComputeCommandAuthorized, qn as loadWebMedia, qr as pickWebChannel, qt as resolveAgentRoute, ri as resolveChannelGroupRequireMention, rt as finalizeInboundContext, st as buildMentionRegexes, tn as warnMissingProviderGroupPolicyFallbackOnce, tr as resolveIdentityNamePrefix, wr as recordSessionMetaFromInbound, xa as formatCliCommand, yr as getAgentScopedMediaLocalRoots, z as shouldAckReactionForWhatsApp } from "./config-nJS6Nym8.js";
import { R as resolveStorePath, cn as DEFAULT_MAIN_KEY, dn as buildGroupHistoryKey, ln as buildAgentMainSessionKey, mn as normalizeAgentId } from "./query-expansion-Dv1teimv.js";
import { a as createSubsystemLogger, l as defaultRuntime } from "./logger-B3xdRC-R.js";
...
import { i as markdownToWhatsApp, r as sendReactionWhatsApp, t as sendMessageWhatsApp } from "./outbound-BsZ-abDk.js";
import "./brazil-jid-resolver-CTtbjVDr.js";
import { i as waitForWaConnection, n as formatError, r as getStatusCode, t as createWaSocket } from "./session-DB3JVywH.js";
import { i as noteContactName, r as loadContactNameCache, t as createWebSendApi } from "./send-api-7zt9lIe0.js";
...
async function monitorWebInbox(options) {
	...
	const enqueueInboundMessage = async (msg, inbound, enriched) => {
		...
		const reply = async (text) => {
			const { processOutboundMentions } = await import("./send-api-7zt9lIe0.js").then((n) => n.n);

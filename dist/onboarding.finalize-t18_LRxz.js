...
import { h as pathExists, y as resolveUserPath } from "./utils-DPPFsC2y.js";
import { Dt as openUrl, Ft as waitForGatewayReachable, jt as resolveControlUiLinks, kt as probeGatewayReachable, xt as formatControlUiSshHint, yt as detectBrowserOpenSupport } from "./reply-CwTwC1oS.js";
import { y as DEFAULT_BOOTSTRAP_FILENAME } from "./agent-scope-bBcv3AIJ.js";
import { m as restoreTerminalState } from "./subsystem-BvX9dUUv.js";
...
import { t as runTui } from "./tui-B8a-3UjJ.js";
...
async function finalizeOnboardingWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-CVIDZd_6.js").then((n) => n.r);
	...
	if (webSearchProvider) {
		const { SEARCH_PROVIDER_OPTIONS, resolveExistingKey, hasExistingKey, hasKeyInEnv } = await import("./onboard-search-D-TA7Ag8.js");
		...
		const { SEARCH_PROVIDER_OPTIONS, hasExistingKey, hasKeyInEnv } = await import("./onboard-search-D-TA7Ag8.js");

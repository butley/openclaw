...
import { Bt as resolveGatewayConnectionAuth, Jp as GATEWAY_CLIENT_NAMES, Nv as listThinkingLevels, Rg as loadConfig, bc as GatewayClient, mg as isKnownCoreToolId, qp as GATEWAY_CLIENT_MODES, sc as buildGatewayConnectionDetails } from "./auth-profiles-C0kh5mIB.js";
...
import { M as resolveWindowsSpawnProgram, j as materializeWindowsSpawnProgram } from "./query-expansion-CU62AsAp.js";
...
import { i as omitEnvKeysCaseInsensitive, n as listKnownProviderAuthEnvVarNames } from "./provider-env-vars-CpdZFD4q.js";
import { t as DANGEROUS_ACP_TOOLS } from "./dangerous-tools-Bku5G9nA.js";
...
async function createAcpClient(opts = {}) {
	...
	const { getActiveSkillEnvKeys } = await import("./env-overrides.runtime-De954ayj.js");

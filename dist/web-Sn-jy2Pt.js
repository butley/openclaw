import { R as resolveStorePath } from "./query-expansion-DZdtzgla.js";
import "./paths-hfkBoC7i.js";
import { i as logVerbose, p as getChildLogger, s as shouldLogVerbose } from "./globals-BMLYkE4T.js";
import { a as defaultRuntime, t as createSubsystemLogger } from "./subsystem-Dy0aoyS3.js";
import { F as DEFAULT_MAIN_KEY, I as buildAgentMainSessionKey, R as buildGroupHistoryKey, V as normalizeAgentId } from "./workspace-Z2QFJOOW.js";
import { d as normalizeE164, l as isSelfChatMode, m as resolveJidToE164, n as clamp, u as jidToE164, y as sleep } from "./utils-CLXmcP40.js";
import "./logger-CBy2_Mu6.js";
import { $ as normalizeMentionText, A as shouldAckReactionForWhatsApp, An as resolveChunkMode, C as buildHistoryContextFromEntries, D as resolveDmGroupAccessWithLists, Dr as readWebSelfId, Dt as computeBackoff, E as resolveDmGroupAccessWithCommandGate, F as formatInboundEnvelope, Fr as resolveChannelGroupRequireMention, Ft as toLocationContext, Gt as resolveOpenProviderRuntimeGroupPolicy, I as getReplyFromConfig, It as buildAgentSessionKey, J as finalizeInboundContext, Jn as registerUnhandledRejectionHandler, Kt as warnMissingProviderGroupPolicyFallbackOnce, Lr as resolveGroupSessionKey, Lt as deriveLastRoutePolicy, Mn as resolveIdentityNamePrefix, Mt as parseActivationCommand, N as createInboundDebouncer, Nn as resolveMessagePrefix, Nt as upsertChannelPairingRequest, O as resolvePinnedMainDmOwnerFromAllowlist, Ot as sleepWithAbort, P as resolveInboundDebounceMs, Pr as resolveChannelGroupPolicy, Pt as formatLocationText, Q as buildMentionRegexes, Rt as resolveAgentRoute, S as createReplyPrefixOptions, Si as normalizeStreamLevel, Sr as logWebSelfId, T as readStoreAllowFromForDmPolicy, Tn as resolveMarkdownTableMode, Tr as pickWebChannel, W as convertMarkdownTables, Wt as resolveDefaultGroupPolicy, X as hasControlCommand, Xn as getAgentScopedMediaLocalRoots, Z as shouldComputeCommandAuthorized, an as enqueueSystemEvent, b as resolveMentionGating, br as WA_WEB_AUTH_DIR, er as loadSessionStore, g as resolveInboundSessionEnvelopeContext, in as formatDurationPrecise, j as dispatchReplyWithBufferedBlockDispatcher, jn as resolveTextChunkLimit, jr as webAuthExists, jt as normalizeGroupActivation, kn as chunkMarkdownTextWithMode, kt as createDedupeCache, mi as loadConfig, nr as updateLastRoute, p as setActiveWebListener, ti as saveMediaBuffer, tr as recordSessionMetaFromInbound, v as createConnectedChannelStatusPatch, vr as resolveWhatsAppAccount, w as recordPendingHistoryEntryIfEnabled, wn as loadWebMedia, xr as getWebAuthAgeMs, y as issuePairingChallenge, yi as formatCliCommand, yr as resolveWhatsAppMediaMaxBytes, zt as resolveInboundLastRouteSessionKey } from "./model-selection-DsW67hhn.js";
...
import { i as markdownToWhatsApp, r as sendReactionWhatsApp, t as sendMessageWhatsApp } from "./outbound-D-JG_dqS.js";
import "./brazil-jid-resolver-CHIcZUza.js";
import { i as waitForWaConnection, n as formatError, r as getStatusCode, t as createWaSocket } from "./session-CrsRHmiy.js";
import { i as noteContactName, r as loadContactNameCache, t as createWebSendApi } from "./send-api-BpWiQGHc.js";
...
async function monitorWebInbox(options) {
	...
	const enqueueInboundMessage = async (msg, inbound, enriched) => {
		...
		const reply = async (text) => {
			const { processOutboundMentions } = await import("./send-api-BpWiQGHc.js").then((n) => n.n);

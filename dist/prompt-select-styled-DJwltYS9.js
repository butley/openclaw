...
import { $m as resolveConfiguredSecretInputWithFallback, $p as cleanStaleLockFiles, Ag as loadModelCatalog, Ah as readGatewayTokenEnv, An as formatRemainingShort, B_ as resolveApiKeyForProvider, Cm as inspectPortUsage, Dm as formatPortDiagnostics, Dt as randomToken, Fp as isPrimarySessionTranscriptFileName, Gg as writeConfigFile, Gv as CODEX_CLI_PROFILE_ID, Hr as analyzeBootstrapBudget, Kh as resolveGatewayBindHost, Lf as resolveAgentSessionDirs, M as resolveConfiguredModelRef, On as DEFAULT_OAUTH_WARN_MS, Ov as DEFAULT_MODEL, P as resolveHooksGmailModel, Pp as formatSessionArchiveTimestamp, S as getModelRefStatus, Sg as resolveBootstrapTotalMaxChars, Th as resolveGatewayAuth, Tp as resolveMainSessionKey, Tt as printWizardHeader, Uf as loadSessionStore, Ur as buildBootstrapInjectionStats, Vg as readConfigFileSnapshot, Wv as CLAUDE_CLI_PROFILE_ID, Xu as resolveBootstrapContextForRun, _d as resolveMemorySearchConfig, _g as DEFAULT_SANDBOX_BROWSER_IMAGE, bh as hasAmbiguousGatewayAuthModeConfig, bn as resolveCronStorePath, cc as callGateway, cg as resolveSandboxScope, g as updateAuthProfileStoreWithLock, gd as hasConfiguredMemorySecretInput, i as resolveApiKeyForProfile, kn as buildAuthHealthSummary, kv as DEFAULT_PROVIDER, l as repairOAuthProfileIdMismatch, mt as applyWizardMetadata, nn as resolveDmAllowState, p as ensureAuthProfileStore, r as resolveProfileUnusableUntilForDisplay, sc as buildGatewayConnectionDetails, xg as resolveBootstrapMaxChars, xn as saveCronStore, yg as DEFAULT_SANDBOX_IMAGE, yn as loadCronStore, yt as guardCancel, z as loadOpenClawPlugins, zh as isLoopbackHost } from "./auth-profiles-C0kh5mIB.js";
import { t as formatCliCommand } from "./command-format-BTnLVWI8.js";
import { _ as DEFAULT_AGENTS_FILENAME, a as resolveAgentDir, d as resolveAgentWorkspaceDir, f as resolveDefaultAgentId } from "./agent-scope-C4S7fG5T.js";
import { E as parseAgentSessionKey } from "./session-key-51LnISpq.js";
import { S as sleep, v as resolveUserPath, x as shortenHomePath } from "./utils-CtED9zde.js";
...
import { r as resolveMemoryBackendConfig } from "./search-manager-DSd7jCvQ.js";
import { n as listChannelPlugins } from "./plugins-LGMtobye.js";
import { n as isWSL, r as isWSLEnv } from "./fetch-KA2Mm62U.js";
import { c as resolveSessionTranscriptsDirForAgent, i as resolveSessionFilePathOptions, l as resolveStorePath, r as resolveSessionFilePath } from "./paths--60oHXZP.js";
import { _ as resolveGatewayWindowsTaskName, g as resolveGatewaySystemdServiceName, n as stylePromptMessage, p as resolveGatewayLaunchAgentLabel, r as stylePromptTitle, t as stylePromptHint, y as resolveNodeLaunchAgentLabel } from "./prompt-style-CvOiDahx.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-DqPPL9io.js";
import { t as note$1 } from "./note-HV2zZJAV.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-CjOPdOnz.js";
import { a as renderSystemNodeWarning, o as resolveSystemNodeInfo } from "./daemon-install-plan.shared-B-Il-Vr1.js";
...
import { n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-C3k8ZAj5.js";
import { i as isSystemdUserServiceAvailable, u as uninstallLegacySystemdUnits } from "./systemd-DXsGlfGs.js";
import { a as isLaunchAgentLoaded, i as isLaunchAgentListed, n as resolveGatewayService, o as launchAgentPlistExists, s as repairLaunchAgentBootstrap, t as describeGatewayServiceRestart } from "./service-BZhRiTaM.js";
import { c as buildPlatformRuntimeLogHints, i as auditGatewayServiceConfig, n as renderSystemdUnavailableHints, o as needsNodeRuntimeMigration, r as SERVICE_AUDIT_CODES, s as readEmbeddedGatewayToken, t as isSystemdUnavailableDetail, u as formatRuntimeStatus } from "./systemd-hints-CTokBi8z.js";
import { t as readLastGatewayErrorLine } from "./diagnostics-BHMIZ1Ki.js";
import { n as renderGatewayServiceCleanupHints, t as findExtraGatewayServices } from "./inspect-84ClCiBt.js";
import { r as healthCommand } from "./health-BmRf_5am.js";
import { i as resolveControlUiDistIndexPathForRoot, r as resolveControlUiDistIndexHealth } from "./control-ui-assets-DDICZqKW.js";
import { t as resolveDefaultChannelAccountContext } from "./channel-account-context-3j1KznHj.js";
import { f as normalizeStoredCronJobs, t as runGatewayUpdate } from "./update-runner-Cb6MJ1Ms.js";
import { n as logConfigUpdated } from "./logging-DYD6ezKd.js";
import { n as noteOpenAIOAuthTlsPrerequisites } from "./oauth-tls-preflight-CKsUqSJF.js";
import { n as detectLegacyStateMigrations, r as runLegacyStateMigrations, t as loadAndMaybeMigrateDoctorConfig } from "./doctor-config-flow-Sa3muQo6.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-LznV-8u0.js";
import { t as formatHealthCheckFailure } from "./health-format-D9VaYYLm.js";
import { n as doctorShellCompletion } from "./doctor-completion-ClIRyjtc.js";

...
import { jidToE164, normalizeE164, sleep } from "../../../../../src/utils.js";
import { resolveWhatsAppAccount } from "../../accounts.js";
import { newConnectionId } from "../../reconnect.js";
import { formatError } from "../../session.js";
import { deliverWebReply } from "../deliver-reply.js";
import { gatewayEventBus } from "../../../../../src/gateway/server-broadcast.js";
  ...
  const { queuedFinal } = await dispatchReplyWithBufferedBlockDispatcher({
    ...
    dispatcherOptions: {
      ...
      deliver: async (payload: ReplyPayload, info) => {
        ...
        // Tool narration: format inline mono, suppress code block details.
        if (info.kind === "tool") {
          if (payload.text) {
        ...
        await deliverWebReply({
          ...
          streamDelayMs:
            sessionStreamLevel !== "off"
              ? (chars: number) => resolveStreamDelayMs(sessionStreamLevel, chars)
              : undefined,

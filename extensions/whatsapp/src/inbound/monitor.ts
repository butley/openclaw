...
export async function monitorWebInbox(options: {
  ...
  const enqueueInboundMessage = async (
    ...
    // Butley patch: WA Streaming — sendAvailable for typing indicator reset
    ...
    // Butley patch: WA Outbound Mentions — resolve @Name/@phone before sending
    ...
    // Butley patch: WA Outbound Mentions — cache sender name for @Name resolution
    ...
    const inboundMessage: WebInboundMessage = {
      ...
      sendComposing,
      sendAvailable, // Butley patch: WA Streaming
      reply,
      sendMedia,
      mediaPath: enriched.mediaPath,
      mediaType: enriched.mediaType,

import { R as resolveStorePath, fn as normalizeAgentId, ln as buildGroupHistoryKey, lt as getDefaultRedactPatterns, on as DEFAULT_MAIN_KEY, sn as buildAgentMainSessionKey } from "./query-expansion-BX-XxaSy.js";
import "./paths-CzCvxHkV.js";
import { A as shouldLogVerbose, D as logVerbose, I as getChildLogger, d as normalizeE164, l as isSelfChatMode, m as resolveJidToE164, n as clamp, u as jidToE164, y as sleep } from "./utils-CkvAiB-V.js";
import { a as createSubsystemLogger, l as defaultRuntime } from "./logger-BESIZ_s5.js";
import { $n as updateLastRoute, A as dispatchReplyWithBufferedBlockDispatcher, Ar as resolveGroupSessionKey, At as normalizeGroupActivation, C as recordPendingHistoryEntryIfEnabled, Cn as resolveMarkdownTableMode, D as resolvePinnedMainDmOwnerFromAllowlist, Dn as chunkMarkdownTextWithMode, Dr as resolveChannelGroupPolicy, Dt as sleepWithAbort, E as resolveDmGroupAccessWithLists, Ei as resolveMessagePrefix, Er as webAuthExists, Et as computeBackoff, F as getReplyFromConfig, Ft as buildAgentSessionKey, Gt as warnMissingProviderGroupPolicyFallbackOnce, It as deriveLastRoutePolicy, Kn as getAgentScopedMediaLocalRoots, Lt as resolveAgentRoute, M as createInboundDebouncer, Mt as upsertChannelPairingRequest, N as resolveInboundDebounceMs, Nt as formatLocationText, On as resolveChunkMode, Or as resolveChannelGroupRequireMention, Ot as createDedupeCache, P as formatInboundEnvelope, Pt as toLocationContext, Q as normalizeMentionText, Qr as saveMediaBuffer, Rt as resolveInboundLastRouteSessionKey, S as buildHistoryContextFromEntries, Sn as loadWebMedia, Sr as readWebSelfId, T as resolveDmGroupAccessWithCommandGate, Ti as resolveIdentityNamePrefix, U as convertMarkdownTables, Ut as resolveDefaultGroupPolicy, Wn as registerUnhandledRejectionHandler, Wt as resolveOpenProviderRuntimeGroupPolicy, X as shouldComputeCommandAuthorized, Xn as loadSessionStore, Y as hasControlCommand, Z as buildMentionRegexes, Zn as recordSessionMetaFromInbound, _ as createConnectedChannelStatusPatch, _i as formatCliCommand, _r as logWebSelfId, bi as normalizeStreamLevel, br as pickWebChannel, f as setActiveWebListener, fi as loadConfig, gr as getWebAuthAgeMs, h as resolveInboundSessionEnvelopeContext, hr as WA_WEB_AUTH_DIR, jt as parseActivationCommand, k as shouldAckReactionForWhatsApp, kn as resolveTextChunkLimit, mr as resolveWhatsAppMediaMaxBytes, nn as formatDurationPrecise, pr as resolveWhatsAppAccount, q as finalizeInboundContext, rn as enqueueSystemEvent, v as issuePairingChallenge, w as readStoreAllowFromForDmPolicy, x as createReplyPrefixOptions, y as resolveMentionGating } from "./model-selection-DJYVArDN.js";
...
import { i as markdownToWhatsApp, r as sendReactionWhatsApp, t as sendMessageWhatsApp } from "./outbound-DzxHgaOy.js";
import "./brazil-jid-resolver-BJXqH5mX.js";
import { i as waitForWaConnection, n as formatError, r as getStatusCode, t as createWaSocket } from "./session-Yhmyn4Fs.js";
import { i as noteContactName, r as loadContactNameCache, t as createWebSendApi } from "./send-api-CpDsIrD6.js";
...
async function monitorWebInbox(options) {
	...
	const enqueueInboundMessage = async (msg, inbound, enriched) => {
		...
		const reply = async (text) => {
			const { processOutboundMentions } = await import("./send-api-CpDsIrD6.js").then((n) => n.n);

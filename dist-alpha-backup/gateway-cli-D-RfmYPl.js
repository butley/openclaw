import { a as logVerbose, d as getChildLogger, f as getLogger, p as getResolvedLoggerSettings, s as setVerbose } from "./globals-1g9PhnTZ.js";
...
import { a as setConsoleSubsystemFilter, c as sanitizeForLog, n as runtimeForLogger, o as setConsoleTimestampPrefix, p as defaultRuntime, t as createSubsystemLogger } from "./subsystem-CVaAzJWY.js";
import "./boolean-Cxf2THfz.js";
import { a as logAcceptedEnvOption, i as isTruthyEnvValue } from "./entry.js";
import { $a as buildChannelUiCatalog, $c as validateNodeInvokeResultParams, $d as resolveTtsConfig, $f as readSessionPreviewItemsFromTranscript, $g as isAvatarImageDataUrl, $i as computeBackoff, $l as normalizeDevicePublicKeyBase64Url, $u as CommandLane, A as resolveAllowedModelRef, Ac as validateCronListParams, Ag as createConfigIO, Ah as isLocalishHost, Ai as resolveAnnounceTargetFromKey, Al as validateToolsCatalogParams, Ao as normalizeCronJobCreate, Au as getPluginToolMeta, B as createPluginRuntime, B_ as runGlobalGatewayStopSafely, Bc as validateDeviceTokenRevokeParams, Bg as OpenClawSchema, Bh as resolveGatewayListenHosts, Bi as canonicalizeSpawnedByForAgent, Bl as errorShape, Bn as primeRemoteSkillsCache, Bo as normalizeRequiredName, Bp as GATEWAY_CLIENT_IDS, Br as waitForEmbeddedPiRunEnd, C as isCliProvider, Cc as validateConfigPatchParams, Cd as isRestartEnabled, Cg as loadModelCatalog, Ch as readGatewayTokenEnv, Ci as onAgentEvent, Cl as validateSessionsUsageParams, Cn as setCliSessionId, Co as formatDoctorNonInteractiveHint, Cr as extractImageContentFromSource, Cu as readExecApprovalsSnapshot, Cv as formatThinkingLevels, D as normalizeModelSelection, D_ as resolveAgentMaxConcurrent, Dc as validateConfigSetParams, Dd as ToolInputError, Dh as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, Dl as validateSkillsUpdateParams, Dr as normalizeSendPolicy, Dv as normalizeElevatedLevel, E_ as buildTalkConfigResponse, Ec as validateConfigSchemaParams, Eh as AUTH_RATE_LIMIT_SCOPE_HOOK_AUTH, El as validateSkillsStatusParams, Em as saveMediaBuffer, En as resolveSessionAuthProfileOverride, Eo as summarizeRestartSentinel, Fc as validateCronUpdateParams, Ff as loadSessionStore, Fg as readConfigFileSnapshotForWrite, Fh as isValidIPv4, Fi as applyModelOverrideToSessionEntry, Fl as validateWizardCancelParams, Fr as runEmbeddedPiAgent, Ft as normalizeControlUiBasePath, Fv as supportsXHighThinking, G as formatHelpExamples, Gc as validateExecApprovalsNodeGetParams, Gf as mergeDeliveryContext, Gg as parseByteSize, Gh as safeEqualSecret, Gi as loadSessionEntry, Gl as buildDeviceAuthPayload, Gm as resolveConfiguredSecretInputString, Gn as setSkillsRemoteRegistry, Gs as callGateway, Gu as enqueueCommandInLane, Ha as deliverOutboundPayloads, Hc as validateExecApprovalRequestParams, Hi as listAgentsForGateway, Hl as ConnectErrorDetailCodes, Hm as ensureGatewayStartupAuth, Hn as refreshRemoteBinsForConnectedNodes, Ho as parseAbsoluteTimeMs, Hp as GATEWAY_CLIENT_NAMES, I as resolveSubagentConfiguredModelSelection, Ic as validateDevicePairApproveParams, Ig as resolveConfigSnapshotHash, Ih as normalizeHostHeader, Ii as loadProviderUsageSummary, Il as validateWizardNextParams, Io as normalizeOptionalAgentId, Ip as isWebchatClient, Is as resolveSystemRunCommandRequest, It as resolveAssistantAvatarUrl, Jc as validateLogsTailParams, Jd as getTtsProvider, Jf as archiveFileOnDisk, Jh as enableTailscaleFunnel, Ji as resolveSessionModelRef, Jn as rejectNodePairing, Jp as isPidAlive, Ju as getTotalQueueSize, Kc as validateExecApprovalsNodeSetParams, Kf as normalizeSessionDeliveryFields, Kh as disableTailscaleFunnel, Ki as migrateAndPruneGatewaySessionStoreKey, Kl as buildDeviceAuthPayloadV3, Kn as approveNodePairing, Ku as getActiveTaskCount, L as resolveThinkingDefault, Lc as validateDevicePairListParams, Ld as SILENT_REPLY_TOKEN, Lh as pickPrimaryLanIPv4, Ll as validateWizardStartParams, Lo as normalizeOptionalSessionKey, Lp as normalizeMessageChannel, Lr as abortEmbeddedPiRun, Ls as buildSystemRunApprovalBinding, M as resolveConfiguredModelRef, Ma as resolveOutboundTarget, Mc as validateCronRunParams, Md as resolveUserTimezone, Mf as parseSessionThreadInfo, Mg as parseConfigJson5, Mh as isLoopbackHost, Ml as validateWakeParams, Mn as parseVerboseOverride, Mo as normalizeCronStaggerMs, Mp as isDeliverableMessageChannel, Mr as stopSubagentsForRequester, Mv as normalizeUsageDisplay, N as resolveDefaultModelForAgent, Na as resolveSessionDeliveryTarget, Nc as validateCronRunsParams, Ng as readBestEffortConfig, Ni as resolveNestedAgentLane, Nl as validateWebLoginStartParams, Nn as unbindThreadBindingsBySessionKey, No as resolveCronStaggerMs, Np as isGatewayCliClient, Ns as resolveSystemRunApprovalRequestContext, Nt as CONTROL_UI_AVATAR_PREFIX, Nv as normalizeVerboseLevel, O_ as resolveSubagentMaxConcurrent, Oc as validateConnectParams, Oh as createAuthRateLimiter, Ol as validateTalkConfigParams, Oo as writeRestartSentinel, Or as resolveSendPolicy, Ou as saveExecApprovals, Ov as normalizeFastMode, P as resolveHooksGmailModel, Pc as validateCronStatusParams, Pf as archiveRemovedSessionTranscripts, Pg as readConfigFileSnapshot, Ph as isTrustedProxyAddress, Pi as resolvePreferredSessionKeyForSessionIdMatches, Pl as validateWebLoginWaitParams, Po as resolveDefaultCronStaggerMs, Pp as isGatewayMessageChannel, Ps as resolveSystemRunApprovalRuntimeContext, Pt as buildControlUiAvatarUrl, Qc as validateNodeInvokeParams, Qd as resolveTtsAutoMode, Qf as readSessionMessages, Qg as isAvatarHttpUrl, Ql as loadOrCreateDeviceIdentity, Qn as verifyNodeToken, Qs as PAIRING_SCOPE, Qu as waitForActiveTasks, Rc as validateDevicePairRejectParams, Rg as writeConfigFile, Rh as resolveClientIp, Rl as validateWizardStatusParams, Ro as normalizeOptionalText$1, Rr as getActiveEmbeddedRunCount, Rs as matchSystemRunApprovalBinding, Rt as resolveExecApprovalCommandDisplay, S as getModelRefStatus, Sc as validateConfigGetParams, Sf as estimateBase64DecodedBytes, Sh as readGatewayPasswordEnv, Si as getAgentRunContext, Sl as validateSessionsResolveParams, Sn as getCliSessionId, So as consumeRestartSentinel, Sr as extractFileContentFromSource, Sv as DEFAULT_PROVIDER, Tc as validateConfigSchemaLookupResult, Th as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN, Ti as onInboundMessageEvent, Tl as validateSkillsInstallParams, Tm as cleanOldMedia, Tr as resolveInputFileLimits, U as withProgress, Uc as validateExecApprovalResolveParams, Uh as pickPrimaryTailnetIPv4, Ui as listSessionsFromStore, Ul as resolveAuthConnectErrorDetailCode, Um as mergeGatewayAuthConfig, Un as refreshRemoteNodeBins, Uo as normalizeLegacyDeliveryInput, Up as hasGatewayClientCap, Ur as resolveBootstrapWarningSignaturesSeen, Us as buildExecApprovalPendingReplyPayload, Uu as clearBootstrapSnapshot, Va as buildOutboundSessionContext, Vc as validateDeviceTokenRotateParams, Vh as resolveRequestClientIp, Vl as parseSessionLabel, Vn as recordRemoteNodeInfo, Vp as GATEWAY_CLIENT_MODES, Vs as toSystemRunApprovalMismatchError, Vu as listChannelAgentTools, Wc as validateExecApprovalsGetParams, Wd as resolveAgentIdentity, Wf as deliveryContextFromSession, Wh as pickPrimaryTailnetIPv6, Wi as loadCombinedSessionStoreForGateway, Wl as resolveDeviceAuthConnectErrorDetailCode, Wm as mergeGatewayTailscaleConfig, Wn as removeRemoteNodeInfo, Wp as normalizeGatewayClientMode, Wr as resolveFastModeState, Wt as resolveAgentAvatar, Wu as clearBootstrapSnapshotOnSessionRollover, Xa as applyPluginAutoEnable, Xc as validateNodeDescribeParams, Xd as isTtsProviderConfigured, Xf as capArrayByJsonBytes, Xl as loadGatewayTlsRuntime$1, Xn as requestNodePairing, Xp as readJsonFile, Xr as applyToolPolicyPipeline, Xs as ADMIN_SCOPE$2, Xt as createReplyPrefixOptions, Xu as resetAllLanes, Ya as resolveOutboundChannelPlugin, Yc as validateModelsListParams, Yd as isTtsEnabled, Yf as archiveSessionTranscripts, Yh as enableTailscaleServe, Yl as normalizeDeviceAuthScopes, Yn as renamePairedNode, Yp as createAsyncLock, Yr as resolveToolLoopDetectionConfig, Yu as markGatewayDraining, Zc as validateNodeEventParams, Zd as resolveTtsApiKey, Zf as cleanupArchivedSessionTranscripts, Zg as AVATAR_MAX_BYTES, Zh as getTailnetHostname, Zi as lookupContextTokens, Zl as deriveDeviceIdFromPublicKey, Zn as updatePairedNodeMetadata, Zp as writeJsonAtomic, Zr as buildDefaultToolPolicyPipelineSteps, Zs as APPROVALS_SCOPE, Zt as buildHistoryContextFromEntries, Zu as setCommandLaneConcurrency, _c as validateChatAbortParams, _g as fetchWithSsrFGuard, _h as isLocalDirectRequest, _l as validateSessionsDeleteParams, _o as markGatewaySigusr1RestartHandled, _p as resolveExplicitAgentSessionKey, ac as validateAgentIdentityParams, af as OPENAI_TTS_MODELS, ag as resolveToolProfilePolicy, ai as createOpenClawTools, al as validateNodePairVerifyParams, ao as normalizePollInput, ap as normalizeInputProvenance, ar as formatZonedTimestamp, as as applyBrowserProxyPaths, at as resolveAgentOutboundIdentity, bc as validateChatSendParams, bg as registerUnhandledRejectionHandler, bi as clearAgentRunContext, bl as validateSessionsPreviewParams, bn as resolveCronStorePath, bo as setPreRestartDeferralCheck, bp as snapshotSessionOrigin, br as DEFAULT_INPUT_IMAGE_MIMES, bt as handleReset, bu as normalizeExecApprovals, cc as validateAgentsCreateParams, cg as listCoreToolSections, cl as validateNodePendingEnqueueParams, cp as evaluateSessionFreshness, cs as clearSecretsRuntimeSnapshot, da as parseTimeoutMsWithFallback, dc as validateAgentsFilesListParams, di as listDescendantRunsForRequester, dl as validatePushTestParams, ds as resolveCommandSecretsFromActiveRuntimeSnapshot, du as setHeartbeatsEnabled, e_ as looksLikeAvatarPath, ea as sleepWithAbort, ec as WRITE_SCOPE, ef as resolveTtsPrefsPath, ei as resolveEffectiveToolPolicy, el as validateNodeListParams, ep as resolveSessionTranscriptCandidates, es as buildSafeExternalPrompt, eu as publicKeyRawBase64UrlFromPem, fc as validateAgentsFilesSetParams, fl as validateRequestFrame, fm as createBrowserRouteDispatcher, fo as resolveFailoverReasonFromError, fp as mergeSessionEntry, fs as GATEWAY_AUTH_SURFACE_PATHS, g_ as ensureControlUiAllowedOriginsForNonLoopbackBind, gc as validateChannelsStatusParams, gg as extractTextFromChatContent, gh as authorizeWsControlUiGatewayConnect, gi as resolveAgentTimeoutMs, gl as validateSessionsCompactParams, gn as getTotalPendingReplies, go as isGatewaySigusr1RestartExternallyAllowed, gp as resolveAgentMainSessionKey, gr as registerSkillsChangeListener, gs as isKnownSecretTargetId, h_ as applyLegacyMigrations, hc as validateChannelsLogoutParams, hh as authorizeHttpGatewayConnect, hl as validateSendParams, hn as createReplyDispatcher, ho as emitGatewayRestart, hp as canonicalizeMainSessionAlias, hr as getSkillsSnapshotVersion, hu as ensureExecApprovals, ia as normalizeGroupActivation, ic as formatValidationErrors, id as isDiagnosticsEnabled, if as textToSpeech, ig as mergeAlsoAllowPolicy, ii as runBeforeToolCallHook, il as validateNodePairRequestParams, io as resolveMessageChannelSelection, ip as stripInlineDirectiveTagsFromMessageForDisplay, ir as listAgentWorkspaceDirs, is as closeTrackedBrowserTabsForSessions, iu as isSystemEventContextChanged, jc as validateCronRemoveParams, jf as extractDeliveryInfo, jg as loadConfig, jh as isLoopbackAddress, jl as validateUpdateRunParams, jn as applyVerboseOverride, jo as normalizeCronJobPatch, jp as INTERNAL_MESSAGE_CHANNEL, jr as isAbortRequestText, ju as resolvePluginTools, jv as normalizeThinkLevel, kc as validateCronAddParams, kf as resolveAgentSessionDirs, kg as migrateLegacyConfig, kh as normalizeRateLimitClientIp, ki as readLatestAssistantReply, kl as validateTalkModeParams, ko as normalizeHttpWebhookUrl, kv as normalizeReasoningLevel, lc as validateAgentsDeleteParams, ld as resolveMemorySearchConfig, lg as resolveCoreToolProfiles, li as initSubagentRegistry, ll as validateNodeRenameParams, ls as getActiveSecretsRuntimeSnapshot, lu as requestHeartbeatNow, m_ as applyMergePatch, ma as resolveOutboundSessionRoute, mc as validateAgentsUpdateParams, md as getAcpSessionManager, mh as assertGatewayAuthConfigured, ml as validateSecretsResolveResult, mm as startBrowserControlServiceFromConfig, mn as dispatchInboundMessage, mo as deferGatewayRestartUntilIdle, mp as setSessionRuntimeModel, na as clearSessionQueues, nc as isNodeRoleMethod, nd as stopDiagnosticHeartbeat, nf as setTtsEnabled, ni as resolveSubagentToolPolicy, nl as validateNodePairListParams, no as maybeResolveIdLikeTarget, np as stripEnvelopeFromMessages, ns as getHookType, nt as buildTelegramExecApprovalButtons, nu as verifyDeviceSignature, oc as validateAgentParams, of as OPENAI_TTS_VOICES, og as PROFILE_OPTIONS, oi as countActiveDescendantRuns, ol as validateNodePendingAckParams, op as jsonUtf8Bytes, os as persistBrowserProxyFiles, pa as ensureOutboundSessionEntry, pc as validateAgentsListParams, pd as stripHeartbeatToken, pl as validateSecretsResolveParams, pm as createBrowserControlContext, po as consumeGatewaySigusr1RestartAuthorization, ps as evaluateGatewayAuthSurfaceStates, pu as DEFAULT_EXEC_APPROVAL_TIMEOUT_MS, qa as normalizeReplyPayloadsForDelivery, qc as validateExecApprovalsSetParams, qh as disableTailscaleServe, qi as resolveGatewaySessionStoreTarget, ql as normalizeDeviceMetadataForAuth, qn as listNodePairing, qp as cleanStaleLockFiles, qr as resolveCronStyleNow, rf as setTtsProvider, rg as collectExplicitAllowlist, rl as validateNodePairRejectParams, ro as resetDirectoryCache, rp as stripInlineDirectiveTagsForDisplay, rs as isExternalHookSession, rt as resolveExecApprovalSessionTarget, ru as enqueueSystemEvent, sc as validateAgentWaitParams, sl as validateNodePendingDrainParams, sn as sendTypingTelegram, so as runWithModelFallback, ss as activateSecretsRuntimeSnapshot, st as handleSlackHttpRequest, tc as authorizeOperatorScopesForMethod, td as startDiagnosticHeartbeat, tf as resolveTtsProviderOrder, ti as resolveGroupToolPolicy, tl as validateNodePairApproveParams, tp as stripEnvelopeFromMessage, ts as detectSuspiciousPatterns, uc as validateAgentsFilesGetParams, ud as getMachineDisplayName, ul as validatePollParams, up as resolveSessionResetPolicy, us as prepareSecretsRuntimeSnapshot, va as readChannelAllowFromStoreSync, vc as validateChatHistoryParams, vg as SsrFBlockedError, vh as resolveGatewayAuth, vi as normalizeSpawnedRunMetadata, vl as validateSessionsListParams, vm as movePathToTrash, vn as buildBareSessionResetPrompt, vo as scheduleGatewaySigusr1Restart, vp as resolveMainSessionKey, vu as mergeExecApprovalsSocketDefaults, wc as validateConfigSchemaLookupParams, wi as registerAgentRunContext, wl as validateSkillsBinsParams, wm as rawDataToString, wn as runCliAgent, wo as formatRestartSentinelMessage, wr as normalizeMimeList, wv as formatXHighModelHint, xc as validateConfigApplyParams, xi as emitAgentEvent, xl as validateSessionsResetParams, xn as saveCronStore, xo as triggerOpenClawRestart, xr as DEFAULT_INPUT_TIMEOUT_MS, xv as DEFAULT_MODEL, y as buildAllowedModelSet, yc as validateChatInjectParams, yi as resolveIngressWorkspaceOverrideForSpawnedRun, yl as validateSessionsPatchParams, yn as loadCronStore, yo as setGatewaySigusr1RestartPolicy, yp as resolveMainSessionKeyFromConfig, yr as DEFAULT_INPUT_IMAGE_MAX_BYTES, yv as normalizeSecretInput, z as loadOpenClawPlugins, z_ as getGlobalHookRunner, zc as validateDevicePairRemoveParams, zd as isSilentReplyText, zf as updateSessionStore, zg as validateConfigObjectWithPlugins, zh as resolveGatewayBindHost, zl as ErrorCodes, zn as getRemoteSkillEligibility, zo as normalizePayloadToSystemText, zp as GATEWAY_CLIENT_CAPS, zr as waitForActiveEmbeddedRuns, zs as missingSystemRunApprovalBinding, zt as sanitizeExecApprovalDisplayText } from "./auth-profiles-C_hWnnsG.js";
import { t as formatCliCommand } from "./command-format-xiq-peSB.js";
import { C as DEFAULT_MEMORY_FILENAME, D as ensureAgentWorkspace, E as DEFAULT_USER_FILENAME, M as resolveWorkspaceTemplateDir, S as DEFAULT_MEMORY_ALT_FILENAME, T as DEFAULT_TOOLS_FILENAME, _ as DEFAULT_AGENTS_FILENAME, a as resolveAgentDir, b as DEFAULT_HEARTBEAT_FILENAME, d as resolveAgentWorkspaceDir, f as resolveDefaultAgentId, h as resolveSessionAgentId, i as resolveAgentConfig, j as resolveDefaultAgentWorkspaceDir, k as isWorkspaceOnboardingCompleted, l as resolveAgentModelFallbacksOverride, n as listAgentEntries, r as listAgentIds, u as resolveAgentSkillsFilter, w as DEFAULT_SOUL_FILENAME, x as DEFAULT_IDENTITY_FILENAME, y as DEFAULT_BOOTSTRAP_FILENAME } from "./agent-scope-ciM67gYz.js";
import { C as isCronRunSessionKey, E as parseAgentSessionKey, S as isAcpSessionKey, T as isSubagentSessionKey, _ as normalizeAccountId$1, c as normalizeAgentId, g as DEFAULT_ACCOUNT_ID, h as toAgentStoreSessionKey, l as normalizeMainKey, m as toAgentRequestSessionKey, o as classifySessionKeyShape, r as buildAgentMainSessionKey, t as DEFAULT_AGENT_ID, u as resolveAgentIdFromSessionKey } from "./session-key-Cl1W5L6J.js";
import { E as isPlainObject, S as sleep, T as truncateUtf16Safe, n as clamp, s as ensureDir, v as resolveUserPath, x as shortenHomePath } from "./utils-hRMQE3lI.js";
import { a as sameFileIdentity, i as openVerifiedFileSync, m as matchesSkillFilter, n as openBoundaryFile, r as openBoundaryFileSync, u as isNotFoundPathError } from "./boundary-file-read-BoNLDurR.js";
import { i as logWarn, t as logDebug } from "./logger-Dz2ir4Xz.js";
import { n as runExec, t as runCommandWithTimeout } from "./exec-oLHRjz5-.js";
import { t as resolveOpenClawPackageRoot } from "./openclaw-root-ojNYMqcE.js";
import { a as hasConfiguredSecretInput } from "./types.secrets-BEA4gMCN.js";
import "./github-copilot-token-BlHBUXZs.js";
import { C as createInternalHookEvent, S as clearInternalHooks, T as triggerInternalHook, b as canonicalizePathVariant, h as createEmptyPluginRegistry, t as CHANNEL_IDS, u as getActivePluginRegistry, v as PROTECTED_PLUGIN_ROUTE_PREFIXES, w as registerInternalHook, y as canonicalizePathForSecurity } from "./registry-BGvHaTSg.js";
import { T as isTestDefaultMemorySlotDisabled, i as loadWorkspaceSkillEntries, r as buildWorkspaceSkillSnapshot } from "./skills-WwJ-cgxf.js";
import { f as hasBinary } from "./frontmatter-COEYX5xL.js";
import "./env-overrides-eH6HaD80.js";
import { n as resolveRuntimeServiceVersion, t as VERSION } from "./version-BlUhcaFh.js";
import { i as parseDurationMs, r as resolveMemoryBackendConfig, t as getMemorySearchManager } from "./search-manager-OoPMhEwb.js";
import { U as resolveWhatsAppAccount, ct as normalizeWhatsAppTarget, g as buildChannelAccountBindings, n as listChannelPlugins, r as normalizeChannelId, t as getChannelPlugin, ut as resolveChannelDefaultAccountId } from "./plugins-CVp4JUox.js";
import { B as readLocalFileSafely, H as writeFileWithinRoot, L as openFileWithinRoot, N as SafeOpenError, W as detectMime } from "./query-expansion-BiHEyx7G.js";
import { a as testRegexWithBoundedInput, i as compileSafeRegex } from "./redact-BWjgs076.js";
import { o as isErrno, r as formatErrorMessage } from "./errors-D5INWvGS.js";
import "./fetch-D5SuoyGB.js";
import { n as assertNoPathAliasEscape } from "./path-alias-guards-BWsWlD0g.js";
import { l as ensurePortAvailable, m as formatPortDiagnostics, o as cleanStaleGatewayProcessesSync, u as inspectPortUsage } from "./cmd-argv-DWNHU-dd.js";
import "./delivery-queue-Dqzoxn1f.js";
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent, i as resolveSessionFilePathOptions, l as resolveStorePath, r as resolveSessionFilePath } from "./paths-DPIeb3JQ.js";
import { c as formatUsd, d as deriveSessionTotalTokens, f as hasNonzeroUsage, i as loadSessionUsageTimeSeries, n as loadCostUsageSummary, r as loadSessionCostSummary, s as formatTokenCount, t as discoverAllSessions } from "./session-cost-usage-hVTPrj3b.js";
import { t as getChannelActivity } from "./channel-activity-CEmsyqOm.js";
...
import { t as buildWorkspaceSkillStatus } from "./skills-status-Bb1AvbkE.js";
import { n as sendMessageWhatsApp } from "./outbound-YYR63q9e.js";
import "./brazil-jid-resolver-B1MenYJ2.js";
import { i as onHeartbeatEvent, r as getLastHeartbeatEvent, t as resolveHeartbeatVisibility } from "./heartbeat-visibility-Cw6M8flb.js";
import { a as HEALTH_REFRESH_INTERVAL_MS, c as MAX_PREAUTH_PAYLOAD_BYTES, d as getMaxChatHistoryMessagesBytes, i as DEDUPE_TTL_MS, l as TICK_INTERVAL_MS, n as gatewayEventBus, o as MAX_BUFFERED_BYTES, r as DEDUPE_MAX, s as MAX_PAYLOAD_BYTES, t as createGatewayBroadcaster, u as getHandshakeTimeoutMs } from "./server-broadcast-BU8Hp9t8.js";
import { a as setGatewayWsLogStyle, n as logWs, t as formatForLog } from "./ws-log-DGQPtxik.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-CL3ZzR2b.js";
import { n as DEFAULT_GATEWAY_HTTP_TOOL_DENY } from "./dangerous-tools-CcL6pQb-.js";
import { t as readSecretFromFile } from "./secret-file-D6ZIfIe6.js";
import { n as inheritOptionFromParent } from "./command-options-BdArMmsJ.js";
import { t as WizardCancelledError } from "./prompts-D1_edbkK.js";
import { a as pruneAgentConfig, i as loadAgentIdentity, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-fMkHo5i7.js";
import { t as isWithinDir } from "./path-safety-DnyvZF1s.js";
import "./install-safe-path-quUPwVHa.js";
import "./skill-scanner-f8IdsT0k.js";
import { n as formatConfigIssueLines } from "./issue-format-D2kw5D0V.js";
import { t as buildChannelAccountSnapshot } from "./status-B6hNDer4.js";
import "./channels-status-issues-JoMibbiV.js";
import { n as verifyDeviceBootstrapToken } from "./device-bootstrap-CFirX3zT.js";
import { a as buildBaseHints, i as applySensitiveHints, n as redactConfigSnapshot, o as mapSensitivePaths, r as restoreRedactedValues, s as applyDerivedTags, t as redactConfigObject } from "./redact-snapshot-bqUdewIy.js";
...
import { p as scheduleDetachedLaunchdRestartHandoff } from "./launchd-B710b1h_.js";
import { c as isGatewayArgv, l as parseProcCmdline } from "./service-BVqHJOKW.js";
import "./systemd-Wxr_n5sP.js";
import "./lifecycle-core-xZLDOEwt.js";
import "./systemd-hints-0Dxh4CDT.js";
import { t as parsePort$1 } from "./parse-port-BHMszcoq.js";
import { n as addGatewayServiceCommands } from "./daemon-cli-B82ecl6U.js";
import { r as probeGateway } from "./probe-auth-PRgXvF0-.js";
import "./diagnostics-BPlcXCmS.js";
import "./inspect-Cbac-DZO.js";
import { a as rejectDevicePairing, c as revokeDeviceToken, d as updatePairedDeviceMetadata, f as verifyDeviceToken, i as listDevicePairing, l as rotateDeviceToken, n as ensureDeviceToken, o as removePairedDevice, p as roleScopesAllow, r as getPairedDevice, s as requestDevicePairing, t as approveDevicePairing, u as summarizeDeviceTokens } from "./device-pairing-CzXbuLAG.js";
import "./table-DmABQmtM.js";
import { n as resolveWideAreaDiscoveryDomain, r as writeWideAreaGatewayZone } from "./widearea-dns-BHD1ra_z.js";
import { i as toOptionString, n as extractGatewayMiskeys, r as maybeExplainGatewayServiceStop, t as describeUnknownError } from "./shared-gDzb3NsK.js";
import { t as discoverGatewayBeacons } from "./bonjour-discovery-52l35S1v.js";
import { i as pickGatewaySelfPresence, r as getStatusSummary } from "./status-BEwADrQw.js";
import { a as styleHealthChannelLine, c as startHeartbeatRunner, n as getHealthSnapshot, s as runHeartbeatOnce, t as formatHealthChannelLines } from "./health-SAgL9NoO.js";
import { n as createDefaultDeps, r as createOutboundSendDeps$1, t as createOutboundSendDeps } from "./outbound-send-deps-DPT-bWsd.js";
import { a as resolveControlUiRootOverrideSync, n as isPackageProvenControlUiRootSync, o as resolveControlUiRootSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-BZkzP3ll.js";
import { m as normalizeUpdateChannel, n as checkUpdateStatus, o as resolveNpmChannelTag, r as compareSemverStrings } from "./channel-account-context-Cyv8kGJo.js";
import "./onboarding.secret-input-CRGOVQkN.js";
import { t as runOnboardingWizard } from "./onboarding-D9oN-fa6.js";
import { _ as buildGogWatchStartArgs, g as buildGogWatchServeArgs, i as ensureTailscaleEndpoint, w as resolveGmailHookRuntimeConfig } from "./gmail-setup-utils-Y_F3EECE.js";
import { f as normalizeStoredCronJobs, h as computePreviousRunAtMs, m as computeNextRunAtMs, p as coerceFiniteScheduleNumber, t as runGatewayUpdate } from "./update-runner-ChcBzfu6.js";
import { a as resolveAgentOutboundTarget, i as resolveAgentDeliveryPlan, n as agentCommandFromIngress } from "./agent-CLLJVIfQ.js";
import { a as resolveApnsAuthConfigFromEnv, c as shouldClearStoredApnsRegistration, d as extractAudioAttachments, f as parseMessageWithAttachments, l as resolveApnsRelayConfigFromEnv, n as loadApnsRegistration, o as sendApnsAlert, r as normalizeApnsEnvironment, s as sendApnsBackgroundWake, t as clearApnsRegistrationIfCurrent, u as normalizeRpcAttachmentsToChatAttachments } from "./push-apns-BkQTrTDj.js";
import { n as isNodeCommandAllowed, r as resolveNodeCommandAllowlist } from "./node-command-policy-6IVDCyMj.js";
import { _ as resolveHookTargetAgentId, a as getHookAgentPolicyError, b as resolveFunctionModuleExport, c as normalizeAgentPayload, d as normalizeWakePayload, f as readJsonBody, g as resolveHookSessionKey, h as resolveHookIdempotencyKey, i as extractHookToken, l as normalizeHookDispatchSessionKey, m as resolveHookDeliver, n as collectEnabledInsecureOrDangerousFlags, o as getHookChannelError, p as resolveHookChannel, s as isHookAgentAllowed, u as normalizeHookHeaders, v as resolveHooksConfig, y as applyHookMappings } from "./audit-BrwXiRQb.js";
import "./node-service-Bm8ZOKgI.js";
import "./status.update-yjTN2Obz.js";
import { t as installSkill } from "./skills-install-C0vZB3_-.js";
import { i as shouldIncludeHook, r as resolveHookConfig, t as loadWorkspaceHookEntries } from "./workspace-3UBcnKE_.js";
import { n as forceFreePortAndWait, r as waitForPortBindable } from "./ports-B9FQJQs6.js";
...
function startChannelHealthMonitor(deps) {
	...
	if (abortSignal?.aborted) stopped = true;
		...
		log$6.info?.(`started (interval: ${Math.round(checkIntervalMs / 1e3)}s, startup-grace: ${Math.round(timing.monitorStartupGraceMs / 1e3)}s, channel-connect-grace: ${Math.round(timing.channelConnectGraceMs / 1e3)}s)`);
	}
	return { stop };
}
//#endregion
...
const log$5 = createSubsystemLogger("gateway/server-chat");
const reasoningDebugEnabled$1 = process.env.OPENCLAW_DEBUG_REASONING === "1";
...
function createAgentEventHandler({ broadcast, broadcastToConnIds, nodeSendToSession, agentRunSeq, chatRunState, resolveSessionKeyForRun, clearAgentRunContext, toolEventRecipients }) {
	const RETRYABLE_LIFECYCLE_ERROR_RE = /\b(?:429|rate\s*limit(?:ed)?|too\s*many\s*requests|temporarily\s*overloaded|overloaded)\b/i;
	...
	const emitChatDelta = (sessionKey, clientRunId, sourceRunId, seq, text, delta) => {
		...
		const now = Date.now();
		if (now - (chatRunState.deltaSentAt.get(clientRunId) ?? 0) < 50) return;
	...
	const emitChatFinal = (sessionKey, clientRunId, sourceRunId, seq, jobState, error, stopReason) => {
		...
		if (jobState === "done") {
			...
			nodeSendToSession(sessionKey, "chat", payload);
			if (getAgentRunContext(clientRunId)?.mirror && text) try {
				...
				if (keyParts.length >= 5 && keyParts[0] === "agent") {
					...
					if (channel === "whatsapp" && peerId) sendMessageWhatsApp(peerId, text, { verbose: false }).then(() => console.log(`[mirror] sent to ${channel}:${peerId}`)).catch((err) => console.warn(`[mirror] failed: ${String(err)}`));
				}
			} catch (mirrorErr) {
	...
	return (evt) => {
		...
		if (isToolEvent) {
			if ((typeof evt.data?.phase === "string" ? evt.data.phase : "") === "start" && sessionKey && !isAborted) {
				flushBufferedChatDeltaIfNeeded(sessionKey, clientRunId, evt.runId, evt.seq);
				chatRunState.buffers.delete(clientRunId);
				chatRunState.deltaLastBroadcastLen.delete(clientRunId);
			}
			const recipients = toolEventRecipients.get(evt.runId);
			if (recipients && recipients.size > 0) _broadcastToConnIds("agent", toolPayload, recipients);
			broadcast("agent", toolPayload, { dropIfSlow: true });
		} else broadcast("agent", agentPayload);
		if (reasoningDebugEnabled$1 && evt.stream === "thinking") {
			const rawDeltaLen = typeof evt.data?.rawDelta === "string" ? evt.data.rawDelta.length : typeof evt.data?.delta === "string" ? evt.data.delta.length : 0;
			log$5.info(`[reasoning:gateway] runId=${evt.runId} clientRunId=${clientRunId} sessionKey=${sessionKey ?? "NONE"} visible=${String(getAgentRunContext(evt.runId)?.isControlUiVisible ?? true)} rawDeltaLen=${rawDeltaLen}`);
		}
		const lifecyclePhase = evt.stream === "lifecycle" && typeof evt.data?.phase === "string" ? evt.data.phase : null;
		const lifecycleErrorText = lifecyclePhase === "error" && typeof evt.data?.error === "string" ? evt.data.error : "";
		const isRetryableLifecycleError = lifecyclePhase === "error" && RETRYABLE_LIFECYCLE_ERROR_RE.test(lifecycleErrorText);
		if (sessionKey) {
			...
			else if (!isAborted && (lifecyclePhase === "end" || lifecyclePhase === "error" && !isRetryableLifecycleError)) {
...
function createGatewayCloseHandler(params) {
	return async (opts) => {
		...
		if (params.inboundMessageUnsub) try {
...
function resolveSenderIsOwnerFromClient(client) {
	return (Array.isArray(client?.connect?.scopes) ? client.connect.scopes : []).includes(ADMIN_SCOPE$2);
}
...
function resolveChatAbortRequester(client) {
	...
	return {
		...
		isAdmin: scopes.includes(ADMIN_SCOPE$2)
	};
}
...
const chatHandlers = {
	"chat.history": async ({ params, respond, context }) => {
		...
		const threadHistoryIndices = /* @__PURE__ */ new Set();
		const senderMetaByIndex = /* @__PURE__ */ new Map();
		const chatHistoryByIndex = /* @__PURE__ */ new Map();
		for (let i = 0; i < sliced.length; i += 1) {
			const msg = sliced[i];
			if (msg.role !== "user") continue;
			const text = typeof msg.content === "string" ? msg.content : Array.isArray(msg.content) ? msg.content.filter((b) => b.type === "text" && typeof b.text === "string").map((b) => b.text).join("") : "";
			if (!text) continue;
			if (text.trimStart().startsWith("[Thread history - for context]")) threadHistoryIndices.add(i);
			const chatHistMatch = text.match(/Chat history since last reply \(untrusted, for context\):\s*```json\s*(\[[\s\S]*?\])\s*```/);
			if (chatHistMatch) try {
				const parsed = JSON.parse(chatHistMatch[1]).filter((e) => typeof e.sender === "string" && typeof e.body === "string").map((e) => ({
					sender: e.sender,
			...
			try {
				...
				if (convMatch) try {
					isGroupChat = JSON.parse(convMatch[1]).is_group_chat === true;
				} catch {}
				senderMetaByIndex.set(i, {
					name,
					id,
					isGroupChat
				});
		...
		const audioUrlByIndex = /* @__PURE__ */ new Map();
		{
			let pendingAudioUrl;
			for (let i = 0; i < sanitized.length; i += 1) {
				...
				if (role === "toolResult" && typeof details?.audioUrl === "string") pendingAudioUrl = details.audioUrl;
				else if (role === "assistant") {
					const stopReason = msg.stopReason;
					if (pendingAudioUrl && stopReason !== "toolUse") {
						audioUrlByIndex.set(i, pendingAudioUrl);
						pendingAudioUrl = void 0;
					}
				} else if (role === "user") pendingAudioUrl = void 0;
			}
		}
		const imageUrlByIndex = /* @__PURE__ */ new Map();
		{
			let pendingImageUrl;
			for (let i = 0; i < sanitized.length; i += 1) {
				const msg = sanitized[i];
				const role = msg.role;
				const details = msg.details;
				if (role === "toolResult" && typeof details?.imageUrl === "string") pendingImageUrl = details.imageUrl;
				else if (role === "assistant") {
					const stopReason = msg.stopReason;
					if (pendingImageUrl && stopReason !== "toolUse") {
						imageUrlByIndex.set(i, pendingImageUrl);
						pendingImageUrl = void 0;
					}
				} else if (role === "user") pendingImageUrl = void 0;
			}
		}
		const normalized = sanitizeChatHistoryMessages(sanitized);
		for (const [idx, meta] of senderMetaByIndex) if (idx < normalized.length) normalized[idx].senderMeta = meta;
		for (const [idx, entries] of chatHistoryByIndex) if (idx < normalized.length) normalized[idx].chatHistory = entries;
		for (const idx of threadHistoryIndices) if (idx < normalized.length) {
			const raw = sliced[idx];
			const rawText = typeof raw.content === "string" ? raw.content : Array.isArray(raw.content) ? raw.content.filter((b) => b.type === "text" && typeof b.text === "string").map((b) => b.text).join("") : "";
			normalized[idx].threadHistoryRaw = rawText;
		}
		for (const [idx, url] of audioUrlByIndex) if (idx < normalized.length) normalized[idx].audioUrl = url;
		for (const [idx, url] of imageUrlByIndex) if (idx < normalized.length) normalized[idx].imageUrl = url;
	...
	"chat.send": async ({ params, respond, context, client }) => {
		...
		if (normalizedAttachments.length > 0) try {
			...
			for (const image of parsedImages) try {
				image.mediaUrl = `/media/${(await saveMediaBuffer(Buffer.from(image.data, "base64"), image.mimeType, "inbound", 5e6)).id}`;
			} catch (err) {
			...
			for (const item of audio) {
				const saved = await saveMediaBuffer(Buffer.from(item.data, "base64"), item.mimeType, "inbound", 2e7, item.fileName);
		...
		try {
			...
			const ctx = {
				...
				MediaPaths: parsedAudioPaths.length > 0 ? parsedAudioPaths : void 0,
				MediaUrls: parsedAudioPaths.length > 0 ? parsedAudioPaths : void 0
			};
			...
			dispatchInboundMessage({
				...
				if (!agentRunStarted) {
					...
					if (p.mirror && combinedReply) try {
						const keyParts = p.sessionKey.split(":").filter(Boolean);
						if (keyParts.length >= 5 && keyParts[0] === "agent") {
							const channel = keyParts[2];
							const peerId = keyParts.slice(4).join(":");
							if (channel === "whatsapp" && peerId) import("./outbound-YYR63q9e.js").then((n) => n.t).then(({ sendMessageWhatsApp }) => {
								sendMessageWhatsApp(peerId, combinedReply, { verbose: false }).then(() => context.logGateway.info(`[mirror] sent to ${channel}:${peerId}`)).catch((err) => context.logGateway.warn(`[mirror] failed: ${String(err)}`));
							});
						}
					} catch (mirrorErr) {
...
const healthHandlers = {
	...
	status: async ({ respond, client }) => {
		respond(true, await getStatusSummary({ includeSensitive: (Array.isArray(client?.connect?.scopes) ? client.connect.scopes : []).includes(ADMIN_SCOPE$1) }), void 0);
	}
};
//#endregion
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-BSHIo6UL.js");
...
const usageHandlers = {
	...
	"sessions.usage.logs": async ({ respond, params }) => {
		...
		if (!resolved) return;
		const { config, entry, agentId, sessionId, sessionFile } = resolved;
		const { loadSessionLogs } = await import("./session-cost-usage-hVTPrj3b.js").then((n) => n.a);
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./server-0a-xX8dS.js");
...
//#endregion
//#region src/gateway/server-sse.ts
const log$3 = createSubsystemLogger("gateway/sse");
const reasoningDebugEnabled = process.env.OPENCLAW_DEBUG_REASONING === "1";
function tryFlush(res) {
	const r = res;
...
function emitTextStart(res, counter) {
...
function emitTextDelta(res, id, delta) {
	sseWrite(res, {
		type: "text-delta",
		id,
		delta
...
function emitTextEnd(res, id) {
	sseWrite(res, {
		type: "text-end",
		id
	});
}
function emitReasoningStart(res, counter) {
...
function emitReasoningDelta(res, id, delta) {
	sseWrite(res, {
...
function emitReasoningEnd(res, id) {
	sseWrite(res, {
		type: "reasoning-end",
		id
	});
...
function handleSseStream(req, res) {
	...
	if (url.pathname !== "/api/sse/stream") return false;
	...
	if (persistentMode) sseWrite(res, {
		type: "connected",
		sessionKey
	});
	else sseWrite(res, {
	...
	const pingInterval = setInterval(() => ssePing(res), 15e3);
	const timeout = persistentMode ? null : setTimeout(() => {
		if (!finished) {
			sseWrite(res, {
				type: "error",
				errorText: "Stream timeout (5 minutes)"
			});
			sseEnd(res);
			cleanup();
		}
	...
	let sseEventCount = 0;
	function cleanup() {
		const durationSec = ((Date.now() - sseOpenedAt) / 1e3).toFixed(1);
		console.warn(`[sse] connection closed: sessionKey=${sessionKey} duration=${durationSec}s events=${sseEventCount} runActive=${currentRunId !== null} lastTextLen=${lastTextLen}`);
		finished = true;
	...
	*/
	...
	function onChatEvent(payload) {
		...
		if (payload.state === "delta") {
			...
			if (!content) return;
			for (const block of content) if (block.type === "text" && block.text) {
				const fullText = block.text;
				if (fullText.length <= lastTextLen) continue;
				const newText = fullText.slice(lastTextLen);
				lastTextLen = fullText.length;
				closeActiveReasoning();
				if (!activeTextId) activeTextId = emitTextStart(res, textCounter);
			...
			sseWrite(res, {
				type: "error",
				errorText: payload.errorMessage ?? "Unknown error"
			});
			handleRunEnd();
	...
	function onAgentEvent(payload) {
		...
		if (agentSessionKey !== sessionKey) return;
		if (persistentMode && payload.runId && payload.runId !== currentRunId) {
			currentRunId = payload.runId;
			sseWrite(res, {
				type: "start",
		...
		if (payload.stream === "thinking") {
			const delta = typeof payload.data?.rawDelta === "string" ? payload.data.rawDelta : typeof payload.data?.delta === "string" ? payload.data.delta : null;
			const fullText = typeof payload.data?.rawText === "string" ? payload.data.rawText : typeof payload.data?.text === "string" ? payload.data.text : null;
			const newContent = delta ? delta : fullText && fullText.length > lastReasoningLen ? fullText.slice(lastReasoningLen) : null;
			if (reasoningDebugEnabled) log$3.info(`[reasoning:sse] runId=${payload.runId} sessionKey=${agentSessionKey ?? "NONE"} fullLen=${fullText?.length ?? 0} deltaLen=${delta?.length ?? 0} emitLen=${newContent?.length ?? 0} active=${activeReasoningId ? "yes" : "no"} lastReasoningLen=${lastReasoningLen}`);
			if (newContent) {
				closeActiveText();
				lastTextLen = 0;
				if (!activeReasoningId) activeReasoningId = emitReasoningStart(res, reasoningCounter);
				if (fullText) lastReasoningLen = fullText.length;
				emitReasoningDelta(res, activeReasoningId, newContent);
			}
		}
		if (payload.stream === "tool") {
			const phase = payload.data?.phase;
			const toolName = payload.data?.tool ?? payload.data?.name ?? "tool";
			const toolCallId = payload.data?.toolCallId ?? payload.data?.id ?? `tool_${Date.now()}`;
			if (phase === "start") {
				closeActiveText();
				closeActiveReasoning();
				lastTextLen = 0;
			...
			} else if (phase === "result" || phase === "end") sseWrite(res, {
	...
	const normalizeSessionKey = (key) => key.replace(/:direct:/, ":dm:");
	const onInboundMessage = (payload) => {
...
async function handleToolsInvokeHttpRequest(req, res, opts) {
	...
	const subagentFiltered = applyToolPolicyPipeline({
		tools: [...listChannelAgentTools({ cfg }), ...createOpenClawTools({
		...
		try {
			...
			const requestStages = [
				...
				},
				{
					name: "media",
					run: async () => {
						if (req.method !== "GET" || !requestPath.startsWith("/media/")) return false;
						...
						try {
							...
							for (const entry of entries) if (entry.startsWith("tts-")) candidatePaths.push(pathMod.join(ttsBaseDir, entry, filename));
						} catch {}
						candidatePaths.push(pathMod.join(osMod.homedir(), ".openclaw", "media", filename));
						candidatePaths.push(pathMod.join(osMod.homedir(), ".openclaw", "media", "inbound", filename));
						candidatePaths.push(pathMod.join("/root/clawd", filename));
						for (const filePath of candidatePaths) try {
...
async function startGatewayServer(port = 18789, opts = {}) {
	...
	if (!minimalTestGateway) (async () => {
		const { recoverPendingDeliveries } = await import("./delivery-queue-Dqzoxn1f.js").then((n) => n.n);
		const { deliverOutboundPayloads } = await import("./auth-profiles-C_hWnnsG.js").then((n) => n.Ua);

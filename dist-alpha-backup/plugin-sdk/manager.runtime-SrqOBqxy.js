...
import { W as formatCliCommand } from "./channel-config-helpers-DXyHWBVJ.js";
import { $i as resolveSessionKey, An as deriveSessionTotalTokens, As as DEFAULT_PROVIDER, Br as getAcpSessionManager, Bt as clearSessionAuthProfileOverride, C as resolveThinkingDefault, Ci as createMediaAttachmentCache, Cn as registerAgentRunContext, Ct as formatMention, Dn as AGENT_LANE_NESTED, Dr as runWithModelFallback, Ei as runCapability, En as resolveAcpDispatchPolicyError, Fo as isDeliverableMessageChannel, Gi as emitSessionTranscriptUpdate, In as normalizeReplyPayload, Io as isGatewayMessageChannel, It as getCliSessionId, J as isDangerousNameMatchingEnabled, Ki as loadSessionStore, Lo as isInternalMessageChannel, Lt as setCliSessionId, Mn as resolveContextTokensForModel, Ni as loadModelCatalog, Nr as clearBootstrapSnapshotOnSessionRollover, On as AGENT_LANE_SUBAGENT, Or as FailoverError, Po as INTERNAL_MESSAGE_CHANNEL, Qi as normalizeAccountId, Ro as normalizeMessageChannel, Rt as runCliAgent, S as resolveDefaultModelForAgent, Si as buildProviderRegistry, Sn as emitAgentEvent, T as resolveCommandSecretRefsViaGateway, Tn as resolveAcpAgentPolicyError, Tr as resolveMessageChannelSelection, Ts as ensureAuthProfileStore, Vt as applyVerboseOverride, Wi as resolveSessionTranscriptFile, Wt as getRemoteSkillEligibility, Xn as resolveAgentRoute, Yi as updateSessionStore, Zt as getSkillsSnapshotVersion, _ as isCliProvider, _r as buildOutboundSessionContext, a as readConfigFileSnapshotForWrite, aa as setSessionRuntimeModel, b as normalizeProviderId, bn as normalizeSpawnedRunMetadata, br as normalizeOutboundPayloads, ca as normalizeChannelId, cn as resolveBootstrapWarningSignaturesSeen, dr as formatDiscordUserTag, ea as evaluateSessionFreshness, g as buildAllowedModelSet, hi as parseTtsDirectives, hs as buildWorkspaceSkillSnapshot, i as loadConfig, ia as mergeSessionEntry, jn as hasNonzeroUsage, kn as applyModelOverrideToSessionEntry, ks as DEFAULT_MODEL, mi as textToSpeech, na as resolveSessionResetPolicy, ni as isSilentReplyPrefixText, o as setRuntimeConfigSnapshot, oa as resolveExplicitAgentSessionKey, on as runEmbeddedPiAgent, or as resolveOutboundTarget, pi as resolveTtsConfig, ra as resolveSessionResetType, ri as isSilentReplyText, sa as getChannelPlugin, sn as prepareSessionManagerForRun, sr as resolveSessionDeliveryTarget, ss as formatErrorMessage, ta as resolveChannelResetConfig, tn as resolveSendPolicy, ur as resolveDiscordOwnerAccess, v as modelKey, vn as resolveAgentTimeoutMs, vr as deliverOutboundPayloads, w as getAgentRuntimeCommandSecretTargetIds, wi as normalizeMediaAttachments, wn as resolveAcpSessionCwd, x as resolveConfiguredModelRef, xn as clearAgentRunContext, xr as normalizeOutboundPayloadsForJson, y as normalizeModelRef, yn as formatAgentInternalEventsForPrompt, yr as formatOutboundPayloadLog, zo as resolveMessageChannel } from "./thread-bindings-0Uc4GeBT.js";
...
import { c as normalizeThinkLevel, n as formatXHighModelHint, p as supportsXHighThinking, t as formatThinkingLevels, u as normalizeVerboseLevel } from "./thinking-CSUA5PYQ.js";
import { At as ensureAgentWorkspace, R as resolveStorePath, bt as resolveSessionAgentId, ft as resolveAgentDir, gt as resolveAgentWorkspaceDir, ht as resolveAgentSkillsFilter, ut as listAgentIds, vt as resolveEffectiveModelFallbacks } from "./query-expansion-s2jldUV4.js";
...
import { c as toAcpRuntimeError } from "./registry-SHl7cuYc.js";
...
function loadWhatsAppSenderRuntime() {
	whatsappSenderRuntimePromise ??= import("./deps-send-whatsapp.runtime-Dtfi1fRA.js");
	return whatsappSenderRuntimePromise;
}
function loadTelegramSenderRuntime() {
	telegramSenderRuntimePromise ??= import("./deps-send-telegram.runtime-XpqD0fa8.js");
	return telegramSenderRuntimePromise;
}
function loadDiscordSenderRuntime() {
	discordSenderRuntimePromise ??= import("./deps-send-discord.runtime-Bxay4mIh.js");
	return discordSenderRuntimePromise;
}
function loadSlackSenderRuntime() {
	slackSenderRuntimePromise ??= import("./deps-send-slack.runtime-BrXKkmYj.js");
	return slackSenderRuntimePromise;
}
function loadSignalSenderRuntime() {
	signalSenderRuntimePromise ??= import("./deps-send-signal.runtime-Dpgig2ue.js");
	return signalSenderRuntimePromise;
}
function loadIMessageSenderRuntime() {
	imessageSenderRuntimePromise ??= import("./deps-send-imessage.runtime-H0qezOeD.js");

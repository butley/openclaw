...
import { T as readWebSelfId, W as formatCliCommand, _ as resolveWhatsAppMediaMaxBytes, h as resolveWhatsAppAccount, y as getWebAuthAgeMs } from "./channel-config-helpers-DXyHWBVJ.js";
import { $r as loadWebMedia, Ai as registerUnhandledRejectionHandler, Ao as resolveChannelGroupRequireMention, At as resolveInboundDebounceMs, Dt as dispatchReplyWithBufferedBlockDispatcher, Fn as createDedupeCache, Ft as getReplyFromConfig, G as issuePairingChallenge, Hn as readChannelAllowFromStoreSync, Ji as updateLastRoute, Jn as buildAgentSessionKey, K as resolveMentionGating, Ki as loadSessionStore, Kn as formatLocationText, M as resolveInboundSessionEnvelopeContext, Mi as getAgentScopedMediaLocalRoots, Mr as enqueueSystemEvent, Nn as computeBackoff, No as resolveGroupSessionKey, O as setActiveWebListener, Pn as sleepWithAbort, Rn as normalizeGroupActivation, Un as upsertChannelPairingRequest, W as createConnectedChannelStatusPatch, Xn as resolveAgentRoute, Yn as deriveLastRoutePolicy, Z as createReplyPrefixOptions, Zn as resolveInboundLastRouteSessionKey, _t as resolvePinnedMainDmOwnerFromAllowlist, ai as resolveChunkMode, an as normalizeMentionText, bs as normalizeChatChannelId, ct as recordPendingHistoryEntryIfEnabled, di as resolveIdentityNamePrefix, dt as readStoreAllowFromForDmPolicy, ei as resolveMarkdownTableMode, en as finalizeInboundContext, fi as resolveMessagePrefix, ht as resolveDmGroupAccessWithLists, i as loadConfig, ii as chunkMarkdownTextWithMode, in as buildMentionRegexes, jr as formatDurationPrecise, jt as formatInboundEnvelope, ko as resolveChannelGroupPolicy, kt as createInboundDebouncer, mt as resolveDmGroupAccessWithCommandGate, nn as hasControlCommand, nt as buildHistoryContextFromEntries, oi as resolveTextChunkLimit, qi as recordSessionMetaFromInbound, qn as toLocationContext, rn as shouldComputeCommandAuthorized, rs as saveMediaBuffer, wt as convertMarkdownTables, zn as parseActivationCommand } from "./thread-bindings-0Uc4GeBT.js";
import { t as getChildLogger } from "./logger-C9fkmDdb.js";
import { i as logVerbose, s as shouldLogVerbose } from "./globals-DMfGJ_36.js";
import { d as normalizeE164, l as isSelfChatMode, m as resolveJidToE164, n as clamp, u as jidToE164, y as sleep } from "./utils-DfdxfpoM.js";
import { a as defaultRuntime, t as createSubsystemLogger } from "./subsystem-CfLo2GBS.js";
import { s as normalizeStreamLevel } from "./thinking-CSUA5PYQ.js";
import { R as resolveStorePath } from "./query-expansion-s2jldUV4.js";
import { t as getDefaultRedactPatterns } from "./redact-BuzJ8kUo.js";
...
import { r as shouldAckReactionForWhatsApp } from "./ack-reactions-D4S_h6SS.js";
import { n as recordChannelActivity } from "./channel-activity-DJJMFNxS.js";
import { i as markdownToWhatsApp, r as sendReactionWhatsApp } from "./outbound-Bk_cs4FT.js";
import { i as waitForWaConnection, n as formatError, r as getStatusCode, t as createWaSocket } from "./session-BrkbCS71.js";
import { i as noteContactName, r as loadContactNameCache, t as createWebSendApi } from "./send-api-BL2Ww_n_.js";
...
async function monitorWebInbox(options) {
	...
	const enqueueInboundMessage = async (msg, inbound, enriched) => {
		...
		const reply = async (text) => {
			const { processOutboundMentions } = await import("./send-api-BL2Ww_n_.js").then((n) => n.n);

...
import { h as pathExists, y as resolveUserPath } from "./utils-B1xPTYn-.js";
import { Dt as openUrl, Ft as waitForGatewayReachable, jt as resolveControlUiLinks, kt as probeGatewayReachable, xt as formatControlUiSshHint, yt as detectBrowserOpenSupport } from "./reply-BRIrPGWy.js";
import { y as DEFAULT_BOOTSTRAP_FILENAME } from "./agent-scope-D85sFDRQ.js";
import { m as restoreTerminalState } from "./subsystem-Du2dCfuD.js";
...
async function finalizeOnboardingWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-D3LGHoNj.js").then((n) => n.r);
	...
	if (webSearchProvider) {
		const { SEARCH_PROVIDER_OPTIONS, resolveExistingKey, hasExistingKey, hasKeyInEnv } = await import("./onboard-search-DYtPvLnS.js");
		...
		const { SEARCH_PROVIDER_OPTIONS, hasExistingKey, hasKeyInEnv } = await import("./onboard-search-DYtPvLnS.js");

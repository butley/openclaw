...
import { A as shouldLogVerbose, D as logVerbose, I as getChildLogger, d as normalizeE164, l as isSelfChatMode, m as resolveJidToE164, n as clamp, u as jidToE164, y as sleep } from "./utils-D1-x5Nni.js";
import { $i as registerUnhandledRejectionHandler, A as resolveDmGroupAccessWithCommandGate, B as getReplyFromConfig, Bt as buildAgentSessionKey, C as issuePairingChallenge, Cr as loadSessionStore, D as buildHistoryContextFromEntries, E as createReplyPrefixOptions, Ea as formatCliCommand, F as dispatchReplyWithBufferedBlockDispatcher, Ft as normalizeGroupActivation, Gr as logWebSelfId, Hr as resolveWhatsAppMediaMaxBytes, Ht as resolveAgentRoute, It as parseActivationCommand, J as convertMarkdownTables, Jr as pickWebChannel, Jt as resolveDefaultGroupPolicy, L as createInboundDebouncer, Lt as upsertChannelPairingRequest, M as resolvePinnedMainDmOwnerFromAllowlist, Mt as sleepWithAbort, Nt as createDedupeCache, O as recordPendingHistoryEntryIfEnabled, P as shouldAckReactionForWhatsApp, Q as finalizeInboundContext, Qn as resolveMarkdownTableMode, R as resolveInboundDebounceMs, Rt as formatLocationText, S as createConnectedChannelStatusPatch, Sa as normalizeStreamLevel, Tr as updateLastRoute, Ur as WA_WEB_AUTH_DIR, Ut as resolveInboundLastRouteSessionKey, Vr as resolveWhatsAppAccount, Vt as deriveLastRoutePolicy, Wr as getWebAuthAgeMs, Xr as readWebSelfId, Xt as warnMissingProviderGroupPolicyFallbackOnce, Yt as resolveOpenProviderRuntimeGroupPolicy, Zn as loadWebMedia, aa as loadConfig, ar as resolveIdentityNamePrefix, ei as webAuthExists, et as hasControlCommand, h as setActiveWebListener, ii as resolveGroupSessionKey, ir as resolveTextChunkLimit, j as resolveDmGroupAccessWithLists, ji as saveMediaBuffer, jn as enqueueSystemEvent, jt as computeBackoff, k as readStoreAllowFromForDmPolicy, na as getAgentScopedMediaLocalRoots, ni as resolveChannelGroupRequireMention, nr as chunkMarkdownTextWithMode, nt as buildMentionRegexes, or as resolveMessagePrefix, rr as resolveChunkMode, rt as normalizeMentionText, ti as resolveChannelGroupPolicy, tt as shouldComputeCommandAuthorized, v as resolveInboundSessionEnvelopeContext, w as resolveMentionGating, wn as formatDurationPrecise, wr as recordSessionMetaFromInbound, z as formatInboundEnvelope, zt as toLocationContext } from "./auth-profiles-CUjKaPws.js";
import { a as createSubsystemLogger, l as defaultRuntime } from "./logger-DmhAyJm1.js";
import { $ as getDefaultRedactPatterns, R as resolveStorePath, fn as normalizeAgentId, ln as buildGroupHistoryKey, on as DEFAULT_MAIN_KEY, sn as buildAgentMainSessionKey } from "./query-expansion-Cst10lCV.js";
...
import { i as markdownToWhatsApp, r as sendReactionWhatsApp, t as sendMessageWhatsApp } from "./outbound-QofPkGsT.js";
import "./brazil-jid-resolver-CKMFDhDM.js";
import { i as waitForWaConnection, n as formatError, r as getStatusCode, t as createWaSocket } from "./session-B4w-c73j.js";
import { i as noteContactName, r as loadContactNameCache, t as createWebSendApi } from "./send-api-CIE360jM.js";
import { t as loginWeb } from "./login-MuTbgbg2.js";
import "chalk";
...
async function monitorWebInbox(options) {
	...
	const enqueueInboundMessage = async (msg, inbound, enriched) => {
		...
		const reply = async (text) => {
			const { processOutboundMentions } = await import("./send-api-CIE360jM.js").then((n) => n.n);

...
import { Bs as normalizeSystemRunApprovalPlan, Bt as resolveGatewayConnectionAuth, Cu as readExecApprovalsSnapshot, Eu as resolveExecApprovals, Fs as formatExecCommand, Fu as resolveExecSafeBinRuntimePolicy, G as formatHelpExamples, Hp as GATEWAY_CLIENT_NAMES, Is as resolveSystemRunCommandRequest, Jr as withTimeout, Lu as evaluateExecAllowlist, Nu as isInterpreterLikeSafeBin, Ou as saveExecApprovals, Ql as loadOrCreateDeviceIdentity, Ru as evaluateShellAllowlist, Tu as requiresExecApproval, Vp as GATEWAY_CLIENT_MODES, Zp as writeJsonAtomic, a_ as resolvePlannedSegmentArgv, bu as normalizeExecApprovals, c_ as POSIX_SHELL_WRAPPERS, d_ as unwrapKnownShellMultiplexerInvocation, f_ as POSIX_INLINE_COMMAND_FLAGS, fm as createBrowserRouteDispatcher, hu as ensureExecApprovals, i_ as analyzeArgvCommand, jg as loadConfig, ku as requestJsonlSocket, l_ as normalizeExecutableToken, mm as startBrowserControlServiceFromConfig, mu as addAllowlistEntry, o_ as resolveCommandResolutionFromArgv, p_ as resolveInlineCommandMatch, pm as createBrowserControlContext, rc as GatewayClient, s_ as resolveExecutableFromPathEnv, u_ as unwrapKnownDispatchWrapperInvocation, ud as getMachineDisplayName, vu as mergeExecApprovalsSocketDefaults, wu as recordAllowlistUse, xm as resolveBrowserConfig, zu as resolveAllowAlwaysPatterns } from "./auth-profiles-C_hWnnsG.js";
import { t as formatCliCommand } from "./command-format-xiq-peSB.js";
import { i as resolveAgentConfig } from "./agent-scope-ciM67gYz.js";
import "./utils-hRMQE3lI.js";
import { a as sameFileIdentity } from "./boundary-file-read-BoNLDurR.js";
import { i as logWarn } from "./logger-Dz2ir4Xz.js";
...
import { S as sanitizeSystemRunEnvOverrides, x as sanitizeHostExecEnv } from "./env-overrides-eH6HaD80.js";
import { t as VERSION } from "./version-BlUhcaFh.js";
import { a as splitShellArgs } from "./search-manager-OoPMhEwb.js";
import "./plugins-CVp4JUox.js";
import { W as detectMime } from "./query-expansion-BiHEyx7G.js";
...
import { _ as resolveNodeWindowsTaskName, c as formatNodeServiceDescription, g as resolveNodeSystemdServiceName, h as resolveNodeLaunchAgentLabel } from "./constants-a1ITP_xg.js";
...
import { l as buildNodeServiceEnvironment, n as resolveDaemonInstallRuntimeInputs, p as resolveNodeProgramArguments, t as emitDaemonInstallRuntimeWarning } from "./daemon-install-plan.shared-CWj5Gxrz.js";
...
import { _ as installDaemonServiceAndEmit, a as createCliStatusTextStyles, g as buildDaemonServiceSnapshot, i as runServiceUninstall, m as resolveRuntimeStatusColor, o as createDaemonInstallActionContext, r as runServiceStop, s as failIfNixDaemonInstallMode, t as runServiceRestart } from "./lifecycle-core-xZLDOEwt.js";
import { c as buildPlatformRuntimeLogHints, l as buildPlatformServiceStartHints, u as formatRuntimeStatus } from "./systemd-hints-0Dxh4CDT.js";
import { t as parsePort } from "./parse-port-BHMszcoq.js";
import { i as NODE_SYSTEM_RUN_COMMANDS, n as NODE_EXEC_APPROVALS_COMMANDS, t as NODE_BROWSER_PROXY_COMMAND } from "./node-commands-BnJMyJDd.js";

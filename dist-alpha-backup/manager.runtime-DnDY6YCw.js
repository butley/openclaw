...
import { A as shouldLogVerbose, D as logVerbose, J as resolvePreferredOpenClawTmpDir } from "./utils-D1-x5Nni.js";
import { $ as resolveSendPolicy, $t as formatOutboundPayloadLog, Ar as resolveSessionKey, At as resolveContextTokensForModel, Ca as normalizeThinkLevel, Cr as loadSessionStore, Ct as resolveAcpAgentPolicyError, Dt as applyModelOverrideToSessionEntry, Ea as formatCliCommand, Er as updateSessionStore, Et as AGENT_LANE_SUBAGENT, Fr as mergeSessionEntry, G as applyVerboseOverride, Gt as resolveSessionDeliveryTarget, H as setCliSessionId, Hi as buildWorkspaceSkillSnapshot, Ht as resolveAgentRoute, Ir as setSessionRuntimeModel, Kt as resolveDiscordOwnerAccess, Ln as getAcpSessionManager, Lr as resolveExplicitAgentSessionKey, Mn as clearBootstrapSnapshotOnSessionRollover, Mr as resolveChannelResetConfig, Nr as resolveSessionResetPolicy, Ot as deriveSessionTotalTokens, Pr as resolveSessionResetType, Pt as normalizeReplyPayload, Qt as deliverOutboundPayloads, Rn as toAcpRuntimeError, Rr as getChannelPlugin, Sr as emitSessionTranscriptUpdate, St as resolveAcpSessionCwd, T as isDangerousNameMatchingEnabled, Ta as supportsXHighThinking, Tt as AGENT_LANE_NESTED, U as runCliAgent, V as getCliSessionId, W as clearSessionAuthProfileOverride, Wt as resolveOutboundTarget, X as getRemoteSkillEligibility, Z as getSkillsSnapshotVersion, Zt as buildOutboundSessionContext, _r as normalizeMediaAttachments, _t as formatAgentInternalEventsForPrompt, a as modelKey, aa as loadConfig, ai as INTERNAL_MESSAGE_CHANNEL, an as runWithModelFallback, at as prepareSessionManagerForRun, ba as formatThinkingLevels, bt as emitAgentEvent, c as resolveConfiguredModelRef, ca as readConfigFileSnapshotForWrite, ci as isInternalMessageChannel, cr as textToSpeech, ea as formatErrorMessage, en as normalizeOutboundPayloads, er as isSilentReplyPrefixText, f as getAgentRuntimeCommandSecretTargetIds, gr as createMediaAttachmentCache, gt as resolveAgentTimeoutMs, hr as buildProviderRegistry, i as isCliProvider, it as runEmbeddedPiAgent, jr as evaluateSessionFreshness, kr as normalizeAccountId, kt as hasNonzeroUsage, l as resolveDefaultModelForAgent, la as setRuntimeConfigSnapshot, li as normalizeMessageChannel, lr as parseTtsDirectives, o as normalizeModelRef, oi as isDeliverableMessageChannel, ot as resolveBootstrapWarningSignaturesSeen, p as resolveCommandSecretRefsViaGateway, q as formatMention, qt as formatDiscordUserTag, r as buildAllowedModelSet, ra as loadModelCatalog, rn as resolveMessageChannelSelection, s as normalizeProviderId, si as isGatewayMessageChannel, sn as FailoverError, sr as resolveTtsConfig, t as ensureAuthProfileStore, tn as normalizeOutboundPayloadsForJson, tr as isSilentReplyText, u as resolveThinkingDefault, ui as resolveMessageChannel, va as DEFAULT_MODEL, vt as normalizeSpawnedRunMetadata, wa as normalizeVerboseLevel, wt as resolveAcpDispatchPolicyError, xa as formatXHighModelHint, xr as resolveSessionTranscriptFile, xt as registerAgentRunContext, ya as DEFAULT_PROVIDER, yr as runCapability, yt as clearAgentRunContext, zr as normalizeChannelId } from "./auth-profiles-CUjKaPws.js";
import { a as createSubsystemLogger, l as defaultRuntime } from "./logger-DmhAyJm1.js";
import { Et as resolveSessionAgentId, It as ensureAgentWorkspace, R as resolveStorePath, St as resolveAgentWorkspaceDir, fn as normalizeAgentId, gt as listAgentIds, mn as resolveAgentIdFromSessionKey, pn as normalizeMainKey, vt as resolveAgentDir, wt as resolveEffectiveModelFallbacks, xt as resolveAgentSkillsFilter } from "./query-expansion-Cst10lCV.js";
...
function loadWhatsAppSenderRuntime() {
	whatsappSenderRuntimePromise ??= import("./deps-send-whatsapp.runtime-D4R67ePJ.js");
	return whatsappSenderRuntimePromise;
}
function loadTelegramSenderRuntime() {
	telegramSenderRuntimePromise ??= import("./deps-send-telegram.runtime-CXHLZKRC.js");
	return telegramSenderRuntimePromise;
}
function loadDiscordSenderRuntime() {
	discordSenderRuntimePromise ??= import("./deps-send-discord.runtime-B5REPhvb.js");
	return discordSenderRuntimePromise;
}
function loadSlackSenderRuntime() {
	slackSenderRuntimePromise ??= import("./deps-send-slack.runtime-C669nQe_.js");
	return slackSenderRuntimePromise;
}
function loadSignalSenderRuntime() {
	signalSenderRuntimePromise ??= import("./deps-send-signal.runtime-0bcbh6Oi.js");
	return signalSenderRuntimePromise;
}
function loadIMessageSenderRuntime() {
	imessageSenderRuntimePromise ??= import("./deps-send-imessage.runtime-Dl01mhFe.js");

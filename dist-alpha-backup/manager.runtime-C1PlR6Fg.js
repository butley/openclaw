import { Et as resolveSessionAgentId, It as ensureAgentWorkspace, R as resolveStorePath, St as resolveAgentWorkspaceDir, fn as normalizeAgentId, gt as listAgentIds, mn as resolveAgentIdFromSessionKey, pn as normalizeMainKey, vt as resolveAgentDir, wt as resolveEffectiveModelFallbacks, xt as resolveAgentSkillsFilter } from "./query-expansion-BX-XxaSy.js";
import "./paths-CzCvxHkV.js";
import { A as shouldLogVerbose, D as logVerbose, q as resolvePreferredOpenClawTmpDir } from "./utils-CkvAiB-V.js";
import { a as createSubsystemLogger, l as defaultRuntime } from "./logger-BESIZ_s5.js";
import { $ as runEmbeddedPiAgent, An as resolveTtsConfig, B as applyVerboseOverride, Bn as normalizeMediaAttachments, Bt as resolveSessionDeliveryTarget, Ci as supportsXHighThinking, Ct as deriveSessionTotalTokens, En as isSilentReplyText, Fr as normalizeMessageChannel, G as getRemoteSkillEligibility, H as formatMention, Hn as runCapability, Ht as formatDiscordUserTag, I as getCliSessionId, Ir as resolveMessageChannel, J as resolveSendPolicy, Jn as resolveSessionTranscriptFile, Jt as formatOutboundPayloadLog, K as getSkillsSnapshotVersion, Kt as buildOutboundSessionContext, L as setCliSessionId, Lt as resolveAgentRoute, Mn as parseTtsDirectives, Mr as isDeliverableMessageChannel, Nr as isGatewayMessageChannel, Oi as DEFAULT_MODEL, Pr as isInternalMessageChannel, Qt as resolveMessageChannelSelection, R as runCliAgent, Rn as buildProviderRegistry, Si as normalizeVerboseLevel, St as applyModelOverrideToSessionEntry, Tn as isSilentReplyPrefixText, Tt as resolveContextTokensForModel, Vt as resolveDiscordOwnerAccess, Xn as loadSessionStore, Xt as normalizeOutboundPayloadsForJson, Yn as emitSessionTranscriptUpdate, Yt as normalizeOutboundPayloads, _i as formatCliCommand, _t as resolveAcpSessionCwd, a as normalizeProviderId, ar as resolveSessionResetPolicy, b as isDangerousNameMatchingEnabled, bt as AGENT_LANE_NESTED, c as resolveThinkingDefault, cr as setSessionRuntimeModel, dr as normalizeChannelId, dt as resolveAgentTimeoutMs, en as runWithModelFallback, er as updateSessionStore, et as prepareSessionManagerForRun, fi as loadConfig, ft as formatAgentInternalEventsForPrompt, gi as ensureAuthProfileStore, gt as registerAgentRunContext, ht as emitAgentEvent, i as normalizeModelRef, in as clearBootstrapSnapshotOnSessionRollover, ir as resolveChannelResetConfig, jn as textToSpeech, jr as INTERNAL_MESSAGE_CHANNEL, ki as DEFAULT_PROVIDER, kt as normalizeReplyPayload, l as getAgentRuntimeCommandSecretTargetIds, ln as getAcpSessionManager, lr as resolveExplicitAgentSessionKey, mi as setRuntimeConfigSnapshot, mt as clearAgentRunContext, n as isCliProvider, ni as formatErrorMessage, nr as resolveSessionKey, o as resolveConfiguredModelRef, or as resolveSessionResetType, pi as readConfigFileSnapshotForWrite, pt as normalizeSpawnedRunMetadata, qn as loadModelCatalog, qt as deliverOutboundPayloads, r as modelKey, rr as evaluateSessionFreshness, s as resolveDefaultModelForAgent, sr as mergeSessionEntry, t as buildAllowedModelSet, tn as FailoverError, tr as normalizeAccountId, tt as resolveBootstrapWarningSignaturesSeen, u as resolveCommandSecretRefsViaGateway, ui as buildWorkspaceSkillSnapshot, un as toAcpRuntimeError, ur as getChannelPlugin, vi as formatThinkingLevels, vt as resolveAcpAgentPolicyError, wt as hasNonzeroUsage, xi as normalizeThinkLevel, xt as AGENT_LANE_SUBAGENT, yi as formatXHighModelHint, yt as resolveAcpDispatchPolicyError, z as clearSessionAuthProfileOverride, zn as createMediaAttachmentCache, zt as resolveOutboundTarget } from "./model-selection-DJYVArDN.js";
...
function loadWhatsAppSenderRuntime() {
	whatsappSenderRuntimePromise ??= import("./deps-send-whatsapp.runtime-77-12rZJ.js");
	return whatsappSenderRuntimePromise;
}
function loadTelegramSenderRuntime() {
	telegramSenderRuntimePromise ??= import("./deps-send-telegram.runtime-BrQPNIzx.js");
	return telegramSenderRuntimePromise;
}
function loadDiscordSenderRuntime() {
	discordSenderRuntimePromise ??= import("./deps-send-discord.runtime-CdVSY0UQ.js");
	return discordSenderRuntimePromise;
}
function loadSlackSenderRuntime() {
	slackSenderRuntimePromise ??= import("./deps-send-slack.runtime-C5YMBQa3.js");
	return slackSenderRuntimePromise;
}
function loadSignalSenderRuntime() {
	signalSenderRuntimePromise ??= import("./deps-send-signal.runtime-CF7oeJvh.js");
	return signalSenderRuntimePromise;
}
function loadIMessageSenderRuntime() {
	imessageSenderRuntimePromise ??= import("./deps-send-imessage.runtime-DlsEJfjd.js");

...
import { $l as mergeExecApprovalsSocketDefaults, Ar as withTimeout, B_ as resolveCommandResolutionFromArgv, Cm as GATEWAY_CLIENT_MODES, G_ as unwrapKnownShellMultiplexerInvocation, H_ as POSIX_SHELL_WRAPPERS, J_ as splitShellArgs, Jm as createBrowserControlContext, K_ as POSIX_INLINE_COMMAND_FLAGS, Mm as writeJsonAtomic, Nl as loadOrCreateDeviceIdentity, R_ as analyzeArgvCommand, Rs as GatewayClient, U_ as normalizeExecutableToken, V_ as resolveExecutableFromPathEnv, W_ as unwrapKnownDispatchWrapperInvocation, Wt as resolveGatewayConnectionAuth, Xl as ensureExecApprovals, Yl as addAllowlistEntry, Ym as startBrowserControlServiceFromConfig, _s as resolveSystemRunCommandRequest, au as recordAllowlistUse, bu as resolveAllowAlwaysPatterns, gs as formatExecCommand, gu as resolveExecSafeBinRuntimePolicy, iu as readExecApprovalsSnapshot, lu as saveExecApprovals, mu as isInterpreterLikeSafeBin, nh as resolveBrowserConfig, ou as requiresExecApproval, q as formatHelpExamples, q_ as resolveInlineCommandMatch, qm as createBrowserRouteDispatcher, qu as getMachineDisplayName, su as resolveExecApprovals, tu as normalizeExecApprovals, u_ as loadConfig, uu as requestJsonlSocket, uv as VERSION, vu as evaluateExecAllowlist, wm as GATEWAY_CLIENT_NAMES, xs as normalizeSystemRunApprovalPlan, yu as evaluateShellAllowlist, z_ as resolvePlannedSegmentArgv } from "./reply-BRIrPGWy.js";
import { i as resolveAgentConfig } from "./agent-scope-D85sFDRQ.js";
import { p as defaultRuntime } from "./subsystem-Du2dCfuD.js";
import { s as sameFileIdentity } from "./openclaw-root-B76Z4doY.js";
import { i as logWarn } from "./logger-CTiHjjqB.js";
...
import { S as sanitizeSystemRunEnvOverrides, x as sanitizeHostExecEnv } from "./env-overrides-B59mbP3-.js";
import "./registry-3SOFgkh6.js";
import "./skills-CObtH1pm.js";
import "./frontmatter-D-zbDLA0.js";
import "./plugins-B3EU9SbO.js";
import { N as detectMime } from "./query-expansion-D7MNjl_J.js";
...
import { l as buildNodeServiceEnvironment, n as resolveDaemonInstallRuntimeInputs, p as resolveNodeProgramArguments, t as emitDaemonInstallRuntimeWarning } from "./daemon-install-plan.shared-D7_9J7V7.js";
import { r as isGatewayDaemonRuntime, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-C4_-bMd5.js";
import "./runtime-parse-B7MHNKjD.js";
import "./launchd-BwHL4IZ9.js";
import "./service-DUsMTOWn.js";
import "./systemd-BiGGKSFE.js";
import { _ as installDaemonServiceAndEmit, a as createCliStatusTextStyles, g as buildDaemonServiceSnapshot, i as runServiceUninstall, m as resolveRuntimeStatusColor, o as createDaemonInstallActionContext, r as runServiceStop, s as failIfNixDaemonInstallMode, t as runServiceRestart } from "./lifecycle-core-sRtcGiY2.js";
import { c as buildPlatformRuntimeLogHints, l as buildPlatformServiceStartHints, u as formatRuntimeStatus } from "./systemd-hints-CFP9Xn2H.js";
import { t as parsePort } from "./parse-port-BuDrrHb-.js";
import { i as NODE_SYSTEM_RUN_COMMANDS, n as NODE_EXEC_APPROVALS_COMMANDS, t as NODE_BROWSER_PROXY_COMMAND } from "./node-commands-B78FISkV.js";

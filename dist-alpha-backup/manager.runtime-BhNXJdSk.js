import { $r as isInternalMessageChannel, Ar as normalizeChannelId, Bi as DEFAULT_MODEL, Bt as resolveAcpSessionCwd, Cn as runWithModelFallback, Cr as resolveChannelResetConfig, Ct as prepareSessionManagerForRun, Dn as clearBootstrapSnapshotOnSessionRollover, Dr as setSessionRuntimeModel, Er as mergeSessionEntry, Ft as formatAgentInternalEventsForPrompt, Gt as applyModelOverrideToSessionEntry, Ht as resolveAcpDispatchPolicyError, Ii as normalizeThinkLevel, It as normalizeSpawnedRunMetadata, Jt as resolveContextTokensForModel, Kt as deriveSessionTotalTokens, Li as normalizeVerboseLevel, Lt as clearAgentRunContext, Mi as formatCliCommand, Mn as getAcpSessionManager, Ni as formatThinkingLevels, Nn as toAcpRuntimeError, Or as resolveExplicitAgentSessionKey, Pi as formatXHighModelHint, Pt as resolveAgentTimeoutMs, Qn as parseTtsDirectives, Qr as isGatewayMessageChannel, Qt as normalizeReplyPayload, Ri as supportsXHighThinking, Rt as emitAgentEvent, Sr as evaluateSessionFreshness, St as runEmbeddedPiAgent, Tr as resolveSessionResetType, Un as isSilentReplyPrefixText, Ut as AGENT_LANE_NESTED, Vi as DEFAULT_PROVIDER, Vt as resolveAcpAgentPolicyError, W as isDangerousNameMatchingEnabled, Wn as isSilentReplyText, Wt as AGENT_LANE_SUBAGENT, Xn as resolveTtsConfig, Xr as INTERNAL_MESSAGE_CHANNEL, Zn as textToSpeech, Zr as isDeliverableMessageChannel, _n as formatOutboundPayloadLog, _t as resolveSendPolicy, a as setRuntimeConfigSnapshot, ar as createMediaAttachmentCache, br as normalizeAccountId, c as modelKey, cn as resolveOutboundTarget, cr as runCapability, ct as getCliSessionId, d as resolveConfiguredModelRef, dn as formatDiscordUserTag, dt as clearSessionAuthProfileOverride, ei as normalizeMessageChannel, f as resolveDefaultModelForAgent, ft as applyVerboseOverride, gn as deliverOutboundPayloads, gr as loadSessionStore, h as resolveCommandSecretRefsViaGateway, hn as buildOutboundSessionContext, hr as emitSessionTranscriptUpdate, ht as getSkillsSnapshotVersion, i as readConfigFileSnapshotForWrite, ir as buildProviderRegistry, ji as ensureAuthProfileStore, ki as buildWorkspaceSkillSnapshot, kr as getChannelPlugin, l as normalizeModelRef, ln as resolveSessionDeliveryTarget, lt as setCliSessionId, m as getAgentRuntimeCommandSecretTargetIds, mr as resolveSessionTranscriptFile, mt as getRemoteSkillEligibility, o as buildAllowedModelSet, on as resolveAgentRoute, or as normalizeMediaAttachments, p as resolveThinkingDefault, pr as loadModelCatalog, qt as hasNonzeroUsage, r as loadConfig, s as isCliProvider, ti as resolveMessageChannel, u as normalizeProviderId, un as resolveDiscordOwnerAccess, ut as runCliAgent, vn as normalizeOutboundPayloads, wn as FailoverError, wr as resolveSessionResetPolicy, wt as resolveBootstrapWarningSignaturesSeen, xi as formatErrorMessage, xn as resolveMessageChannelSelection, xr as resolveSessionKey, yn as normalizeOutboundPayloadsForJson, yr as updateSessionStore, z as formatMention, zt as registerAgentRunContext } from "./discord-CGOKw6Ak.js";
...
function loadWhatsAppSenderRuntime() {
	whatsappSenderRuntimePromise ??= import("./deps-send-whatsapp.runtime-B_oRvVRv.js");
	return whatsappSenderRuntimePromise;
}
function loadTelegramSenderRuntime() {
	telegramSenderRuntimePromise ??= import("./deps-send-telegram.runtime-oL6CaugY.js");
	return telegramSenderRuntimePromise;
}
function loadDiscordSenderRuntime() {
	discordSenderRuntimePromise ??= import("./deps-send-discord.runtime-1AhJGGbS.js");
	return discordSenderRuntimePromise;
}
function loadSlackSenderRuntime() {
	slackSenderRuntimePromise ??= import("./deps-send-slack.runtime-y0cDbW_e.js");
	return slackSenderRuntimePromise;
}
function loadSignalSenderRuntime() {
	signalSenderRuntimePromise ??= import("./deps-send-signal.runtime-C4Zmzxf9.js");
	return signalSenderRuntimePromise;
}
function loadIMessageSenderRuntime() {
	imessageSenderRuntimePromise ??= import("./deps-send-imessage.runtime-PxfK54sZ.js");

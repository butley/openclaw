...
import { Cm as GATEWAY_CLIENT_MODES, Eg as isKnownCoreToolId, Rs as GatewayClient, Ts as buildGatewayConnectionDetails, Wt as resolveGatewayConnectionAuth, u_ as loadConfig, uv as VERSION, wm as GATEWAY_CLIENT_NAMES, zv as listThinkingLevels } from "./reply-BRIrPGWy.js";
...
import { M as resolveWindowsSpawnProgram, j as materializeWindowsSpawnProgram } from "./query-expansion-D7MNjl_J.js";
...
import { i as omitEnvKeysCaseInsensitive, n as listKnownProviderAuthEnvVarNames } from "./provider-env-vars-WC12PyZa.js";
import { t as DANGEROUS_ACP_TOOLS } from "./dangerous-tools-BhDZiOL3.js";
...
async function createAcpClient(opts = {}) {
	...
	const { getActiveSkillEnvKeys } = await import("./env-overrides.runtime-Qwjbwkw3.js");

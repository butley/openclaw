...
function resolveMemoryBackendConfig(params) {
	...
	return {
		...
		qmd: {
			...
			maxOutputChars: typeof qmdCfg?.maxOutputChars === "number" && qmdCfg.maxOutputChars > 0 ? Math.floor(qmdCfg.maxOutputChars) : void 0,
...
function loadManagerRuntime() {
	managerRuntimePromise ??= import("./manager-runtime-BRawFUbo.js");
...
async function getMemorySearchManager(params) {
	...
	if (resolved.backend === "qmd" && resolved.qmd) {
		...
		try {
			const { QmdMemoryManager } = await import("./qmd-manager-RMa_sfo8.js");

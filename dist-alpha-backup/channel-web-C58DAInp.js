import { a as logVerbose, c as shouldLogVerbose, d as getChildLogger } from "./globals-cEUy0WVg.js";
import { C as sleep, f as isSelfChatMode, m as normalizeE164, p as jidToE164, r as clamp, v as resolveJidToE164 } from "./utils-B1xPTYn-.js";
import { Ad as resolveMessagePrefix, Ca as warnMissingProviderGroupPolicyFallbackOnce, Cd as chunkMarkdownTextWithMode, Dn as buildHistoryContextFromEntries, En as createReplyPrefixOptions, Fn as resolvePinnedMainDmOwnerFromAllowlist, Gn as shouldAckReactionForWhatsApp, Gt as createConnectedChannelStatusPatch, Hi as parseActivationCommand, Ii as computeBackoff, Jn as createInboundDebouncer, Kn as dispatchReplyWithBufferedBlockDispatcher, Li as sleepWithAbort, Nn as resolveDmGroupAccessWithCommandGate, On as recordPendingHistoryEntryIfEnabled, Pn as resolveDmGroupAccessWithLists, Ri as createDedupeCache, Rl as enqueueSystemEvent, Sa as resolveOpenProviderRuntimeGroupPolicy, Td as resolveTextChunkLimit, Un as convertMarkdownTables, Uv as normalizeStreamLevel, Vi as normalizeGroupActivation, Xn as formatInboundEnvelope, Yn as resolveInboundDebounceMs, _d as loadWebMedia, _p as recordSessionMetaFromInbound, ca as buildAgentSessionKey, cm as resolveChannelGroupRequireMention, cr as finalizeInboundContext, da as resolveInboundLastRouteSessionKey, df as getAgentScopedMediaLocalRoots, dr as hasControlCommand, fm as resolveGroupSessionKey, fr as shouldComputeCommandAuthorized, gp as loadSessionStore, gr as normalizeMentionText, hr as buildMentionRegexes, jn as readStoreAllowFromForDmPolicy, kd as resolveIdentityNamePrefix, la as deriveLastRoutePolicy, lf as registerUnhandledRejectionHandler, ls as formatDurationPrecise, oa as formatLocationText, pt as resolveInboundSessionEnvelopeContext, ra as upsertChannelPairingRequest, sa as toLocationContext, sh as saveMediaBuffer, sm as resolveChannelGroupPolicy, t as getReplyFromConfig, tt as setActiveWebListener, u_ as loadConfig, ua as resolveAgentRoute, vd as resolveMarkdownTableMode, vn as issuePairingChallenge, wd as resolveChunkMode, xa as resolveDefaultGroupPolicy, yn as resolveMentionGating, yp as updateLastRoute } from "./reply-BRIrPGWy.js";
import { p as defaultRuntime, t as createSubsystemLogger } from "./subsystem-Du2dCfuD.js";
...
import { $ as readWebSelfId, G as resolveWhatsAppMediaMaxBytes, U as resolveWhatsAppAccount, q as getWebAuthAgeMs } from "./plugins-B3EU9SbO.js";
import { l as resolveStorePath } from "./paths-B4q5wccl.js";
import { n as recordChannelActivity } from "./channel-activity-U1P6GjYM.js";
import { a as markdownToWhatsApp, i as sendReactionWhatsApp } from "./outbound-DxqWL5Bx.js";
import { i as waitForWaConnection, n as formatError, r as getStatusCode, t as createWaSocket } from "./session-CcRQAZwQ.js";
import { i as noteContactName, r as loadContactNameCache, t as createWebSendApi } from "./send-api-D5gK2Mu8.js";
import { n as gatewayEventBus } from "./server-broadcast-BuKiBvDl.js";
...
async function monitorWebInbox(options) {
	...
	const enqueueInboundMessage = async (msg, inbound, enriched) => {
		...
		const reply = async (text) => {
			const { processOutboundMentions } = await import("./send-api-D5gK2Mu8.js").then((n) => n.n);

...
import { Bt as resolveGatewayConnectionAuth, Ev as listThinkingLevels, Hp as GATEWAY_CLIENT_NAMES, Vp as GATEWAY_CLIENT_MODES, Ws as buildGatewayConnectionDetails, jg as loadConfig, rc as GatewayClient, sg as isKnownCoreToolId } from "./auth-profiles-C_hWnnsG.js";
...
import { M as resolveWindowsSpawnProgram, j as materializeWindowsSpawnProgram } from "./query-expansion-BiHEyx7G.js";
...
import { i as omitEnvKeysCaseInsensitive, n as listKnownProviderAuthEnvVarNames } from "./provider-env-vars-BHVS4cSa.js";
import { t as DANGEROUS_ACP_TOOLS } from "./dangerous-tools-CcL6pQb-.js";
...
async function createAcpClient(opts = {}) {
	...
	const { getActiveSkillEnvKeys } = await import("./env-overrides.runtime-BF9QsBwH.js");

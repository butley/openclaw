import { $t as normalizeGroupActivation, B as createConnectedChannelStatusPatch, Bn as loadWebMedia, En as enqueueSystemEvent, Fi as normalizeStreamLevel, Fr as getWebAuthAgeMs, G as createReplyPrefixOptions, Gn as chunkMarkdownTextWithMode, Gr as webAuthExists, H as resolveMentionGating, Ir as logWebSelfId, J as readStoreAllowFromForDmPolicy, Jn as resolveIdentityNamePrefix, K as buildHistoryContextFromEntries, Kn as resolveChunkMode, Kr as resolveChannelGroupPolicy, L as resolveInboundSessionEnvelopeContext, Mi as formatCliCommand, Mr as resolveWhatsAppAccount, Nr as resolveWhatsAppMediaMaxBytes, Pr as WA_WEB_AUTH_DIR, Tn as formatDurationPrecise, U as convertMarkdownTables, V as issuePairingChallenge, Vn as resolveMarkdownTableMode, Vr as readWebSelfId, X as resolveDmGroupAccessWithLists, Xt as sleepWithAbort, Y as resolveDmGroupAccessWithCommandGate, Yn as resolveMessagePrefix, Yr as resolveGroupSessionKey, Yt as computeBackoff, Z as resolvePinnedMainDmOwnerFromAllowlist, Zt as createDedupeCache, _ as setActiveWebListener, _i as saveMediaBuffer, _r as recordSessionMetaFromInbound, an as deriveLastRoutePolicy, at as resolveInboundDebounceMs, bt as buildMentionRegexes, en as parseActivationCommand, fn as resolveDefaultGroupPolicy, fr as getAgentScopedMediaLocalRoots, gr as loadSessionStore, gt as finalizeInboundContext, in as buildAgentSessionKey, it as createInboundDebouncer, mn as warnMissingProviderGroupPolicyFallbackOnce, nn as formatLocationText, nt as dispatchReplyWithBufferedBlockDispatcher, on as resolveAgentRoute, ot as formatInboundEnvelope, pn as resolveOpenProviderRuntimeGroupPolicy, q as recordPendingHistoryEntryIfEnabled, qn as resolveTextChunkLimit, qr as resolveChannelGroupRequireMention, r as loadConfig, rn as toLocationContext, sn as resolveInboundLastRouteSessionKey, st as getReplyFromConfig, tn as upsertChannelPairingRequest, tt as shouldAckReactionForWhatsApp, ur as registerUnhandledRejectionHandler, vr as updateLastRoute, vt as hasControlCommand, xt as normalizeMentionText, yt as shouldComputeCommandAuthorized, zr as pickWebChannel } from "./discord-CGOKw6Ak.js";
...
import { Q as getDefaultRedactPatterns, R as resolveStorePath } from "./query-expansion-Dpf_vNBe.js";
import { A as shouldLogVerbose, D as logVerbose, I as getChildLogger, d as normalizeE164, l as isSelfChatMode, m as resolveJidToE164, n as clamp, u as jidToE164, y as sleep } from "./utils-BBQx0yHF.js";
...
import { i as markdownToWhatsApp, r as sendReactionWhatsApp, t as sendMessageWhatsApp } from "./outbound-_ZvlDexu.js";
import "./brazil-jid-resolver-CjnbRjup.js";
import { i as waitForWaConnection, n as formatError, r as getStatusCode, t as createWaSocket } from "./session-Bzu5E7Fv.js";
import { i as noteContactName, r as loadContactNameCache, t as createWebSendApi } from "./send-api-DxlWnVcc.js";
...
async function monitorWebInbox(options) {
	...
	const enqueueInboundMessage = async (msg, inbound, enriched) => {
		...
		const reply = async (text) => {
			const { processOutboundMentions } = await import("./send-api-DxlWnVcc.js").then((n) => n.n);

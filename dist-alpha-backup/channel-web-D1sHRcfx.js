import { a as logVerbose, c as shouldLogVerbose, d as getChildLogger } from "./globals-1g9PhnTZ.js";
import { p as defaultRuntime, t as createSubsystemLogger } from "./subsystem-CVaAzJWY.js";
import { $ as setActiveWebListener, $i as computeBackoff, Ap as resolveGroupSessionKey, Ar as shouldComputeCommandAuthorized, Av as normalizeStreamLevel, Ba as warnMissingProviderGroupPolicyFallbackOnce, Bd as chunkMarkdownTextWithMode, Ca as formatLocationText, Da as resolveAgentRoute, Ea as deriveLastRoutePolicy, Em as saveMediaBuffer, Ep as resolveChannelGroupRequireMention, Er as finalizeInboundContext, Fd as resolveMarkdownTableMode, Ff as loadSessionStore, Hd as resolveTextChunkLimit, Ht as issuePairingChallenge, If as recordSessionMetaFromInbound, In as convertMarkdownTables, Kd as resolveIdentityNamePrefix, Nr as buildMentionRegexes, Oa as resolveInboundLastRouteSessionKey, Os as formatDurationPrecise, Pd as loadWebMedia, Pr as normalizeMentionText, Qt as recordPendingHistoryEntryIfEnabled, Ra as resolveDefaultGroupPolicy, Rf as updateLastRoute, Sg as getAgentScopedMediaLocalRoots, Ta as buildAgentSessionKey, Tp as resolveChannelGroupPolicy, Ut as resolveMentionGating, Vd as resolveChunkMode, Vt as createConnectedChannelStatusPatch, Xt as createReplyPrefixOptions, Zt as buildHistoryContextFromEntries, _n as getReplyFromConfig, aa as parseActivationCommand, an as resolvePinnedMainDmOwnerFromAllowlist, ba as upsertChannelPairingRequest, bg as registerUnhandledRejectionHandler, cn as shouldAckReactionForWhatsApp, dn as createInboundDebouncer, ea as sleepWithAbort, fn as resolveInboundDebounceMs, ia as normalizeGroupActivation, in as resolveDmGroupAccessWithLists, jg as loadConfig, kr as hasControlCommand, ln as dispatchReplyWithBufferedBlockDispatcher, pn as formatInboundEnvelope, qd as resolveMessagePrefix, rn as resolveDmGroupAccessWithCommandGate, ru as enqueueSystemEvent, ta as createDedupeCache, tn as readStoreAllowFromForDmPolicy, ut as resolveInboundSessionEnvelopeContext, wa as toLocationContext, za as resolveOpenProviderRuntimeGroupPolicy } from "./auth-profiles-C_hWnnsG.js";
import { t as formatCliCommand } from "./command-format-xiq-peSB.js";
import { a as buildGroupHistoryKey, c as normalizeAgentId, n as DEFAULT_MAIN_KEY, r as buildAgentMainSessionKey } from "./session-key-Cl1W5L6J.js";
import { S as sleep, _ as resolveJidToE164, d as isSelfChatMode, f as jidToE164, n as clamp, p as normalizeE164 } from "./utils-hRMQE3lI.js";
import { $ as readWebSelfId, G as resolveWhatsAppMediaMaxBytes, U as resolveWhatsAppAccount, q as getWebAuthAgeMs } from "./plugins-CVp4JUox.js";
import { l as resolveStorePath } from "./paths-DPIeb3JQ.js";
import { n as recordChannelActivity } from "./channel-activity-CEmsyqOm.js";
import { a as markdownToWhatsApp, i as sendReactionWhatsApp } from "./outbound-YYR63q9e.js";
import { i as waitForWaConnection, n as formatError, r as getStatusCode, t as createWaSocket } from "./session-llZGyXB6.js";
import { i as noteContactName, r as loadContactNameCache, t as createWebSendApi } from "./send-api-CuFnCb5P.js";
import { n as gatewayEventBus } from "./server-broadcast-BU8Hp9t8.js";
...
async function monitorWebInbox(options) {
	...
	const enqueueInboundMessage = async (msg, inbound, enriched) => {
		...
		const reply = async (text) => {
			const { processOutboundMentions } = await import("./send-api-CuFnCb5P.js").then((n) => n.n);

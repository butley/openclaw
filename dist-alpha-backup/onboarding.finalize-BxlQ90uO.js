...
import { m as restoreTerminalState } from "./subsystem-CVaAzJWY.js";
import "./boolean-Cxf2THfz.js";
import { Et as probeGatewayReachable, Mt as waitForGatewayReachable, Ot as resolveControlUiLinks, gt as detectBrowserOpenSupport, vt as formatControlUiSshHint, wt as openUrl } from "./auth-profiles-C_hWnnsG.js";
import { r as resolveCliName, t as formatCliCommand } from "./command-format-xiq-peSB.js";
import { y as DEFAULT_BOOTSTRAP_FILENAME } from "./agent-scope-ciM67gYz.js";
import { m as pathExists, v as resolveUserPath } from "./utils-hRMQE3lI.js";
...
async function finalizeOnboardingWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-CrraApTp.js").then((n) => n.r);
	...
	if (webSearchProvider) {
		const { SEARCH_PROVIDER_OPTIONS, resolveExistingKey, hasExistingKey, hasKeyInEnv } = await import("./onboard-search-Cl9him9L.js");
		...
		const { SEARCH_PROVIDER_OPTIONS, hasExistingKey, hasKeyInEnv } = await import("./onboard-search-Cl9him9L.js");

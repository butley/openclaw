...
import { $ as resolveCommandSecretRefsViaGateway, A as normalizeProviderId, B as resolvePluginProviders, C as findNormalizedProviderValue, D as modelKey, Dt as openUrl, Ev as resolveOpenClawAgentDir, F as resolveDefaultModelForAgent, Fv as DEFAULT_PROVIDER, Gd as resolveModelWithRegistry, Jd as discoverAuthStorage, K as withProgressTotals, Ka as describeFailoverError, L as resolveModelRefFromString, Ov as resolveAuthProfileDisplayLabel, P as resolveConfiguredModelRef, Pv as DEFAULT_MODEL, S as buildModelAliasIndex, Tv as resolveAuthStorePathForDisplay, Ug as resolveSecretRefString, X as getModelsCommandSecretTargetIds, Yd as discoverModels, _f as resolveApiKeyForProvider, _r as runEmbeddedPiAgent, _v as listProfilesForProvider, bf as resolveUsableCustomProviderApiKey, bi as formatUsageWindowSummary, bv as ensureAuthProfileStore, c as buildAuthHealthSummary, ep as resolveAuthProfileEligibility, ff as loadModelCatalog, g_ as setRuntimeConfigSnapshot, gf as hasUsableCustomProviderApiKey, hf as getCustomProviderApiKey, j as parseModelRef, l as formatRemainingShort, l_ as createConfigIO, m_ as readConfigFileSnapshotForWrite, mf as shouldSuppressBuiltInModel, mv as shouldEnableShellEnvFallback, np as resolveProfileUnusableUntilForDisplay, o as maskApiKey, pv as getShellEnvAppliedKeys, qf as isNonSecretApiKeyMarker, s as DEFAULT_OAUTH_WARN_MS, tp as resolveAuthProfileOrder, u_ as loadConfig, vf as resolveAwsSdkEnvVarName, vi as loadProviderUsageSummary, vv as setAuthProfileOrder, w_ as parseDurationMs, xi as resolveUsageProviderId, yf as resolveEnvApiKey, yv as upsertAuthProfile } from "./reply-BRIrPGWy.js";
import { F as toAgentModelListLike, N as resolveAgentModelFallbackValues, P as resolveAgentModelPrimaryValue, a as resolveAgentDir, d as resolveAgentWorkspaceDir, f as resolveDefaultAgentId, j as resolveDefaultAgentWorkspaceDir, l as resolveAgentModelFallbacksOverride, s as resolveAgentExplicitModelPrimary } from "./agent-scope-D85sFDRQ.js";
...
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent } from "./paths-B4q5wccl.js";
...
import { n as runCommandWithRuntime, t as resolveOptionFromCommand } from "./cli-utils-Bal-Phw0.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { ensureAuthProfileStore } = await import("./auth-profiles.runtime-BtzkmSZo.js");
	const { ensureOpenClawModelsJson } = await import("./reply-BRIrPGWy.js").then((n) => n.pf);

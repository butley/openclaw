import { d as visibleWidth, u as stripAnsi$1 } from "./subsystem-CVaAzJWY.js";
import { Cf as formatRawAssistantErrorForUi, Cv as formatThinkingLevels, Gm as resolveConfiguredSecretInputString, Hp as GATEWAY_CLIENT_NAMES, Js as resolveExplicitGatewayAuth, Ks as ensureExplicitGatewayAuth, Mv as normalizeUsageDisplay, Pv as resolveResponseUsageMode, Tv as listThinkingLevelLabels, Vp as GATEWAY_CLIENT_MODES, Ws as buildGatewayConnectionDetails, Xi as formatTimeAgo, Yi as formatRelativeTimestamp, bf as formatToolDetail, fh as assertExplicitGatewayAuthModeWhenBothConfigured, jg as loadConfig, rc as GatewayClient, vd as listChatCommands, xf as resolveToolDisplay, yd as listChatCommandsForConfig, zp as GATEWAY_CLIENT_CAPS } from "./auth-profiles-C_hWnnsG.js";
import { c as resolveAgentIdByWorkspacePath, f as resolveDefaultAgentId } from "./agent-scope-ciM67gYz.js";
import { E as parseAgentSessionKey, c as normalizeAgentId, l as normalizeMainKey, r as buildAgentMainSessionKey } from "./session-key-Cl1W5L6J.js";
import { a as hasConfiguredSecretInput } from "./types.secrets-BEA4gMCN.js";
import { t as VERSION } from "./version-BlUhcaFh.js";
import { s as formatTokenCount, y as stripLeadingInboundMetadata } from "./session-cost-usage-hVTPrj3b.js";
...
const bgAnsi = (code) => (text) => chalk.bgAnsi256(code)(text);
...
function createCommandHandlers(context) {
	...
	const handleCommand = async (raw) => {
		...
		switch (name) {
			...
			case "verbose":
				if (!args) {
					chatLog.addSystem("usage: /verbose <off|light|on|full>");
					break;
				}
				try {
					const result = await client.patchSession({

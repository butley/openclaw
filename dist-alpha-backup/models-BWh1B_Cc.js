...
import { Ag as createConfigIO, An as formatRemainingShort, Cg as loadModelCatalog, Dn as maskApiKey, Eg as resolveOpenClawAgentDir, F as resolveModelRefFromString, F_ as resolveEnvApiKey, Fg as readConfigFileSnapshotForWrite, Fr as runEmbeddedPiAgent, I_ as resolveUsableCustomProviderApiKey, Ii as loadProviderUsageSummary, Iv as resolveAuthProfileDisplayLabel, J as getModelsCommandSecretTargetIds, L_ as getShellEnvAppliedKeys, Lg as setRuntimeConfigSnapshot, M as resolveConfiguredModelRef, M_ as hasUsableCustomProviderApiKey, N as resolveDefaultModelForAgent, N_ as resolveApiKeyForProvider, O as normalizeProviderId, On as DEFAULT_OAUTH_WARN_MS, P_ as resolveAwsSdkEnvVarName, R as resolvePluginProviders, R_ as shouldEnableShellEnvFallback, Ri as formatUsageWindowSummary, Sv as DEFAULT_PROVIDER, T as modelKey, Tg as shouldSuppressBuiltInModel, W as withProgressTotals, Ym as resolveSecretRefString, Z as resolveCommandSecretRefsViaGateway, b as buildModelAliasIndex, cf as resolveModelWithRegistry, d as setAuthProfileOrder, df as discoverAuthStorage, do as describeFailoverError, dv as isNonSecretApiKeyMarker, f as upsertAuthProfile, ff as discoverModels, j_ as getCustomProviderApiKey, jg as loadConfig, k as parseModelRef, kn as buildAuthHealthSummary, n as resolveAuthProfileOrder, p as ensureAuthProfileStore, r as resolveProfileUnusableUntilForDisplay, t as resolveAuthProfileEligibility, u as listProfilesForProvider, v as resolveAuthStorePathForDisplay, wt as openUrl, x as findNormalizedProviderValue, xv as DEFAULT_MODEL, zi as resolveUsageProviderId } from "./auth-profiles-C_hWnnsG.js";
import { t as formatCliCommand } from "./command-format-xiq-peSB.js";
import { F as toAgentModelListLike, N as resolveAgentModelFallbackValues, P as resolveAgentModelPrimaryValue, a as resolveAgentDir, d as resolveAgentWorkspaceDir, f as resolveDefaultAgentId, j as resolveDefaultAgentWorkspaceDir, l as resolveAgentModelFallbacksOverride, s as resolveAgentExplicitModelPrimary } from "./agent-scope-ciM67gYz.js";
import { x as shortenHomePath } from "./utils-hRMQE3lI.js";
...
import { i as parseDurationMs } from "./search-manager-OoPMhEwb.js";
...
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent } from "./paths-DPIeb3JQ.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { ensureAuthProfileStore } = await import("./auth-profiles.runtime-CreTfwE7.js");
	const { ensureOpenClawModelsJson } = await import("./auth-profiles-C_hWnnsG.js").then((n) => n.wg);

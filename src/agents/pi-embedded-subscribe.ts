...
export function subscribeEmbeddedPiSession(params: SubscribeEmbeddedPiSessionParams) {
  ...
  const state: EmbeddedPiSubscribeState = {
    ...
    // [FORK-PATCH-15] Webchat Thinking Stream — always broadcast thinking to WS/SSE clients
  ...
  const emitReasoningStream = (text: string) => {
    // [FORK-PATCH-15] Always emit thinking via emitAgentEvent regardless of onReasoningStream callback
    ...
    // [FORK-PATCH-15] Guard optional callback
